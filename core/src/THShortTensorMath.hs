...
module THShortTensorMath (
    ...
    c_THShortTensor_abs,
    c_THShortTensor_sigmoid,
    c_THShortTensor_log,
    c_THShortTensor_lgamma,
    c_THShortTensor_log1p,
    c_THShortTensor_exp,
    c_THShortTensor_cos,
    c_THShortTensor_acos,
    c_THShortTensor_cosh,
    c_THShortTensor_sin,
    c_THShortTensor_asin,
    c_THShortTensor_sinh,
    c_THShortTensor_tan,
    c_THShortTensor_atan,
    c_THShortTensor_atan2,
    c_THShortTensor_tanh,
    c_THShortTensor_pow,
    c_THShortTensor_tpow,
    c_THShortTensor_sqrt,
    c_THShortTensor_rsqrt,
    c_THShortTensor_ceil,
    c_THShortTensor_floor,
    c_THShortTensor_round,
    c_THShortTensor_trunc,
    c_THShortTensor_frac,
    c_THShortTensor_lerp,
    c_THShortTensor_mean,
    c_THShortTensor_std,
    c_THShortTensor_var,
    c_THShortTensor_norm,
    c_THShortTensor_renorm,
    c_THShortTensor_dist,
    c_THShortTensor_histc,
    c_THShortTensor_bhistc,
    c_THShortTensor_meanall,
    c_THShortTensor_varall,
    c_THShortTensor_stdall,
    c_THShortTensor_normall,
    c_THShortTensor_linspace,
    c_THShortTensor_logspace,
    c_THShortTensor_rand,
    c_THShortTensor_randn,
    c_THShortTensor_logicalall,
    c_THShortTensor_logicalany) where
...
-- |c_THShortTensor_numel : t -> THStorage *
foreign import ccall "THTensorMath.h THShortTensor_numel"
  c_THShortTensor_numel :: (Ptr CTHShortTensor) -> IO (Ptr CTHShortStorage)
...
-- |c_THShortTensor_sigmoid : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_sigmoid"
  c_THShortTensor_sigmoid :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_log : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_log"
  c_THShortTensor_log :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_lgamma : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_lgamma"
  c_THShortTensor_lgamma :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_log1p : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_log1p"
  c_THShortTensor_log1p :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_exp : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_exp"
  c_THShortTensor_exp :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_cos : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_cos"
  c_THShortTensor_cos :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_acos : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_acos"
  c_THShortTensor_acos :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_cosh : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_cosh"
  c_THShortTensor_cosh :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_sin : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_sin"
  c_THShortTensor_sin :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_asin : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_asin"
  c_THShortTensor_asin :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_sinh : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_sinh"
  c_THShortTensor_sinh :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_tan : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_tan"
  c_THShortTensor_tan :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_atan : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_atan"
  c_THShortTensor_atan :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_atan2 : r_ tx ty -> void
foreign import ccall "THTensorMath.h THShortTensor_atan2"
  c_THShortTensor_atan2 :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_tanh : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_tanh"
  c_THShortTensor_tanh :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_pow : r_ t value -> void
foreign import ccall "THTensorMath.h THShortTensor_pow"
  c_THShortTensor_pow :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> CShort -> IO ()

-- |c_THShortTensor_tpow : r_ value t -> void
foreign import ccall "THTensorMath.h THShortTensor_tpow"
  c_THShortTensor_tpow :: (Ptr CTHShortTensor) -> CShort -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_sqrt : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_sqrt"
  c_THShortTensor_sqrt :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_rsqrt : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_rsqrt"
  c_THShortTensor_rsqrt :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_ceil : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_ceil"
  c_THShortTensor_ceil :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_floor : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_floor"
  c_THShortTensor_floor :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_round : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_round"
  c_THShortTensor_round :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_trunc : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_trunc"
  c_THShortTensor_trunc :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_frac : r_ t -> void
foreign import ccall "THTensorMath.h THShortTensor_frac"
  c_THShortTensor_frac :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> IO ()

-- |c_THShortTensor_lerp : r_ a b weight -> void
foreign import ccall "THTensorMath.h THShortTensor_lerp"
  c_THShortTensor_lerp :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> CShort -> IO ()

-- |c_THShortTensor_mean : r_ t dimension keepdim -> void
foreign import ccall "THTensorMath.h THShortTensor_mean"
  c_THShortTensor_mean :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> CInt -> CInt -> IO ()

-- |c_THShortTensor_std : r_ t dimension biased keepdim -> void
foreign import ccall "THTensorMath.h THShortTensor_std"
  c_THShortTensor_std :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> CInt -> CInt -> CInt -> IO ()

-- |c_THShortTensor_var : r_ t dimension biased keepdim -> void
foreign import ccall "THTensorMath.h THShortTensor_var"
  c_THShortTensor_var :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> CInt -> CInt -> CInt -> IO ()

-- |c_THShortTensor_norm : r_ t value dimension keepdim -> void
foreign import ccall "THTensorMath.h THShortTensor_norm"
  c_THShortTensor_norm :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> CShort -> CInt -> CInt -> IO ()

-- |c_THShortTensor_renorm : r_ t value dimension maxnorm -> void
foreign import ccall "THTensorMath.h THShortTensor_renorm"
  c_THShortTensor_renorm :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> CShort -> CInt -> CShort -> IO ()

-- |c_THShortTensor_dist : a b value -> accreal
foreign import ccall "THTensorMath.h THShortTensor_dist"
  c_THShortTensor_dist :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> CShort -> CLong

-- |c_THShortTensor_histc : hist tensor nbins minvalue maxvalue -> void
foreign import ccall "THTensorMath.h THShortTensor_histc"
  c_THShortTensor_histc :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> CLong -> CShort -> CShort -> IO ()

-- |c_THShortTensor_bhistc : hist tensor nbins minvalue maxvalue -> void
foreign import ccall "THTensorMath.h THShortTensor_bhistc"
  c_THShortTensor_bhistc :: (Ptr CTHShortTensor) -> (Ptr CTHShortTensor) -> CLong -> CShort -> CShort -> IO ()

-- |c_THShortTensor_meanall : self -> accreal
foreign import ccall "THTensorMath.h THShortTensor_meanall"
  c_THShortTensor_meanall :: (Ptr CTHShortTensor) -> CLong

-- |c_THShortTensor_varall : self biased -> accreal
foreign import ccall "THTensorMath.h THShortTensor_varall"
  c_THShortTensor_varall :: (Ptr CTHShortTensor) -> CInt -> CLong

-- |c_THShortTensor_stdall : self biased -> accreal
foreign import ccall "THTensorMath.h THShortTensor_stdall"
  c_THShortTensor_stdall :: (Ptr CTHShortTensor) -> CInt -> CLong

-- |c_THShortTensor_normall : t value -> accreal
foreign import ccall "THTensorMath.h THShortTensor_normall"
  c_THShortTensor_normall :: (Ptr CTHShortTensor) -> CShort -> CLong

-- |c_THShortTensor_linspace : r_ a b n -> void
foreign import ccall "THTensorMath.h THShortTensor_linspace"
  c_THShortTensor_linspace :: (Ptr CTHShortTensor) -> CShort -> CShort -> CLong -> IO ()

-- |c_THShortTensor_logspace : r_ a b n -> void
foreign import ccall "THTensorMath.h THShortTensor_logspace"
  c_THShortTensor_logspace :: (Ptr CTHShortTensor) -> CShort -> CShort -> CLong -> IO ()

-- |c_THShortTensor_rand : r_ _generator size -> void
foreign import ccall "THTensorMath.h THShortTensor_rand"
  c_THShortTensor_rand :: (Ptr CTHShortTensor) -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ()

-- |c_THShortTensor_randn : r_ _generator size -> void
foreign import ccall "THTensorMath.h THShortTensor_randn"
  c_THShortTensor_randn :: (Ptr CTHShortTensor) -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ()

-- |c_THShortTensor_logicalall : self -> int
foreign import ccall "THTensorMath.h THShortTensor_logicalall"
  c_THShortTensor_logicalall :: (Ptr CTHShortTensor) -> CInt

-- |c_THShortTensor_logicalany : self -> int
foreign import ccall "THTensorMath.h THShortTensor_logicalany"
  c_THShortTensor_logicalany :: (Ptr CTHShortTensor) -> CInt