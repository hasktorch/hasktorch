...
module THByteLapack (
    ...
    c_THByteLapack_getri,
    p_THByteLapack_gesv,
    p_THByteLapack_trtrs,
    p_THByteLapack_gels,
    p_THByteLapack_syev,
    p_THByteLapack_geev,
    p_THByteLapack_gesvd,
    p_THByteLapack_getrf,
    p_THByteLapack_getrs,
    p_THByteLapack_getri) where
...
-- |p_THByteLapack_gesv : Pointer to n nrhs a lda ipiv b ldb info -> void
foreign import ccall unsafe "THLapack.h &THByteLapack_gesv"
  p_THByteLapack_gesv :: FunPtr (CInt -> CInt -> Ptr CChar -> CInt -> CIntPtr -> Ptr CChar -> CInt -> CIntPtr -> IO ())

-- |p_THByteLapack_trtrs : Pointer to uplo trans diag n nrhs a lda b ldb info -> void
foreign import ccall unsafe "THLapack.h &THByteLapack_trtrs"
  p_THByteLapack_trtrs :: FunPtr (CChar -> CChar -> CChar -> CInt -> CInt -> Ptr CChar -> CInt -> Ptr CChar -> CInt -> CIntPtr -> IO ())

-- |p_THByteLapack_gels : Pointer to trans m n nrhs a lda b ldb work lwork info -> void
foreign import ccall unsafe "THLapack.h &THByteLapack_gels"
  p_THByteLapack_gels :: FunPtr (CChar -> CInt -> CInt -> CInt -> Ptr CChar -> CInt -> Ptr CChar -> CInt -> Ptr CChar -> CInt -> CIntPtr -> IO ())

-- |p_THByteLapack_syev : Pointer to jobz uplo n a lda w work lwork info -> void
foreign import ccall unsafe "THLapack.h &THByteLapack_syev"
  p_THByteLapack_syev :: FunPtr (CChar -> CChar -> CInt -> Ptr CChar -> CInt -> Ptr CChar -> Ptr CChar -> CInt -> CIntPtr -> IO ())

-- |p_THByteLapack_geev : Pointer to jobvl jobvr n a lda wr wi vl ldvl vr ldvr work lwork info -> void
foreign import ccall unsafe "THLapack.h &THByteLapack_geev"
  p_THByteLapack_geev :: FunPtr (CChar -> CChar -> CInt -> Ptr CChar -> CInt -> Ptr CChar -> Ptr CChar -> Ptr CChar -> CInt -> Ptr CChar -> CInt -> Ptr CChar -> CInt -> CIntPtr -> IO ())

-- |p_THByteLapack_gesvd : Pointer to jobu jobvt m n a lda s u ldu vt ldvt work lwork info -> void
foreign import ccall unsafe "THLapack.h &THByteLapack_gesvd"
  p_THByteLapack_gesvd :: FunPtr (CChar -> CChar -> CInt -> CInt -> Ptr CChar -> CInt -> Ptr CChar -> Ptr CChar -> CInt -> Ptr CChar -> CInt -> Ptr CChar -> CInt -> CIntPtr -> IO ())

-- |p_THByteLapack_getrf : Pointer to m n a lda ipiv info -> void
foreign import ccall unsafe "THLapack.h &THByteLapack_getrf"
  p_THByteLapack_getrf :: FunPtr (CInt -> CInt -> Ptr CChar -> CInt -> CIntPtr -> CIntPtr -> IO ())

-- |p_THByteLapack_getrs : Pointer to trans n nrhs a lda ipiv b ldb info -> void
foreign import ccall unsafe "THLapack.h &THByteLapack_getrs"
  p_THByteLapack_getrs :: FunPtr (CChar -> CInt -> CInt -> Ptr CChar -> CInt -> CIntPtr -> Ptr CChar -> CInt -> CIntPtr -> IO ())

-- |p_THByteLapack_getri : Pointer to n a lda ipiv work lwork info -> void
foreign import ccall unsafe "THLapack.h &THByteLapack_getri"
  p_THByteLapack_getri :: FunPtr (CInt -> Ptr CChar -> CInt -> CIntPtr -> Ptr CChar -> CInt -> CIntPtr -> IO ())