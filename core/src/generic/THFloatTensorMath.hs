...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_maskedSelect"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_nonzero"
  c_THFloatTensor_nonzero :: Ptr CTHLongTensor -> (Ptr CTHFloatTensor) -> IO ()

-- |c_THFloatTensor_indexSelect : tensor src dim index -> void
foreign import ccall unsafe "THTensorMath.h THFloatTensor_indexSelect"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_indexCopy"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_indexAdd"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_indexFill"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_gather"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_scatter"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_scatterAdd"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_csub"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_cremainder"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_addcmul"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_addcdiv"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_addmv"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_addmm"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_addr"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_addbmm"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_baddbmm"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_match"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_numel"
  c_THFloatTensor_numel :: (Ptr CTHFloatTensor) -> CPtrdiff

-- |c_THFloatTensor_max : values_ indices_ t dimension keepdim -> void
foreign import ccall unsafe "THTensorMath.h THFloatTensor_max"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_min"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_kthvalue"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_mode"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_median"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_sort"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_topk"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_leTensor"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_gtTensor"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_geTensor"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_neTensor"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_eqTensor"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_ltTensorT"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_leTensorT"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_gtTensorT"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_geTensorT"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_neTensorT"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_mean"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_std"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_var"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_norm"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_renorm"
  c_THFloatTensor_renorm :: (Ptr CTHFloatTensor) -> (Ptr CTHFloatTensor) -> CFloat -> CInt -> CFloat -> IO ()

-- |c_THFloatTensor_dist : a b value -> accreal
foreign import ccall unsafe "THTensorMath.h THFloatTensor_dist"
...
foreign import ccall unsafe "THTensorMath.h THFloatTensor_histc"
...
-- |p_THFloatTensor_addmm : Pointer to r_ beta t alpha mat1 mat2 -> void
foreign import ccall unsafe "THTensorMath.h &THFloatTensor_addmm"
...
-- |p_THFloatTensor_addr : Pointer to r_ beta t alpha vec1 vec2 -> void
foreign import ccall unsafe "THTensorMath.h &THFloatTensor_addr"
  p_THFloatTensor_addr :: FunPtr ((Ptr CTHFloatTensor) -> CFloat -> (Ptr CTHFloatTensor) -> CFloat -> (Ptr CTHFloatTensor) -> (Ptr CTHFloatTensor) -> IO ())

-- |p_THFloatTensor_addbmm : Pointer to r_ beta t alpha batch1 batch2 -> void
foreign import ccall unsafe "THTensorMath.h &THFloatTensor_addbmm"
...
-- |p_THFloatTensor_baddbmm : Pointer to r_ beta t alpha batch1 batch2 -> void
foreign import ccall unsafe "THTensorMath.h &THFloatTensor_baddbmm"
