...
foreign import ccall "THTensorLapack.h THLongTensor_gesv"
...
foreign import ccall "THTensorLapack.h THLongTensor_geqrf"
  c_THLongTensor_geqrf :: (Ptr CTHLongTensor) -> (Ptr CTHLongTensor) -> (Ptr CTHLongTensor) -> IO ()

-- |c_THLongTensor_orgqr : ra_ a tau -> void
foreign import ccall "THTensorLapack.h THLongTensor_orgqr"
...
foreign import ccall "THTensorLapack.h THLongTensor_btrisolve"
