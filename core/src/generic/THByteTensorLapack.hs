...
foreign import ccall "THTensorLapack.h THByteTensor_trtrs"
  c_THByteTensor_trtrs :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> CChar -> CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THByteTensor_syev"
  c_THByteTensor_syev :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> CChar -> IO ()

-- |c_THByteTensor_geev : re_ rv_ a_ jobvr -> void
foreign import ccall "THTensorLapack.h THByteTensor_geev"
  c_THByteTensor_geev :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> IO ()

-- |c_THByteTensor_gesvd : ru_ rs_ rv_ a jobu -> void
foreign import ccall "THTensorLapack.h THByteTensor_gesvd"
  c_THByteTensor_gesvd :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> IO ()

-- |c_THByteTensor_gesvd2 : ru_ rs_ rv_ ra_ a jobu -> void
foreign import ccall "THTensorLapack.h THByteTensor_gesvd2"
  c_THByteTensor_gesvd2 :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THByteTensor_potrf"
  c_THByteTensor_potrf :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> IO ()

-- |c_THByteTensor_potrs : rb_ b_ a_ uplo -> void
foreign import ccall "THTensorLapack.h THByteTensor_potrs"
  c_THByteTensor_potrs :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> IO ()

-- |c_THByteTensor_potri : ra_ a uplo -> void
foreign import ccall "THTensorLapack.h THByteTensor_potri"
  c_THByteTensor_potri :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THByteTensor_ormqr"
  c_THByteTensor_ormqr :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> CChar -> IO ()

-- |c_THByteTensor_pstrf : ra_ rpiv_ a uplo tol -> void
foreign import ccall "THTensorLapack.h THByteTensor_pstrf"
  c_THByteTensor_pstrf :: (Ptr CTHByteTensor) -> Ptr CTHIntTensor -> (Ptr CTHByteTensor) -> CChar -> CChar -> IO ()
