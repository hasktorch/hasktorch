...
foreign import ccall unsafe "THStorage.h THIntStorage_newWithMapping"
  c_THIntStorage_newWithMapping :: Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHIntStorage)

-- |c_THIntStorage_newWithData : data size -> THStorage *
foreign import ccall unsafe "THStorage.h THIntStorage_newWithData"
...
foreign import ccall unsafe "THStorage.h THIntStorage_newWithAllocator"
...
foreign import ccall unsafe "THStorage.h THIntStorage_newWithDataAndAllocator"
