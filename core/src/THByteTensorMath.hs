...
module THByteTensorMath (
    ...
    c_THByteTensor_abs,
    c_THByteTensor_sigmoid,
    c_THByteTensor_log,
    c_THByteTensor_lgamma,
    c_THByteTensor_log1p,
    c_THByteTensor_exp,
    c_THByteTensor_cos,
    c_THByteTensor_acos,
    c_THByteTensor_cosh,
    ...
    c_THByteTensor_tan,
    c_THByteTensor_atan,
    c_THByteTensor_atan2,
    c_THByteTensor_tanh,
    c_THByteTensor_pow,
    c_THByteTensor_tpow,
    c_THByteTensor_sqrt,
    c_THByteTensor_rsqrt,
    c_THByteTensor_ceil,
    c_THByteTensor_floor,
    c_THByteTensor_round,
    c_THByteTensor_trunc,
    c_THByteTensor_frac,
    c_THByteTensor_lerp,
    c_THByteTensor_mean,
    c_THByteTensor_std,
    c_THByteTensor_var,
    c_THByteTensor_norm,
    c_THByteTensor_renorm,
    c_THByteTensor_dist,
    c_THByteTensor_histc,
    c_THByteTensor_bhistc,
    c_THByteTensor_meanall,
    c_THByteTensor_varall,
    c_THByteTensor_stdall,
    c_THByteTensor_normall,
    c_THByteTensor_linspace,
    c_THByteTensor_logspace,
    c_THByteTensor_rand,
    c_THByteTensor_randn,
    c_THByteTensor_logicalall,
    c_THByteTensor_logicalany) where
...
-- |c_THByteTensor_cinv : self src -> void
foreign import ccall "THTensorMath.h THByteTensor_cinv"
  c_THByteTensor_cinv :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()
...
-- |c_THByteTensor_numel : t -> THStorage *
foreign import ccall "THTensorMath.h THByteTensor_numel"
  c_THByteTensor_numel :: (Ptr CTHByteTensor) -> IO (Ptr CTHByteStorage)
...
-- |c_THByteTensor_abs : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_abs"
  c_THByteTensor_abs :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_sigmoid : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_sigmoid"
  c_THByteTensor_sigmoid :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_log : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_log"
  c_THByteTensor_log :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_lgamma : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_lgamma"
  c_THByteTensor_lgamma :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_log1p : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_log1p"
  c_THByteTensor_log1p :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_exp : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_exp"
  c_THByteTensor_exp :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_cos : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_cos"
  c_THByteTensor_cos :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_acos : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_acos"
  c_THByteTensor_acos :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_cosh : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_cosh"
  c_THByteTensor_cosh :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_sin : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_sin"
  c_THByteTensor_sin :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_asin : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_asin"
  c_THByteTensor_asin :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_sinh : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_sinh"
  c_THByteTensor_sinh :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_tan : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_tan"
  c_THByteTensor_tan :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_atan : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_atan"
  c_THByteTensor_atan :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_atan2 : r_ tx ty -> void
foreign import ccall "THTensorMath.h THByteTensor_atan2"
  c_THByteTensor_atan2 :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_tanh : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_tanh"
  c_THByteTensor_tanh :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_pow : r_ t value -> void
foreign import ccall "THTensorMath.h THByteTensor_pow"
  c_THByteTensor_pow :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> IO ()

-- |c_THByteTensor_tpow : r_ value t -> void
foreign import ccall "THTensorMath.h THByteTensor_tpow"
  c_THByteTensor_tpow :: (Ptr CTHByteTensor) -> CChar -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_sqrt : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_sqrt"
  c_THByteTensor_sqrt :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_rsqrt : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_rsqrt"
  c_THByteTensor_rsqrt :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_ceil : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_ceil"
  c_THByteTensor_ceil :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_floor : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_floor"
  c_THByteTensor_floor :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_round : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_round"
  c_THByteTensor_round :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_trunc : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_trunc"
  c_THByteTensor_trunc :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_frac : r_ t -> void
foreign import ccall "THTensorMath.h THByteTensor_frac"
  c_THByteTensor_frac :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> IO ()

-- |c_THByteTensor_lerp : r_ a b weight -> void
foreign import ccall "THTensorMath.h THByteTensor_lerp"
  c_THByteTensor_lerp :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> IO ()

-- |c_THByteTensor_mean : r_ t dimension keepdim -> void
foreign import ccall "THTensorMath.h THByteTensor_mean"
  c_THByteTensor_mean :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CInt -> CInt -> IO ()

-- |c_THByteTensor_std : r_ t dimension biased keepdim -> void
foreign import ccall "THTensorMath.h THByteTensor_std"
  c_THByteTensor_std :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CInt -> CInt -> CInt -> IO ()

-- |c_THByteTensor_var : r_ t dimension biased keepdim -> void
foreign import ccall "THTensorMath.h THByteTensor_var"
  c_THByteTensor_var :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CInt -> CInt -> CInt -> IO ()

-- |c_THByteTensor_norm : r_ t value dimension keepdim -> void
foreign import ccall "THTensorMath.h THByteTensor_norm"
  c_THByteTensor_norm :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> CInt -> CInt -> IO ()

-- |c_THByteTensor_renorm : r_ t value dimension maxnorm -> void
foreign import ccall "THTensorMath.h THByteTensor_renorm"
  c_THByteTensor_renorm :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> CInt -> CChar -> IO ()

-- |c_THByteTensor_dist : a b value -> accreal
foreign import ccall "THTensorMath.h THByteTensor_dist"
  c_THByteTensor_dist :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> CLong

-- |c_THByteTensor_histc : hist tensor nbins minvalue maxvalue -> void
foreign import ccall "THTensorMath.h THByteTensor_histc"
  c_THByteTensor_histc :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CLong -> CChar -> CChar -> IO ()

-- |c_THByteTensor_bhistc : hist tensor nbins minvalue maxvalue -> void
foreign import ccall "THTensorMath.h THByteTensor_bhistc"
  c_THByteTensor_bhistc :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CLong -> CChar -> CChar -> IO ()

-- |c_THByteTensor_meanall : self -> accreal
foreign import ccall "THTensorMath.h THByteTensor_meanall"
  c_THByteTensor_meanall :: (Ptr CTHByteTensor) -> CLong

-- |c_THByteTensor_varall : self biased -> accreal
foreign import ccall "THTensorMath.h THByteTensor_varall"
  c_THByteTensor_varall :: (Ptr CTHByteTensor) -> CInt -> CLong

-- |c_THByteTensor_stdall : self biased -> accreal
foreign import ccall "THTensorMath.h THByteTensor_stdall"
  c_THByteTensor_stdall :: (Ptr CTHByteTensor) -> CInt -> CLong

-- |c_THByteTensor_normall : t value -> accreal
foreign import ccall "THTensorMath.h THByteTensor_normall"
  c_THByteTensor_normall :: (Ptr CTHByteTensor) -> CChar -> CLong

-- |c_THByteTensor_linspace : r_ a b n -> void
foreign import ccall "THTensorMath.h THByteTensor_linspace"
  c_THByteTensor_linspace :: (Ptr CTHByteTensor) -> CChar -> CChar -> CLong -> IO ()

-- |c_THByteTensor_logspace : r_ a b n -> void
foreign import ccall "THTensorMath.h THByteTensor_logspace"
  c_THByteTensor_logspace :: (Ptr CTHByteTensor) -> CChar -> CChar -> CLong -> IO ()

-- |c_THByteTensor_rand : r_ _generator size -> void
foreign import ccall "THTensorMath.h THByteTensor_rand"
  c_THByteTensor_rand :: (Ptr CTHByteTensor) -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ()

-- |c_THByteTensor_randn : r_ _generator size -> void
foreign import ccall "THTensorMath.h THByteTensor_randn"
  c_THByteTensor_randn :: (Ptr CTHByteTensor) -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ()

-- |c_THByteTensor_logicalall : self -> int
foreign import ccall "THTensorMath.h THByteTensor_logicalall"
  c_THByteTensor_logicalall :: (Ptr CTHByteTensor) -> CInt

-- |c_THByteTensor_logicalany : self -> int
foreign import ccall "THTensorMath.h THByteTensor_logicalany"
  c_THByteTensor_logicalany :: (Ptr CTHByteTensor) -> CInt