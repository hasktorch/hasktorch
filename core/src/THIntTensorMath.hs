...
module THIntTensorMath (
    ...
    c_THIntTensor_abs,
    c_THIntTensor_sigmoid,
    c_THIntTensor_log,
    c_THIntTensor_lgamma,
    c_THIntTensor_log1p,
    c_THIntTensor_exp,
    c_THIntTensor_cos,
    c_THIntTensor_acos,
    ...
    c_THIntTensor_var,
    c_THIntTensor_norm,
    c_THIntTensor_renorm,
    c_THIntTensor_dist,
    c_THIntTensor_histc,
    c_THIntTensor_bhistc,
    c_THIntTensor_meanall,
    c_THIntTensor_varall,
    c_THIntTensor_stdall,
    c_THIntTensor_normall,
    c_THIntTensor_linspace,
    c_THIntTensor_logspace,
    c_THIntTensor_rand,
    c_THIntTensor_randn,
    c_THIntTensor_logicalall,
    c_THIntTensor_logicalany) where
...
-- |c_THIntTensor_sigmoid : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_sigmoid"
  c_THIntTensor_sigmoid :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_log : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_log"
  c_THIntTensor_log :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_lgamma : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_lgamma"
  c_THIntTensor_lgamma :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_log1p : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_log1p"
  c_THIntTensor_log1p :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_exp : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_exp"
  c_THIntTensor_exp :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_cos : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_cos"
  c_THIntTensor_cos :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_acos : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_acos"
  c_THIntTensor_acos :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_cosh : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_cosh"
  c_THIntTensor_cosh :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_sin : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_sin"
  c_THIntTensor_sin :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_asin : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_asin"
  c_THIntTensor_asin :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_sinh : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_sinh"
  c_THIntTensor_sinh :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_tan : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_tan"
  c_THIntTensor_tan :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_atan : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_atan"
  c_THIntTensor_atan :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_atan2 : r_ tx ty -> void
foreign import ccall "THTensorMath.h THIntTensor_atan2"
  c_THIntTensor_atan2 :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_tanh : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_tanh"
  c_THIntTensor_tanh :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_pow : r_ t value -> void
foreign import ccall "THTensorMath.h THIntTensor_pow"
  c_THIntTensor_pow :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> IO ()

-- |c_THIntTensor_tpow : r_ value t -> void
foreign import ccall "THTensorMath.h THIntTensor_tpow"
  c_THIntTensor_tpow :: (Ptr CTHIntTensor) -> CInt -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_sqrt : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_sqrt"
  c_THIntTensor_sqrt :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_rsqrt : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_rsqrt"
  c_THIntTensor_rsqrt :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_ceil : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_ceil"
  c_THIntTensor_ceil :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_floor : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_floor"
  c_THIntTensor_floor :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_round : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_round"
  c_THIntTensor_round :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_trunc : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_trunc"
  c_THIntTensor_trunc :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_frac : r_ t -> void
foreign import ccall "THTensorMath.h THIntTensor_frac"
  c_THIntTensor_frac :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> IO ()

-- |c_THIntTensor_lerp : r_ a b weight -> void
foreign import ccall "THTensorMath.h THIntTensor_lerp"
  c_THIntTensor_lerp :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> IO ()

-- |c_THIntTensor_mean : r_ t dimension keepdim -> void
foreign import ccall "THTensorMath.h THIntTensor_mean"
  c_THIntTensor_mean :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> CInt -> IO ()

-- |c_THIntTensor_std : r_ t dimension biased keepdim -> void
foreign import ccall "THTensorMath.h THIntTensor_std"
  c_THIntTensor_std :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> CInt -> CInt -> IO ()

-- |c_THIntTensor_var : r_ t dimension biased keepdim -> void
foreign import ccall "THTensorMath.h THIntTensor_var"
  c_THIntTensor_var :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> CInt -> CInt -> IO ()

-- |c_THIntTensor_norm : r_ t value dimension keepdim -> void
foreign import ccall "THTensorMath.h THIntTensor_norm"
  c_THIntTensor_norm :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> CInt -> CInt -> IO ()

-- |c_THIntTensor_renorm : r_ t value dimension maxnorm -> void
foreign import ccall "THTensorMath.h THIntTensor_renorm"
  c_THIntTensor_renorm :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> CInt -> CInt -> IO ()

-- |c_THIntTensor_dist : a b value -> accreal
foreign import ccall "THTensorMath.h THIntTensor_dist"
  c_THIntTensor_dist :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> CLong

-- |c_THIntTensor_histc : hist tensor nbins minvalue maxvalue -> void
foreign import ccall "THTensorMath.h THIntTensor_histc"
  c_THIntTensor_histc :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CLong -> CInt -> CInt -> IO ()

-- |c_THIntTensor_bhistc : hist tensor nbins minvalue maxvalue -> void
foreign import ccall "THTensorMath.h THIntTensor_bhistc"
  c_THIntTensor_bhistc :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CLong -> CInt -> CInt -> IO ()

-- |c_THIntTensor_meanall : self -> accreal
foreign import ccall "THTensorMath.h THIntTensor_meanall"
  c_THIntTensor_meanall :: (Ptr CTHIntTensor) -> CLong

-- |c_THIntTensor_varall : self biased -> accreal
foreign import ccall "THTensorMath.h THIntTensor_varall"
  c_THIntTensor_varall :: (Ptr CTHIntTensor) -> CInt -> CLong

-- |c_THIntTensor_stdall : self biased -> accreal
foreign import ccall "THTensorMath.h THIntTensor_stdall"
  c_THIntTensor_stdall :: (Ptr CTHIntTensor) -> CInt -> CLong

-- |c_THIntTensor_normall : t value -> accreal
foreign import ccall "THTensorMath.h THIntTensor_normall"
  c_THIntTensor_normall :: (Ptr CTHIntTensor) -> CInt -> CLong

-- |c_THIntTensor_linspace : r_ a b n -> void
foreign import ccall "THTensorMath.h THIntTensor_linspace"
  c_THIntTensor_linspace :: (Ptr CTHIntTensor) -> CInt -> CInt -> CLong -> IO ()

-- |c_THIntTensor_logspace : r_ a b n -> void
foreign import ccall "THTensorMath.h THIntTensor_logspace"
  c_THIntTensor_logspace :: (Ptr CTHIntTensor) -> CInt -> CInt -> CLong -> IO ()

-- |c_THIntTensor_rand : r_ _generator size -> void
foreign import ccall "THTensorMath.h THIntTensor_rand"
  c_THIntTensor_rand :: (Ptr CTHIntTensor) -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ()

-- |c_THIntTensor_randn : r_ _generator size -> void
foreign import ccall "THTensorMath.h THIntTensor_randn"
  c_THIntTensor_randn :: (Ptr CTHIntTensor) -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ()

-- |c_THIntTensor_logicalall : self -> int
foreign import ccall "THTensorMath.h THIntTensor_logicalall"
  c_THIntTensor_logicalall :: (Ptr CTHIntTensor) -> CInt

-- |c_THIntTensor_logicalany : self -> int
foreign import ccall "THTensorMath.h THIntTensor_logicalany"
  c_THIntTensor_logicalany :: (Ptr CTHIntTensor) -> CInt