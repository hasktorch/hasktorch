...
foreign import ccall "THCTensorMasked.h THCShortTensor_maskedFillByte"
  c_maskedFillByte :: Ptr C'THCState -> Ptr C'THCudaShortTensor -> Ptr C'THCudaByteTensor -> CShort -> IO ()
...
foreign import ccall "THCTensorMasked.h THCShortTensor_maskedCopyByte"
  c_maskedCopyByte :: Ptr C'THCState -> Ptr C'THCudaShortTensor -> Ptr C'THCudaByteTensor -> Ptr C'THCudaShortTensor -> IO ()
...
foreign import ccall "THCTensorMasked.h THCShortTensor_maskedSelectByte"
  c_maskedSelectByte :: Ptr C'THCState -> Ptr C'THCudaShortTensor -> Ptr C'THCudaShortTensor -> Ptr C'THCudaByteTensor -> IO ()
...
foreign import ccall "THCTensorMasked.h &THCShortTensor_maskedFillByte"
  p_maskedFillByte :: FunPtr (Ptr C'THCState -> Ptr C'THCudaShortTensor -> Ptr C'THCudaByteTensor -> CShort -> IO ())
...
foreign import ccall "THCTensorMasked.h &THCShortTensor_maskedCopyByte"
  p_maskedCopyByte :: FunPtr (Ptr C'THCState -> Ptr C'THCudaShortTensor -> Ptr C'THCudaByteTensor -> Ptr C'THCudaShortTensor -> IO ())
...
foreign import ccall "THCTensorMasked.h &THCShortTensor_maskedSelectByte"
  p_maskedSelectByte :: FunPtr (Ptr C'THCState -> Ptr C'THCudaShortTensor -> Ptr C'THCudaShortTensor -> Ptr C'THCudaByteTensor -> IO ())