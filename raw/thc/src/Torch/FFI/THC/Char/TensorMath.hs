...
foreign import ccall "THCTensorMath.h THCCharTensor_zeros"
  c_zeros :: Ptr C'THCState -> Ptr C'THCudaCharTensor -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensorMath.h THCCharTensor_ones"
  c_ones :: Ptr C'THCState -> Ptr C'THCudaCharTensor -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensorMath.h THCCharTensor_reshape"
  c_reshape :: Ptr C'THCState -> Ptr C'THCudaCharTensor -> Ptr C'THCudaCharTensor -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensorMath.h &THCCharTensor_zeros"
  p_zeros :: FunPtr (Ptr C'THCState -> Ptr C'THCudaCharTensor -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensorMath.h &THCCharTensor_ones"
  p_ones :: FunPtr (Ptr C'THCState -> Ptr C'THCudaCharTensor -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensorMath.h &THCCharTensor_reshape"
  p_reshape :: FunPtr (Ptr C'THCState -> Ptr C'THCudaCharTensor -> Ptr C'THCudaCharTensor -> Ptr C'THCLongStorage -> IO ())
