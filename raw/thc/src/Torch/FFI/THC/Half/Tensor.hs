...
foreign import ccall "THCTensor.h THCHalfTensor_newExpand"
  c_newExpand :: Ptr C'THCState -> Ptr C'THCudaHalfTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaHalfTensor)

-- | c_expand :  state r tensor sizes -> void
foreign import ccall "THCTensor.h THCHalfTensor_expand"
  c_expand :: Ptr C'THCState -> Ptr C'THCudaHalfTensor -> Ptr C'THCudaHalfTensor -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h &THCHalfTensor_newExpand"
  p_newExpand :: FunPtr (Ptr C'THCState -> Ptr C'THCudaHalfTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaHalfTensor))

-- | p_expand : Pointer to function : state r tensor sizes -> void
foreign import ccall "THCTensor.h &THCHalfTensor_expand"
  p_expand :: FunPtr (Ptr C'THCState -> Ptr C'THCudaHalfTensor -> Ptr C'THCudaHalfTensor -> Ptr C'THCLongStorage -> IO ())
