...
foreign import ccall "THCTensor.h THCFloatTensor_newSizeOf"
  c_newSizeOf :: Ptr C'THCState -> Ptr C'THCudaFloatTensor -> IO (Ptr C'THCLongStorage)

-- | c_newStrideOf :  state self -> THCLongStorage *
foreign import ccall "THCTensor.h THCFloatTensor_newStrideOf"
  c_newStrideOf :: Ptr C'THCState -> Ptr C'THCudaFloatTensor -> IO (Ptr C'THCLongStorage)
...
foreign import ccall "THCTensor.h THCFloatTensor_newWithStorage"
  c_newWithStorage :: Ptr C'THCState -> Ptr C'THCFloatStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaFloatTensor)
...
foreign import ccall "THCTensor.h THCFloatTensor_newWithSize"
  c_newWithSize :: Ptr C'THCState -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaFloatTensor)
...
foreign import ccall "THCTensor.h THCFloatTensor_newView"
  c_newView :: Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaFloatTensor)

-- | c_newExpand :  state tensor size -> THCTensor *
foreign import ccall "THCTensor.h THCFloatTensor_newExpand"
  c_newExpand :: Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaFloatTensor)

-- | c_expand :  state r tensor sizes -> void
foreign import ccall "THCTensor.h THCFloatTensor_expand"
  c_expand :: Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCudaFloatTensor -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCFloatTensor_resize"
  c_resize :: Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCFloatTensor_setStorage"
  c_setStorage :: Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCFloatStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCFloatTensor_isSize"
  c_isSize :: Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCLongStorage -> IO CInt
...
foreign import ccall "THCTensor.h &THCFloatTensor_newSizeOf"
  p_newSizeOf :: FunPtr (Ptr C'THCState -> Ptr C'THCudaFloatTensor -> IO (Ptr C'THCLongStorage))

-- | p_newStrideOf : Pointer to function : state self -> THCLongStorage *
foreign import ccall "THCTensor.h &THCFloatTensor_newStrideOf"
  p_newStrideOf :: FunPtr (Ptr C'THCState -> Ptr C'THCudaFloatTensor -> IO (Ptr C'THCLongStorage))
...
foreign import ccall "THCTensor.h &THCFloatTensor_newWithStorage"
  p_newWithStorage :: FunPtr (Ptr C'THCState -> Ptr C'THCFloatStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaFloatTensor))
...
foreign import ccall "THCTensor.h &THCFloatTensor_newWithSize"
  p_newWithSize :: FunPtr (Ptr C'THCState -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaFloatTensor))
...
foreign import ccall "THCTensor.h &THCFloatTensor_newView"
  p_newView :: FunPtr (Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaFloatTensor))

-- | p_newExpand : Pointer to function : state tensor size -> THCTensor *
foreign import ccall "THCTensor.h &THCFloatTensor_newExpand"
  p_newExpand :: FunPtr (Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaFloatTensor))

-- | p_expand : Pointer to function : state r tensor sizes -> void
foreign import ccall "THCTensor.h &THCFloatTensor_expand"
  p_expand :: FunPtr (Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCudaFloatTensor -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCFloatTensor_resize"
  p_resize :: FunPtr (Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCFloatTensor_setStorage"
  p_setStorage :: FunPtr (Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCFloatStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCFloatTensor_isSize"
  p_isSize :: FunPtr (Ptr C'THCState -> Ptr C'THCudaFloatTensor -> Ptr C'THCLongStorage -> IO CInt)
