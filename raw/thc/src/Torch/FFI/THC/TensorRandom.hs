...
foreign import ccall "THCTensorRandom.h THCRandom_getRNGState"
  c_THCRandom_getRNGState :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> IO ()

-- | c_THCRandom_setRNGState :  state rng_state -> void
foreign import ccall "THCTensorRandom.h THCRandom_setRNGState"
  c_THCRandom_setRNGState :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> IO ()
...
foreign import ccall "THCTensorRandom.h &THCRandom_getRNGState"
  p_THCRandom_getRNGState :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> IO ())

-- | p_THCRandom_setRNGState : Pointer to function : state rng_state -> void
foreign import ccall "THCTensorRandom.h &THCRandom_setRNGState"
  p_THCRandom_setRNGState :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> IO ())