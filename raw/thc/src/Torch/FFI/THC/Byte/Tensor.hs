...
foreign import ccall "THCTensor.h THCByteTensor_newSizeOf"
  c_newSizeOf :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> IO (Ptr C'THCLongStorage)

-- | c_newStrideOf :  state self -> THCLongStorage *
foreign import ccall "THCTensor.h THCByteTensor_newStrideOf"
  c_newStrideOf :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> IO (Ptr C'THCLongStorage)
...
foreign import ccall "THCTensor.h THCByteTensor_newWithStorage"
  c_newWithStorage :: Ptr C'THCState -> Ptr C'THCByteStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaByteTensor)
...
foreign import ccall "THCTensor.h THCByteTensor_newWithSize"
  c_newWithSize :: Ptr C'THCState -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaByteTensor)
...
foreign import ccall "THCTensor.h THCByteTensor_newView"
  c_newView :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaByteTensor)

-- | c_newExpand :  state tensor size -> THCTensor *
foreign import ccall "THCTensor.h THCByteTensor_newExpand"
  c_newExpand :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaByteTensor)

-- | c_expand :  state r tensor sizes -> void
foreign import ccall "THCTensor.h THCByteTensor_expand"
  c_expand :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCByteTensor_resize"
  c_resize :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCByteTensor_setStorage"
  c_setStorage :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCByteStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCByteTensor_isSize"
  c_isSize :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO CInt
...
foreign import ccall "THCTensor.h &THCByteTensor_newSizeOf"
  p_newSizeOf :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> IO (Ptr C'THCLongStorage))

-- | p_newStrideOf : Pointer to function : state self -> THCLongStorage *
foreign import ccall "THCTensor.h &THCByteTensor_newStrideOf"
  p_newStrideOf :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> IO (Ptr C'THCLongStorage))
...
foreign import ccall "THCTensor.h &THCByteTensor_newWithStorage"
  p_newWithStorage :: FunPtr (Ptr C'THCState -> Ptr C'THCByteStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaByteTensor))
...
foreign import ccall "THCTensor.h &THCByteTensor_newWithSize"
  p_newWithSize :: FunPtr (Ptr C'THCState -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaByteTensor))
...
foreign import ccall "THCTensor.h &THCByteTensor_newView"
  p_newView :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaByteTensor))

-- | p_newExpand : Pointer to function : state tensor size -> THCTensor *
foreign import ccall "THCTensor.h &THCByteTensor_newExpand"
  p_newExpand :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaByteTensor))

-- | p_expand : Pointer to function : state r tensor sizes -> void
foreign import ccall "THCTensor.h &THCByteTensor_expand"
  p_expand :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCByteTensor_resize"
  p_resize :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCByteTensor_setStorage"
  p_setStorage :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCByteStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCByteTensor_isSize"
  p_isSize :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO CInt)
