...
foreign import ccall "THCTensorMath.h THCByteTensor_zeros"
  c_zeros :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensorMath.h THCByteTensor_ones"
  c_ones :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensorMath.h THCByteTensor_reshape"
  c_reshape :: Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensorMath.h &THCByteTensor_zeros"
  p_zeros :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensorMath.h &THCByteTensor_ones"
  p_ones :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensorMath.h &THCByteTensor_reshape"
  p_reshape :: FunPtr (Ptr C'THCState -> Ptr C'THCudaByteTensor -> Ptr C'THCudaByteTensor -> Ptr C'THCLongStorage -> IO ())
