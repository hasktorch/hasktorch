...
foreign import ccall "THCTensor.h THCDoubleTensor_newSizeOf"
  c_newSizeOf :: Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> IO (Ptr C'THCLongStorage)

-- | c_newStrideOf :  state self -> THCLongStorage *
foreign import ccall "THCTensor.h THCDoubleTensor_newStrideOf"
  c_newStrideOf :: Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> IO (Ptr C'THCLongStorage)
...
foreign import ccall "THCTensor.h THCDoubleTensor_newWithStorage"
  c_newWithStorage :: Ptr C'THCState -> Ptr C'THCDoubleStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaDoubleTensor)
...
foreign import ccall "THCTensor.h THCDoubleTensor_newWithSize"
  c_newWithSize :: Ptr C'THCState -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaDoubleTensor)
...
foreign import ccall "THCTensor.h THCDoubleTensor_newView"
  c_newView :: Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaDoubleTensor)

-- | c_newExpand :  state tensor size -> THCTensor *
foreign import ccall "THCTensor.h THCDoubleTensor_newExpand"
  c_newExpand :: Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaDoubleTensor)

-- | c_expand :  state r tensor sizes -> void
foreign import ccall "THCTensor.h THCDoubleTensor_expand"
  c_expand :: Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCudaDoubleTensor -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCDoubleTensor_resize"
  c_resize :: Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCDoubleTensor_setStorage"
  c_setStorage :: Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCDoubleStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCDoubleTensor_isSize"
  c_isSize :: Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCLongStorage -> IO CInt
...
foreign import ccall "THCTensor.h &THCDoubleTensor_newSizeOf"
  p_newSizeOf :: FunPtr (Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> IO (Ptr C'THCLongStorage))

-- | p_newStrideOf : Pointer to function : state self -> THCLongStorage *
foreign import ccall "THCTensor.h &THCDoubleTensor_newStrideOf"
  p_newStrideOf :: FunPtr (Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> IO (Ptr C'THCLongStorage))
...
foreign import ccall "THCTensor.h &THCDoubleTensor_newWithStorage"
  p_newWithStorage :: FunPtr (Ptr C'THCState -> Ptr C'THCDoubleStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaDoubleTensor))
...
foreign import ccall "THCTensor.h &THCDoubleTensor_newWithSize"
  p_newWithSize :: FunPtr (Ptr C'THCState -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaDoubleTensor))
...
foreign import ccall "THCTensor.h &THCDoubleTensor_newView"
  p_newView :: FunPtr (Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaDoubleTensor))

-- | p_newExpand : Pointer to function : state tensor size -> THCTensor *
foreign import ccall "THCTensor.h &THCDoubleTensor_newExpand"
  p_newExpand :: FunPtr (Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaDoubleTensor))

-- | p_expand : Pointer to function : state r tensor sizes -> void
foreign import ccall "THCTensor.h &THCDoubleTensor_expand"
  p_expand :: FunPtr (Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCudaDoubleTensor -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCDoubleTensor_resize"
  p_resize :: FunPtr (Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCDoubleTensor_setStorage"
  p_setStorage :: FunPtr (Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCDoubleStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCDoubleTensor_isSize"
  p_isSize :: FunPtr (Ptr C'THCState -> Ptr C'THCudaDoubleTensor -> Ptr C'THCLongStorage -> IO CInt)
