...
module Torch.FFI.TH.CachingAllocator
...
foreign import ccall "THCCachingAllocator.h THCCachingAllocator_recordStream"
  c_THCCachingAllocator_recordStream :: Ptr (()) -> Ptr (CTHStream) -> IO (())
...
foreign import ccall "THCCachingAllocator.h &THCCachingAllocator_recordStream"
  p_THCCachingAllocator_recordStream :: FunPtr (Ptr (()) -> Ptr (CTHStream) -> IO (()))
