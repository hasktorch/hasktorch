...
foreign import ccall "THCTensor.h THCLongTensor_newSizeOf"
  c_newSizeOf :: Ptr C'THCState -> Ptr C'THCudaLongTensor -> IO (Ptr C'THCLongStorage)

-- | c_newStrideOf :  state self -> THCLongStorage *
foreign import ccall "THCTensor.h THCLongTensor_newStrideOf"
  c_newStrideOf :: Ptr C'THCState -> Ptr C'THCudaLongTensor -> IO (Ptr C'THCLongStorage)
...
foreign import ccall "THCTensor.h THCLongTensor_newWithStorage"
  c_newWithStorage :: Ptr C'THCState -> Ptr C'THCLongStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaLongTensor)
...
foreign import ccall "THCTensor.h THCLongTensor_newWithSize"
  c_newWithSize :: Ptr C'THCState -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaLongTensor)
...
foreign import ccall "THCTensor.h THCLongTensor_newView"
  c_newView :: Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaLongTensor)

-- | c_newExpand :  state tensor size -> THCTensor *
foreign import ccall "THCTensor.h THCLongTensor_newExpand"
  c_newExpand :: Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaLongTensor)

-- | c_expand :  state r tensor sizes -> void
foreign import ccall "THCTensor.h THCLongTensor_expand"
  c_expand :: Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCLongTensor_resize"
  c_resize :: Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCLongTensor_setStorage"
  c_setStorage :: Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ()
...
foreign import ccall "THCTensor.h THCLongTensor_isSize"
  c_isSize :: Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> IO CInt
...
foreign import ccall "THCTensor.h &THCLongTensor_newSizeOf"
  p_newSizeOf :: FunPtr (Ptr C'THCState -> Ptr C'THCudaLongTensor -> IO (Ptr C'THCLongStorage))

-- | p_newStrideOf : Pointer to function : state self -> THCLongStorage *
foreign import ccall "THCTensor.h &THCLongTensor_newStrideOf"
  p_newStrideOf :: FunPtr (Ptr C'THCState -> Ptr C'THCudaLongTensor -> IO (Ptr C'THCLongStorage))
...
foreign import ccall "THCTensor.h &THCLongTensor_newWithStorage"
  p_newWithStorage :: FunPtr (Ptr C'THCState -> Ptr C'THCLongStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaLongTensor))
...
foreign import ccall "THCTensor.h &THCLongTensor_newWithSize"
  p_newWithSize :: FunPtr (Ptr C'THCState -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaLongTensor))
...
foreign import ccall "THCTensor.h &THCLongTensor_newView"
  p_newView :: FunPtr (Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaLongTensor))

-- | p_newExpand : Pointer to function : state tensor size -> THCTensor *
foreign import ccall "THCTensor.h &THCLongTensor_newExpand"
  p_newExpand :: FunPtr (Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> IO (Ptr C'THCudaLongTensor))

-- | p_expand : Pointer to function : state r tensor sizes -> void
foreign import ccall "THCTensor.h &THCLongTensor_expand"
  p_expand :: FunPtr (Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCLongTensor_resize"
  p_resize :: FunPtr (Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCLongTensor_setStorage"
  p_setStorage :: FunPtr (Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> CPtrdiff -> Ptr C'THCLongStorage -> Ptr C'THCLongStorage -> IO ())
...
foreign import ccall "THCTensor.h &THCLongTensor_isSize"
  p_isSize :: FunPtr (Ptr C'THCState -> Ptr C'THCudaLongTensor -> Ptr C'THCLongStorage -> IO CInt)
