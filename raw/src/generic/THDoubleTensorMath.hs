...
foreign import ccall "THTensorMath.h dot"
  c_dot :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble

-- | c_minall : t -> real
foreign import ccall "THTensorMath.h minall"
  c_minall :: Ptr CTHDoubleTensor -> CDouble

-- | c_maxall : t -> real
foreign import ccall "THTensorMath.h maxall"
  c_maxall :: Ptr CTHDoubleTensor -> CDouble

-- | c_medianall : t -> real
foreign import ccall "THTensorMath.h medianall"
  c_medianall :: Ptr CTHDoubleTensor -> CDouble

-- | c_sumall : t -> accreal
foreign import ccall "THTensorMath.h sumall"
  c_sumall :: Ptr CTHDoubleTensor -> CDouble

-- | c_prodall : t -> accreal
foreign import ccall "THTensorMath.h prodall"
  c_prodall :: Ptr CTHDoubleTensor -> CDouble
...
foreign import ccall "THTensorMath.h numel"
  c_numel :: Ptr CTHDoubleTensor -> CPtrdiff
...
foreign import ccall "THTensorMath.h trace"
  c_trace :: Ptr CTHDoubleTensor -> CDouble
...
foreign import ccall "THTensorMath.h equal"
  c_equal :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt
...
foreign import ccall "THTensorMath.h dist"
  c_dist :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CDouble
...
foreign import ccall "THTensorMath.h &dot"
  p_dot :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble)

-- |p_minall : Pointer to function : t -> real
foreign import ccall "THTensorMath.h &minall"
  p_minall :: FunPtr (Ptr CTHDoubleTensor -> CDouble)

-- |p_maxall : Pointer to function : t -> real
foreign import ccall "THTensorMath.h &maxall"
  p_maxall :: FunPtr (Ptr CTHDoubleTensor -> CDouble)

-- |p_medianall : Pointer to function : t -> real
foreign import ccall "THTensorMath.h &medianall"
  p_medianall :: FunPtr (Ptr CTHDoubleTensor -> CDouble)

-- |p_sumall : Pointer to function : t -> accreal
foreign import ccall "THTensorMath.h &sumall"
  p_sumall :: FunPtr (Ptr CTHDoubleTensor -> CDouble)

-- |p_prodall : Pointer to function : t -> accreal
foreign import ccall "THTensorMath.h &prodall"
  p_prodall :: FunPtr (Ptr CTHDoubleTensor -> CDouble)
...
foreign import ccall "THTensorMath.h &numel"
  p_numel :: FunPtr (Ptr CTHDoubleTensor -> CPtrdiff)
...
foreign import ccall "THTensorMath.h &trace"
  p_trace :: FunPtr (Ptr CTHDoubleTensor -> CDouble)
...
foreign import ccall "THTensorMath.h &equal"
  p_equal :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt)
...
foreign import ccall "THTensorMath.h &dist"
  p_dist :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CDouble)
...
foreign import ccall "THTensorMath.h &meanall"
  p_meanall :: FunPtr (Ptr CTHDoubleTensor -> CDouble)

-- |p_varall : Pointer to function : self biased -> accreal
foreign import ccall "THTensorMath.h &varall"
  p_varall :: FunPtr (Ptr CTHDoubleTensor -> CInt -> CDouble)

-- |p_stdall : Pointer to function : self biased -> accreal
foreign import ccall "THTensorMath.h &stdall"
  p_stdall :: FunPtr (Ptr CTHDoubleTensor -> CInt -> CDouble)

-- |p_normall : Pointer to function : t value -> accreal
foreign import ccall "THTensorMath.h &normall"
  p_normall :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> CDouble)
