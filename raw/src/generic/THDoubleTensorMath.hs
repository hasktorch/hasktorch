...
module THDoubleTensorMath (
    ...
    c_THDoubleTensor_take,
    c_THDoubleTensor_put,
    ...
    c_THDoubleTensor_add_scaled,
    c_THDoubleTensor_sub_scaled,
    ...
    c_THDoubleTensor_erf,
    c_THDoubleTensor_erfinv,
    ...
    p_THDoubleTensor_take,
    p_THDoubleTensor_put,
    ...
    p_THDoubleTensor_add_scaled,
    p_THDoubleTensor_sub_scaled,
    ...
    p_THDoubleTensor_erf,
    p_THDoubleTensor_erfinv,
...
-- |c_THDoubleTensor_take : tensor src index -> void
foreign import ccall "THTensorMath.h THDoubleTensor_take"
  c_THDoubleTensor_take :: (Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> Ptr CTHLongTensor -> IO ()

-- |c_THDoubleTensor_put : tensor index src accumulate -> void
foreign import ccall "THTensorMath.h THDoubleTensor_put"
  c_THDoubleTensor_put :: (Ptr CTHDoubleTensor) -> Ptr CTHLongTensor -> (Ptr CTHDoubleTensor) -> CInt -> IO ()
...
-- |c_THDoubleTensor_sub : r_ t value -> void
...
-- |c_THDoubleTensor_add_scaled : r_ t value alpha -> void
foreign import ccall "THTensorMath.h THDoubleTensor_add_scaled"
  c_THDoubleTensor_add_scaled :: (Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CDouble -> CDouble -> IO ()

-- |c_THDoubleTensor_sub_scaled : r_ t value alpha -> void
foreign import ccall "THTensorMath.h THDoubleTensor_sub_scaled"
  c_THDoubleTensor_sub_scaled :: (Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_kthvalue"
  c_THDoubleTensor_kthvalue :: (Ptr CTHDoubleTensor) -> Ptr CTHLongTensor -> (Ptr CTHDoubleTensor) -> CLLong -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_eye"
  c_THDoubleTensor_eye :: (Ptr CTHDoubleTensor) -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_randperm"
  c_THDoubleTensor_randperm :: (Ptr CTHDoubleTensor) -> Ptr CTHGenerator -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_topk"
  c_THDoubleTensor_topk :: (Ptr CTHDoubleTensor) -> Ptr CTHLongTensor -> (Ptr CTHDoubleTensor) -> CLLong -> CInt -> CInt -> CInt -> IO ()

-- |c_THDoubleTensor_tril : r_ t k -> void
foreign import ccall "THTensorMath.h THDoubleTensor_tril"
  c_THDoubleTensor_tril :: (Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CLLong -> IO ()

-- |c_THDoubleTensor_triu : r_ t k -> void
foreign import ccall "THTensorMath.h THDoubleTensor_triu"
  c_THDoubleTensor_triu :: (Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CLLong -> IO ()
...
-- |c_THDoubleTensor_erf : r_ t -> void
foreign import ccall "THTensorMath.h THDoubleTensor_erf"
  c_THDoubleTensor_erf :: (Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> IO ()

-- |c_THDoubleTensor_erfinv : r_ t -> void
foreign import ccall "THTensorMath.h THDoubleTensor_erfinv"
  c_THDoubleTensor_erfinv :: (Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_histc"
  c_THDoubleTensor_histc :: (Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CLLong -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_bhistc"
  c_THDoubleTensor_bhistc :: (Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CLLong -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_linspace"
  c_THDoubleTensor_linspace :: (Ptr CTHDoubleTensor) -> CDouble -> CDouble -> CLLong -> IO ()

-- |c_THDoubleTensor_logspace : r_ a b n -> void
foreign import ccall "THTensorMath.h THDoubleTensor_logspace"
  c_THDoubleTensor_logspace :: (Ptr CTHDoubleTensor) -> CDouble -> CDouble -> CLLong -> IO ()
...
-- |p_THDoubleTensor_take : Pointer to function : tensor src index -> void
foreign import ccall "THTensorMath.h &THDoubleTensor_take"
  p_THDoubleTensor_take :: FunPtr ((Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> Ptr CTHLongTensor -> IO ())

-- |p_THDoubleTensor_put : Pointer to function : tensor index src accumulate -> void
foreign import ccall "THTensorMath.h &THDoubleTensor_put"
  p_THDoubleTensor_put :: FunPtr ((Ptr CTHDoubleTensor) -> Ptr CTHLongTensor -> (Ptr CTHDoubleTensor) -> CInt -> IO ())
...
-- |p_THDoubleTensor_sub : Pointer to function : r_ t value -> void
foreign import ccall "THTensorMath.h &THDoubleTensor_sub"
  p_THDoubleTensor_sub :: FunPtr ((Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CDouble -> IO ())

-- |p_THDoubleTensor_add_scaled : Pointer to function : r_ t value alpha -> void
foreign import ccall "THTensorMath.h &THDoubleTensor_add_scaled"
  p_THDoubleTensor_add_scaled :: FunPtr ((Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CDouble -> CDouble -> IO ())

-- |p_THDoubleTensor_sub_scaled : Pointer to function : r_ t value alpha -> void
foreign import ccall "THTensorMath.h &THDoubleTensor_sub_scaled"
  p_THDoubleTensor_sub_scaled :: FunPtr ((Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_kthvalue"
  p_THDoubleTensor_kthvalue :: FunPtr ((Ptr CTHDoubleTensor) -> Ptr CTHLongTensor -> (Ptr CTHDoubleTensor) -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_eye"
  p_THDoubleTensor_eye :: FunPtr ((Ptr CTHDoubleTensor) -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_randperm"
  p_THDoubleTensor_randperm :: FunPtr ((Ptr CTHDoubleTensor) -> Ptr CTHGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_topk"
  p_THDoubleTensor_topk :: FunPtr ((Ptr CTHDoubleTensor) -> Ptr CTHLongTensor -> (Ptr CTHDoubleTensor) -> CLLong -> CInt -> CInt -> CInt -> IO ())

-- |p_THDoubleTensor_tril : Pointer to function : r_ t k -> void
foreign import ccall "THTensorMath.h &THDoubleTensor_tril"
  p_THDoubleTensor_tril :: FunPtr ((Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CLLong -> IO ())

-- |p_THDoubleTensor_triu : Pointer to function : r_ t k -> void
foreign import ccall "THTensorMath.h &THDoubleTensor_triu"
  p_THDoubleTensor_triu :: FunPtr ((Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CLLong -> IO ())
...
-- |p_THDoubleTensor_erf : Pointer to function : r_ t -> void
foreign import ccall "THTensorMath.h &THDoubleTensor_erf"
  p_THDoubleTensor_erf :: FunPtr ((Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> IO ())

-- |p_THDoubleTensor_erfinv : Pointer to function : r_ t -> void
foreign import ccall "THTensorMath.h &THDoubleTensor_erfinv"
  p_THDoubleTensor_erfinv :: FunPtr ((Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_histc"
  p_THDoubleTensor_histc :: FunPtr ((Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CLLong -> CDouble -> CDouble -> IO ())

-- |p_THDoubleTensor_bhistc : Pointer to function : hist tensor nbins minvalue maxvalue -> void
foreign import ccall "THTensorMath.h &THDoubleTensor_bhistc"
  p_THDoubleTensor_bhistc :: FunPtr ((Ptr CTHDoubleTensor) -> (Ptr CTHDoubleTensor) -> CLLong -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_linspace"
  p_THDoubleTensor_linspace :: FunPtr ((Ptr CTHDoubleTensor) -> CDouble -> CDouble -> CLLong -> IO ())

-- |p_THDoubleTensor_logspace : Pointer to function : r_ a b n -> void
foreign import ccall "THTensorMath.h &THDoubleTensor_logspace"
  p_THDoubleTensor_logspace :: FunPtr ((Ptr CTHDoubleTensor) -> CDouble -> CDouble -> CLLong -> IO ())
