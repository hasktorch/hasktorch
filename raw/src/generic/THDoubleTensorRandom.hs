...
foreign import ccall "THTensorRandom.h normal_stddevs"
...
foreign import ccall "THTensorRandom.h normal_means_stddevs"
...
foreign import ccall "THTensorRandom.h &bernoulli_Tensor"
  p_bernoulli_Tensor :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHGenerator -> Ptr CTHDoubleTensor -> IO ())
