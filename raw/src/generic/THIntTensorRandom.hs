...
module THIntTensorRandom (
    ...
    c_THIntTensor_bernoulli_Tensor,
    ...
    p_THIntTensor_bernoulli_DoubleTensor,
    p_THIntTensor_bernoulli_Tensor) where
...
-- |c_THIntTensor_bernoulli_Tensor : self _generator p -> void
foreign import ccall "THTensorRandom.h THIntTensor_bernoulli_Tensor"
  c_THIntTensor_bernoulli_Tensor :: (Ptr CTHIntTensor) -> Ptr CTHGenerator -> (Ptr CTHIntTensor) -> IO ()
...
-- |p_THIntTensor_bernoulli_Tensor : Pointer to function : self _generator p -> void
foreign import ccall "THTensorRandom.h &THIntTensor_bernoulli_Tensor"
  p_THIntTensor_bernoulli_Tensor :: FunPtr ((Ptr CTHIntTensor) -> Ptr CTHGenerator -> (Ptr CTHIntTensor) -> IO ())