...
module THByteTensorMath (
    ...
    c_THByteTensor_add,
    c_THByteTensor_sub,
    c_THByteTensor_add_scaled,
    c_THByteTensor_sub_scaled,
    c_THByteTensor_mul,
    c_THByteTensor_div,
    ...
    p_THByteTensor_add,
    p_THByteTensor_sub,
    p_THByteTensor_add_scaled,
    p_THByteTensor_sub_scaled,
    p_THByteTensor_mul,
    p_THByteTensor_div,
...
-- |c_THByteTensor_take : tensor src index -> void
foreign import ccall "THTensorMath.h THByteTensor_take"
  c_THByteTensor_take :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> Ptr CTHLongTensor -> IO ()

-- |c_THByteTensor_put : tensor index src accumulate -> void
foreign import ccall "THTensorMath.h THByteTensor_put"
  c_THByteTensor_put :: (Ptr CTHByteTensor) -> Ptr CTHLongTensor -> (Ptr CTHByteTensor) -> CInt -> IO ()
...
-- |c_THByteTensor_sub : r_ t value -> void
foreign import ccall "THTensorMath.h THByteTensor_sub"
  c_THByteTensor_sub :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> IO ()

-- |c_THByteTensor_add_scaled : r_ t value alpha -> void
foreign import ccall "THTensorMath.h THByteTensor_add_scaled"
  c_THByteTensor_add_scaled :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> CChar -> IO ()

-- |c_THByteTensor_sub_scaled : r_ t value alpha -> void
foreign import ccall "THTensorMath.h THByteTensor_sub_scaled"
  c_THByteTensor_sub_scaled :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CChar -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THByteTensor_kthvalue"
  c_THByteTensor_kthvalue :: (Ptr CTHByteTensor) -> Ptr CTHLongTensor -> (Ptr CTHByteTensor) -> CLLong -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THByteTensor_eye"
  c_THByteTensor_eye :: (Ptr CTHByteTensor) -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THByteTensor_randperm"
  c_THByteTensor_randperm :: (Ptr CTHByteTensor) -> Ptr CTHGenerator -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THByteTensor_topk"
  c_THByteTensor_topk :: (Ptr CTHByteTensor) -> Ptr CTHLongTensor -> (Ptr CTHByteTensor) -> CLLong -> CInt -> CInt -> CInt -> IO ()

-- |c_THByteTensor_tril : r_ t k -> void
foreign import ccall "THTensorMath.h THByteTensor_tril"
  c_THByteTensor_tril :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CLLong -> IO ()

-- |c_THByteTensor_triu : r_ t k -> void
foreign import ccall "THTensorMath.h THByteTensor_triu"
  c_THByteTensor_triu :: (Ptr CTHByteTensor) -> (Ptr CTHByteTensor) -> CLLong -> IO ()
