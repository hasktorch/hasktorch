...
module THIntTensorMath (
    ...
    c_THIntTensor_add,
    c_THIntTensor_sub,
    c_THIntTensor_add_scaled,
    c_THIntTensor_sub_scaled,
    c_THIntTensor_mul,
    c_THIntTensor_div,
    ...
    p_THIntTensor_add,
    p_THIntTensor_sub,
    p_THIntTensor_add_scaled,
    p_THIntTensor_sub_scaled,
    p_THIntTensor_mul,
    p_THIntTensor_div,
...
-- |c_THIntTensor_take : tensor src index -> void
foreign import ccall "THTensorMath.h THIntTensor_take"
  c_THIntTensor_take :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> Ptr CTHLongTensor -> IO ()

-- |c_THIntTensor_put : tensor index src accumulate -> void
foreign import ccall "THTensorMath.h THIntTensor_put"
  c_THIntTensor_put :: (Ptr CTHIntTensor) -> Ptr CTHLongTensor -> (Ptr CTHIntTensor) -> CInt -> IO ()
...
-- |c_THIntTensor_sub : r_ t value -> void
foreign import ccall "THTensorMath.h THIntTensor_sub"
  c_THIntTensor_sub :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> IO ()

-- |c_THIntTensor_add_scaled : r_ t value alpha -> void
foreign import ccall "THTensorMath.h THIntTensor_add_scaled"
  c_THIntTensor_add_scaled :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> CInt -> IO ()

-- |c_THIntTensor_sub_scaled : r_ t value alpha -> void
foreign import ccall "THTensorMath.h THIntTensor_sub_scaled"
  c_THIntTensor_sub_scaled :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_kthvalue"
  c_THIntTensor_kthvalue :: (Ptr CTHIntTensor) -> Ptr CTHLongTensor -> (Ptr CTHIntTensor) -> CLLong -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_eye"
  c_THIntTensor_eye :: (Ptr CTHIntTensor) -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_randperm"
  c_THIntTensor_randperm :: (Ptr CTHIntTensor) -> Ptr CTHGenerator -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_topk"
  c_THIntTensor_topk :: (Ptr CTHIntTensor) -> Ptr CTHLongTensor -> (Ptr CTHIntTensor) -> CLLong -> CInt -> CInt -> CInt -> IO ()

-- |c_THIntTensor_tril : r_ t k -> void
foreign import ccall "THTensorMath.h THIntTensor_tril"
  c_THIntTensor_tril :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CLLong -> IO ()

-- |c_THIntTensor_triu : r_ t k -> void
foreign import ccall "THTensorMath.h THIntTensor_triu"
  c_THIntTensor_triu :: (Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CLLong -> IO ()
...
-- |p_THIntTensor_take : Pointer to function : tensor src index -> void
foreign import ccall "THTensorMath.h &THIntTensor_take"
  p_THIntTensor_take :: FunPtr ((Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> Ptr CTHLongTensor -> IO ())

-- |p_THIntTensor_put : Pointer to function : tensor index src accumulate -> void
foreign import ccall "THTensorMath.h &THIntTensor_put"
  p_THIntTensor_put :: FunPtr ((Ptr CTHIntTensor) -> Ptr CTHLongTensor -> (Ptr CTHIntTensor) -> CInt -> IO ())
...
-- |p_THIntTensor_sub : Pointer to function : r_ t value -> void
foreign import ccall "THTensorMath.h &THIntTensor_sub"
  p_THIntTensor_sub :: FunPtr ((Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> IO ())

-- |p_THIntTensor_add_scaled : Pointer to function : r_ t value alpha -> void
foreign import ccall "THTensorMath.h &THIntTensor_add_scaled"
  p_THIntTensor_add_scaled :: FunPtr ((Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> CInt -> IO ())

-- |p_THIntTensor_sub_scaled : Pointer to function : r_ t value alpha -> void
foreign import ccall "THTensorMath.h &THIntTensor_sub_scaled"
  p_THIntTensor_sub_scaled :: FunPtr ((Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_kthvalue"
  p_THIntTensor_kthvalue :: FunPtr ((Ptr CTHIntTensor) -> Ptr CTHLongTensor -> (Ptr CTHIntTensor) -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_eye"
  p_THIntTensor_eye :: FunPtr ((Ptr CTHIntTensor) -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_randperm"
  p_THIntTensor_randperm :: FunPtr ((Ptr CTHIntTensor) -> Ptr CTHGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_topk"
  p_THIntTensor_topk :: FunPtr ((Ptr CTHIntTensor) -> Ptr CTHLongTensor -> (Ptr CTHIntTensor) -> CLLong -> CInt -> CInt -> CInt -> IO ())

-- |p_THIntTensor_tril : Pointer to function : r_ t k -> void
foreign import ccall "THTensorMath.h &THIntTensor_tril"
  p_THIntTensor_tril :: FunPtr ((Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CLLong -> IO ())

-- |p_THIntTensor_triu : Pointer to function : r_ t k -> void
foreign import ccall "THTensorMath.h &THIntTensor_triu"
  p_THIntTensor_triu :: FunPtr ((Ptr CTHIntTensor) -> (Ptr CTHIntTensor) -> CLLong -> IO ())
