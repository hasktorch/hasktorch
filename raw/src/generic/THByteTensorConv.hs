...
foreign import ccall "THTensorConv.h THByteTensor_conv2DRevger"
  c_conv2DRevger :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> IO ()

-- | c_conv2DRevgerm :  r_ beta alpha t_ k_ srow scol -> void
foreign import ccall "THTensorConv.h THByteTensor_conv2DRevgerm"
  c_conv2DRevgerm :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> IO ()

-- | c_conv2Dger :  r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h THByteTensor_conv2Dger"
  c_conv2Dger :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | c_conv2Dmv :  r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h THByteTensor_conv2Dmv"
  c_conv2Dmv :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | c_conv2Dmm :  r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h THByteTensor_conv2Dmm"
  c_conv2Dmm :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | c_conv2Dmul :  r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h THByteTensor_conv2Dmul"
  c_conv2Dmul :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | c_conv2Dcmul :  r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h THByteTensor_conv2Dcmul"
  c_conv2Dcmul :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THByteTensor_conv3DRevger"
  c_conv3DRevger :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> CLLong -> IO ()

-- | c_conv3Dger :  r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h THByteTensor_conv3Dger"
  c_conv3Dger :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | c_conv3Dmv :  r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h THByteTensor_conv3Dmv"
  c_conv3Dmv :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | c_conv3Dmul :  r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h THByteTensor_conv3Dmul"
  c_conv3Dmul :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | c_conv3Dcmul :  r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h THByteTensor_conv3Dcmul"
  c_conv3Dcmul :: Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h &THByteTensor_conv2DRevger"
  p_conv2DRevger :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> IO ())

-- | p_conv2DRevgerm : Pointer to function : r_ beta alpha t_ k_ srow scol -> void
foreign import ccall "THTensorConv.h &THByteTensor_conv2DRevgerm"
  p_conv2DRevgerm :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> IO ())

-- | p_conv2Dger : Pointer to function : r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THByteTensor_conv2Dger"
  p_conv2Dger :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv2Dmv : Pointer to function : r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THByteTensor_conv2Dmv"
  p_conv2Dmv :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv2Dmm : Pointer to function : r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THByteTensor_conv2Dmm"
  p_conv2Dmm :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv2Dmul : Pointer to function : r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THByteTensor_conv2Dmul"
  p_conv2Dmul :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv2Dcmul : Pointer to function : r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THByteTensor_conv2Dcmul"
  p_conv2Dcmul :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THByteTensor_conv3DRevger"
  p_conv3DRevger :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> CLLong -> IO ())

-- | p_conv3Dger : Pointer to function : r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THByteTensor_conv3Dger"
  p_conv3Dger :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv3Dmv : Pointer to function : r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THByteTensor_conv3Dmv"
  p_conv3Dmv :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv3Dmul : Pointer to function : r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THByteTensor_conv3Dmul"
  p_conv3Dmul :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv3Dcmul : Pointer to function : r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THByteTensor_conv3Dcmul"
  p_conv3Dcmul :: FunPtr (Ptr CTHByteTensor -> CChar -> CChar -> Ptr CTHByteTensor -> Ptr CTHByteTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())