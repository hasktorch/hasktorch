...
foreign import ccall "THTensorMath.h &THCharTensor_fill"
  p_fill_ :: FunPtr (Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_zero"
  p_zero_ :: FunPtr (Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_maskedFill"
  p_maskedFill_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THByteTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_maskedCopy"
  p_maskedCopy_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THByteTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_maskedSelect"
  p_maskedSelect_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_nonzero"
  p_nonzero_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_indexSelect"
  p_indexSelect_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_indexCopy"
  p_indexCopy_ :: FunPtr (Ptr C'THCharTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_indexAdd"
  p_indexAdd_ :: FunPtr (Ptr C'THCharTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_indexFill"
  p_indexFill_ :: FunPtr (Ptr C'THCharTensor -> CInt -> Ptr C'THLongTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_take"
  p_take_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_put"
  p_put_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_gather"
  p_gather_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_scatter"
  p_scatter_ :: FunPtr (Ptr C'THCharTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_scatterAdd"
  p_scatterAdd_ :: FunPtr (Ptr C'THCharTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_scatterFill"
  p_scatterFill_ :: FunPtr (Ptr C'THCharTensor -> CInt -> Ptr C'THLongTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_dot"
  p_dot_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THCharTensor_minall"
  p_minall_ :: FunPtr (Ptr C'THCharTensor -> IO CChar)
...
foreign import ccall "THTensorMath.h &THCharTensor_maxall"
  p_maxall_ :: FunPtr (Ptr C'THCharTensor -> IO CChar)
...
foreign import ccall "THTensorMath.h &THCharTensor_medianall"
  p_medianall_ :: FunPtr (Ptr C'THCharTensor -> IO CChar)
...
foreign import ccall "THTensorMath.h &THCharTensor_sumall"
  p_sumall_ :: FunPtr (Ptr C'THCharTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THCharTensor_prodall"
  p_prodall_ :: FunPtr (Ptr C'THCharTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THCharTensor_add"
  p_add_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_sub"
  p_sub_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_add_scaled"
  p_add_scaled_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_sub_scaled"
  p_sub_scaled_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_mul"
  p_mul_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_div"
  p_div_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_lshift"
  p_lshift_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_rshift"
  p_rshift_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_fmod"
  p_fmod_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_remainder"
  p_remainder_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_clamp"
  p_clamp_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_bitand"
  p_bitand_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_bitor"
  p_bitor_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_bitxor"
  p_bitxor_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cadd"
  p_cadd_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_csub"
  p_csub_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cmul"
  p_cmul_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cpow"
  p_cpow_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cdiv"
  p_cdiv_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_clshift"
  p_clshift_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_crshift"
  p_crshift_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cfmod"
  p_cfmod_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cremainder"
  p_cremainder_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cbitand"
  p_cbitand_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cbitor"
  p_cbitor_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cbitxor"
  p_cbitxor_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addcmul"
  p_addcmul_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addcdiv"
  p_addcdiv_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addmv"
  p_addmv_ :: FunPtr (Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addmm"
  p_addmm_ :: FunPtr (Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addr"
  p_addr_ :: FunPtr (Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addbmm"
  p_addbmm_ :: FunPtr (Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_baddbmm"
  p_baddbmm_ :: FunPtr (Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> CChar -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_match"
  p_match_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_numel"
  p_numel_ :: FunPtr (Ptr C'THCharTensor -> IO CPtrdiff)
...
foreign import ccall "THTensorMath.h &THCharTensor_preserveReduceDimSemantics"
  p_preserveReduceDimSemantics_ :: FunPtr (Ptr C'THCharTensor -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_max"
  p_max_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_min"
  p_min_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_kthvalue"
  p_kthvalue_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_mode"
  p_mode_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_median"
  p_median_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_sum"
  p_sum_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_prod"
  p_prod_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cumsum"
  p_cumsum_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cumprod"
  p_cumprod_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_sign"
  p_sign_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_trace"
  p_trace_ :: FunPtr (Ptr C'THCharTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THCharTensor_cross"
  p_cross_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cmax"
  p_cmax_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cmin"
  p_cmin_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cmaxValue"
  p_cmaxValue_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cminValue"
  p_cminValue_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_zeros"
  p_zeros_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_zerosLike"
  p_zerosLike_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_ones"
  p_ones_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_onesLike"
  p_onesLike_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_diag"
  p_diag_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_eye"
  p_eye_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_arange"
  p_arange_ :: FunPtr (Ptr C'THCharTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_range"
  p_range_ :: FunPtr (Ptr C'THCharTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_randperm"
  p_randperm_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_reshape"
  p_reshape_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_sort"
  p_sort_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_topk"
  p_topk_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongTensor -> Ptr C'THCharTensor -> CLLong -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_tril"
  p_tril_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_triu"
  p_triu_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cat"
  p_cat_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_catArray"
  p_catArray_ :: FunPtr (Ptr C'THCharTensor -> Ptr (Ptr C'THCharTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_equal"
  p_equal_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THCharTensor_ltValue"
  p_ltValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_leValue"
  p_leValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_gtValue"
  p_gtValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_geValue"
  p_geValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_neValue"
  p_neValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_eqValue"
  p_eqValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_ltValueT"
  p_ltValueT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_leValueT"
  p_leValueT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_gtValueT"
  p_gtValueT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_geValueT"
  p_geValueT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_neValueT"
  p_neValueT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_eqValueT"
  p_eqValueT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_ltTensor"
  p_ltTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_leTensor"
  p_leTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_gtTensor"
  p_gtTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_geTensor"
  p_geTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_neTensor"
  p_neTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_eqTensor"
  p_eqTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_ltTensorT"
  p_ltTensorT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_leTensorT"
  p_leTensorT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_gtTensorT"
  p_gtTensorT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_geTensorT"
  p_geTensorT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_neTensorT"
  p_neTensorT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_eqTensorT"
  p_eqTensorT_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
