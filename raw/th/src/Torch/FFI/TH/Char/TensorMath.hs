...
foreign import ccall "THTensorMath.h THCharTensor_fill"
  c_fill_ :: Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_maskedFill"
  c_maskedFill_ :: Ptr CTHCharTensor -> Ptr CTHByteTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_maskedCopy"
  c_maskedCopy_ :: Ptr CTHCharTensor -> Ptr CTHByteTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_maskedSelect"
  c_maskedSelect_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHByteTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_nonzero"
  c_nonzero_ :: Ptr CTHLongTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_indexSelect"
  c_indexSelect_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_indexCopy"
  c_indexCopy_ :: Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_indexAdd"
  c_indexAdd_ :: Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_indexFill"
  c_indexFill_ :: Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_take"
  c_take_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_put"
  c_put_ :: Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_gather"
  c_gather_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_scatter"
  c_scatter_ :: Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_scatterAdd"
  c_scatterAdd_ :: Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_scatterFill"
  c_scatterFill_ :: Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_dot"
  c_dot_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THCharTensor_minall"
  c_minall_ :: Ptr CTHCharTensor -> IO CChar
...
foreign import ccall "THTensorMath.h THCharTensor_maxall"
  c_maxall_ :: Ptr CTHCharTensor -> IO CChar
...
foreign import ccall "THTensorMath.h THCharTensor_medianall"
  c_medianall_ :: Ptr CTHCharTensor -> IO CChar
...
foreign import ccall "THTensorMath.h THCharTensor_sumall"
  c_sumall_ :: Ptr CTHCharTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THCharTensor_prodall"
  c_prodall_ :: Ptr CTHCharTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THCharTensor_add"
  c_add_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_sub"
  c_sub_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_add_scaled"
  c_add_scaled_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_sub_scaled"
  c_sub_scaled_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_mul"
  c_mul_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_div"
  c_div_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_lshift"
  c_lshift_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_rshift"
  c_rshift_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_fmod"
  c_fmod_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_remainder"
  c_remainder_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_clamp"
  c_clamp_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_bitand"
  c_bitand_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_bitor"
  c_bitor_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_bitxor"
  c_bitxor_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cadd"
  c_cadd_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_csub"
  c_csub_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cmul"
  c_cmul_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cpow"
  c_cpow_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cdiv"
  c_cdiv_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_clshift"
  c_clshift_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_crshift"
  c_crshift_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cfmod"
  c_cfmod_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cremainder"
  c_cremainder_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cbitand"
  c_cbitand_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cbitor"
  c_cbitor_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cbitxor"
  c_cbitxor_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_addcmul"
  c_addcmul_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_addcdiv"
  c_addcdiv_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_addmv"
  c_addmv_ :: Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_addmm"
  c_addmm_ :: Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_addr"
  c_addr_ :: Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_addbmm"
  c_addbmm_ :: Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_baddbmm"
  c_baddbmm_ :: Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_match"
  c_match_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_numel"
  c_numel_ :: Ptr CTHCharTensor -> IO CPtrdiff
...
foreign import ccall "THTensorMath.h THCharTensor_max"
  c_max_ :: Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_min"
  c_min_ :: Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_kthvalue"
  c_kthvalue_ :: Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CLLong -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_mode"
  c_mode_ :: Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_median"
  c_median_ :: Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_sum"
  c_sum_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_prod"
  c_prod_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cumsum"
  c_cumsum_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cumprod"
  c_cumprod_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_sign"
  c_sign_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_trace"
  c_trace_ :: Ptr CTHCharTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THCharTensor_cross"
  c_cross_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cmax"
  c_cmax_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cmin"
  c_cmin_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cmaxValue"
  c_cmaxValue_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cminValue"
  c_cminValue_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_zeros"
  c_zeros_ :: Ptr CTHCharTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_zerosLike"
  c_zerosLike_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_ones"
  c_ones_ :: Ptr CTHCharTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_onesLike"
  c_onesLike_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_diag"
  c_diag_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_eye"
  c_eye_ :: Ptr CTHCharTensor -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_arange"
  c_arange_ :: Ptr CTHCharTensor -> CLong -> CLong -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_range"
  c_range_ :: Ptr CTHCharTensor -> CLong -> CLong -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_randperm"
  c_randperm_ :: Ptr CTHCharTensor -> Ptr CTHGenerator -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_reshape"
  c_reshape_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_sort"
  c_sort_ :: Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_topk"
  c_topk_ :: Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CLLong -> CInt -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_tril"
  c_tril_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_triu"
  c_triu_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_cat"
  c_cat_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_catArray"
  c_catArray_ :: Ptr CTHCharTensor -> Ptr (Ptr CTHCharTensor) -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_equal"
  c_equal_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO CInt
...
foreign import ccall "THTensorMath.h THCharTensor_ltValue"
  c_ltValue_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_leValue"
  c_leValue_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_gtValue"
  c_gtValue_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_geValue"
  c_geValue_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_neValue"
  c_neValue_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_eqValue"
  c_eqValue_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_ltValueT"
  c_ltValueT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_leValueT"
  c_leValueT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_gtValueT"
  c_gtValueT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_geValueT"
  c_geValueT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_neValueT"
  c_neValueT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_eqValueT"
  c_eqValueT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_ltTensor"
  c_ltTensor_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_leTensor"
  c_leTensor_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_gtTensor"
  c_gtTensor_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_geTensor"
  c_geTensor_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_neTensor"
  c_neTensor_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_eqTensor"
  c_eqTensor_ :: Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_ltTensorT"
  c_ltTensorT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_leTensorT"
  c_leTensorT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_gtTensorT"
  c_gtTensorT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_geTensorT"
  c_geTensorT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_neTensorT"
  c_neTensorT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h THCharTensor_eqTensorT"
  c_eqTensorT_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorMath.h &THCharTensor_fill"
  p_fill_ :: FunPtr (Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_zero"
  p_zero_ :: FunPtr (Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_maskedFill"
  p_maskedFill_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHByteTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_maskedCopy"
  p_maskedCopy_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHByteTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_maskedSelect"
  p_maskedSelect_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_nonzero"
  p_nonzero_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_indexSelect"
  p_indexSelect_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_indexCopy"
  p_indexCopy_ :: FunPtr (Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_indexAdd"
  p_indexAdd_ :: FunPtr (Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_indexFill"
  p_indexFill_ :: FunPtr (Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_take"
  p_take_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_put"
  p_put_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_gather"
  p_gather_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_scatter"
  p_scatter_ :: FunPtr (Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_scatterAdd"
  p_scatterAdd_ :: FunPtr (Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_scatterFill"
  p_scatterFill_ :: FunPtr (Ptr CTHCharTensor -> CInt -> Ptr CTHLongTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_dot"
  p_dot_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THCharTensor_minall"
  p_minall_ :: FunPtr (Ptr CTHCharTensor -> IO CChar)
...
foreign import ccall "THTensorMath.h &THCharTensor_maxall"
  p_maxall_ :: FunPtr (Ptr CTHCharTensor -> IO CChar)
...
foreign import ccall "THTensorMath.h &THCharTensor_medianall"
  p_medianall_ :: FunPtr (Ptr CTHCharTensor -> IO CChar)
...
foreign import ccall "THTensorMath.h &THCharTensor_sumall"
  p_sumall_ :: FunPtr (Ptr CTHCharTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THCharTensor_prodall"
  p_prodall_ :: FunPtr (Ptr CTHCharTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THCharTensor_add"
  p_add_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_sub"
  p_sub_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_add_scaled"
  p_add_scaled_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_sub_scaled"
  p_sub_scaled_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_mul"
  p_mul_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_div"
  p_div_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_lshift"
  p_lshift_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_rshift"
  p_rshift_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_fmod"
  p_fmod_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_remainder"
  p_remainder_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_clamp"
  p_clamp_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_bitand"
  p_bitand_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_bitor"
  p_bitor_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_bitxor"
  p_bitxor_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cadd"
  p_cadd_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_csub"
  p_csub_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cmul"
  p_cmul_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cpow"
  p_cpow_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cdiv"
  p_cdiv_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_clshift"
  p_clshift_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_crshift"
  p_crshift_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cfmod"
  p_cfmod_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cremainder"
  p_cremainder_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cbitand"
  p_cbitand_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cbitor"
  p_cbitor_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cbitxor"
  p_cbitxor_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addcmul"
  p_addcmul_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addcdiv"
  p_addcdiv_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addmv"
  p_addmv_ :: FunPtr (Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addmm"
  p_addmm_ :: FunPtr (Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addr"
  p_addr_ :: FunPtr (Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_addbmm"
  p_addbmm_ :: FunPtr (Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_baddbmm"
  p_baddbmm_ :: FunPtr (Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> CChar -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_match"
  p_match_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_numel"
  p_numel_ :: FunPtr (Ptr CTHCharTensor -> IO CPtrdiff)
...
foreign import ccall "THTensorMath.h &THCharTensor_max"
  p_max_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_min"
  p_min_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_kthvalue"
  p_kthvalue_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_mode"
  p_mode_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_median"
  p_median_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_sum"
  p_sum_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_prod"
  p_prod_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cumsum"
  p_cumsum_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cumprod"
  p_cumprod_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_sign"
  p_sign_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_trace"
  p_trace_ :: FunPtr (Ptr CTHCharTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THCharTensor_cross"
  p_cross_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cmax"
  p_cmax_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cmin"
  p_cmin_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cmaxValue"
  p_cmaxValue_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cminValue"
  p_cminValue_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_zeros"
  p_zeros_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_zerosLike"
  p_zerosLike_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_ones"
  p_ones_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_onesLike"
  p_onesLike_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_diag"
  p_diag_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_eye"
  p_eye_ :: FunPtr (Ptr CTHCharTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_arange"
  p_arange_ :: FunPtr (Ptr CTHCharTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_range"
  p_range_ :: FunPtr (Ptr CTHCharTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_randperm"
  p_randperm_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_reshape"
  p_reshape_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_sort"
  p_sort_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_topk"
  p_topk_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHLongTensor -> Ptr CTHCharTensor -> CLLong -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_tril"
  p_tril_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_triu"
  p_triu_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_cat"
  p_cat_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_catArray"
  p_catArray_ :: FunPtr (Ptr CTHCharTensor -> Ptr (Ptr CTHCharTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_equal"
  p_equal_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THCharTensor_ltValue"
  p_ltValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_leValue"
  p_leValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_gtValue"
  p_gtValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_geValue"
  p_geValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_neValue"
  p_neValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_eqValue"
  p_eqValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_ltValueT"
  p_ltValueT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_leValueT"
  p_leValueT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_gtValueT"
  p_gtValueT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_geValueT"
  p_geValueT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_neValueT"
  p_neValueT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_eqValueT"
  p_eqValueT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_ltTensor"
  p_ltTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_leTensor"
  p_leTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_gtTensor"
  p_gtTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_geTensor"
  p_geTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_neTensor"
  p_neTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_eqTensor"
  p_eqTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_ltTensorT"
  p_ltTensorT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_leTensorT"
  p_leTensorT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_gtTensorT"
  p_gtTensorT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_geTensorT"
  p_geTensorT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_neTensorT"
  p_neTensorT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THCharTensor_eqTensorT"
  p_eqTensorT_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
