...
foreign import ccall "THTensor.h &THCharTensor_storage"
  p_storage_ :: FunPtr (Ptr C'THCharTensor -> IO (Ptr C'THCharStorage))
...
foreign import ccall "THTensor.h &THCharTensor_storageOffset"
  p_storageOffset_ :: FunPtr (Ptr C'THCharTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THCharTensor_nDimension"
  p_nDimension_ :: FunPtr (Ptr C'THCharTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THCharTensor_size"
  p_size_ :: FunPtr (Ptr C'THCharTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THCharTensor_stride"
  p_stride_ :: FunPtr (Ptr C'THCharTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THCharTensor_newSizeOf"
  p_newSizeOf_ :: FunPtr (Ptr C'THCharTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THCharTensor_newStrideOf"
  p_newStrideOf_ :: FunPtr (Ptr C'THCharTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THCharTensor_data"
  p_data_ :: FunPtr (Ptr C'THCharTensor -> IO (Ptr CChar))
...
foreign import ccall "THTensor.h &THCharTensor_setFlag"
  p_setFlag_ :: FunPtr (Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr C'THCharTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_new"
  p_new_ :: FunPtr (IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newWithTensor"
  p_newWithTensor_ :: FunPtr (Ptr C'THCharTensor -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newWithStorage"
  p_newWithStorage_ :: FunPtr (Ptr C'THCharStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newWithStorage1d"
  p_newWithStorage1d_ :: FunPtr (Ptr C'THCharStorage -> CPtrdiff -> CLLong -> CLLong -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newWithStorage2d"
  p_newWithStorage2d_ :: FunPtr (Ptr C'THCharStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newWithStorage3d"
  p_newWithStorage3d_ :: FunPtr (Ptr C'THCharStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newWithStorage4d"
  p_newWithStorage4d_ :: FunPtr (Ptr C'THCharStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newWithSize"
  p_newWithSize_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newWithSize1d"
  p_newWithSize1d_ :: FunPtr (CLLong -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newWithSize2d"
  p_newWithSize2d_ :: FunPtr (CLLong -> CLLong -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newWithSize3d"
  p_newWithSize3d_ :: FunPtr (CLLong -> CLLong -> CLLong -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newWithSize4d"
  p_newWithSize4d_ :: FunPtr (CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newClone"
  p_newClone_ :: FunPtr (Ptr C'THCharTensor -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newContiguous"
  p_newContiguous_ :: FunPtr (Ptr C'THCharTensor -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newSelect"
  p_newSelect_ :: FunPtr (Ptr C'THCharTensor -> CInt -> CLLong -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newNarrow"
  p_newNarrow_ :: FunPtr (Ptr C'THCharTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newTranspose"
  p_newTranspose_ :: FunPtr (Ptr C'THCharTensor -> CInt -> CInt -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newUnfold"
  p_newUnfold_ :: FunPtr (Ptr C'THCharTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newView"
  p_newView_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongStorage -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_newExpand"
  p_newExpand_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongStorage -> IO (Ptr C'THCharTensor))
...
foreign import ccall "THTensor.h &THCharTensor_expand"
  p_expand_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_expandNd"
  p_expandNd_ :: FunPtr (Ptr (Ptr C'THCharTensor) -> Ptr (Ptr C'THCharTensor) -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_resize"
  p_resize_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_resizeAs"
  p_resizeAs_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_resizeNd"
  p_resizeNd_ :: FunPtr (Ptr C'THCharTensor -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_resize1d"
  p_resize1d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_resize2d"
  p_resize2d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_resize3d"
  p_resize3d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_resize4d"
  p_resize4d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_resize5d"
  p_resize5d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_set"
  p_set_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_setStorage"
  p_setStorage_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_setStorageNd"
  p_setStorageNd_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharStorage -> CPtrdiff -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_setStorage1d"
  p_setStorage1d_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharStorage -> CPtrdiff -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_setStorage2d"
  p_setStorage2d_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_setStorage3d"
  p_setStorage3d_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_setStorage4d"
  p_setStorage4d_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_narrow"
  p_narrow_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_select"
  p_select_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_transpose"
  p_transpose_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_unfold"
  p_unfold_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_squeeze"
  p_squeeze_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_squeeze1d"
  p_squeeze1d_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_unsqueeze1d"
  p_unsqueeze1d_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_isContiguous"
  p_isContiguous_ :: FunPtr (Ptr C'THCharTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THCharTensor_isSameSizeAs"
  p_isSameSizeAs_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THCharTensor_isSetTo"
  p_isSetTo_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THCharTensor_isSize"
  p_isSize_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THLongStorage -> IO CInt)
...
foreign import ccall "THTensor.h &THCharTensor_nElement"
  p_nElement_ :: FunPtr (Ptr C'THCharTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THCharTensor_retain"
  p_retain_ :: FunPtr (Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_free"
  p_free_ :: FunPtr (Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_freeCopyTo"
  p_freeCopyTo_ :: FunPtr (Ptr C'THCharTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_set1d"
  p_set1d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_set2d"
  p_set2d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CLLong -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_set3d"
  p_set3d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CLLong -> CLLong -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_set4d"
  p_set4d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THCharTensor_get1d"
  p_get1d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> IO CChar)
...
foreign import ccall "THTensor.h &THCharTensor_get2d"
  p_get2d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CLLong -> IO CChar)
...
foreign import ccall "THTensor.h &THCharTensor_get3d"
  p_get3d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CLLong -> CLLong -> IO CChar)
...
foreign import ccall "THTensor.h &THCharTensor_get4d"
  p_get4d_ :: FunPtr (Ptr C'THCharTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO CChar)
...
foreign import ccall "THTensor.h &THCharTensor_desc"
  p_desc_ :: FunPtr (Ptr C'THCharTensor -> IO (Ptr C'THDescBuff))
...
foreign import ccall "THTensor.h &THCharTensor_sizeDesc"
  p_sizeDesc_ :: FunPtr (Ptr C'THCharTensor -> IO (Ptr C'THDescBuff))
