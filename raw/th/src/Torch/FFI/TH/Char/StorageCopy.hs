...
foreign import ccall "THStorageCopy.h &THCharStorage_rawCopy"
  p_rawCopy_ :: FunPtr (Ptr C'THCharStorage -> Ptr CChar -> IO ())
...
foreign import ccall "THStorageCopy.h &THCharStorage_copy"
  p_copy_ :: FunPtr (Ptr C'THCharStorage -> Ptr C'THCharStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THCharStorage_copyByte"
  p_copyByte_ :: FunPtr (Ptr C'THCharStorage -> Ptr C'THByteStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THCharStorage_copyChar"
  p_copyChar_ :: FunPtr (Ptr C'THCharStorage -> Ptr C'THCharStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THCharStorage_copyShort"
  p_copyShort_ :: FunPtr (Ptr C'THCharStorage -> Ptr C'THShortStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THCharStorage_copyInt"
  p_copyInt_ :: FunPtr (Ptr C'THCharStorage -> Ptr C'THIntStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THCharStorage_copyLong"
  p_copyLong_ :: FunPtr (Ptr C'THCharStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THCharStorage_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr C'THCharStorage -> Ptr C'THFloatStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THCharStorage_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr C'THCharStorage -> Ptr C'THDoubleStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THCharStorage_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr C'THCharStorage -> Ptr C'THHalfStorage -> IO ())
