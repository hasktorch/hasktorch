...
foreign import ccall "THTensorRandom.h c_THTensorChar_bernoulli_DoubleTensor"
...
foreign import ccall "THTensorRandom.h &p_THTensorChar_random"
  p_random :: FunPtr (Ptr (CTHCharTensor) -> Ptr (CTHGenerator) -> IO (()))

-- | p_clampedRandom : Pointer to function : self _generator min max -> void
foreign import ccall "THTensorRandom.h &p_THTensorChar_clampedRandom"
...
foreign import ccall "THTensorRandom.h &p_THTensorChar_bernoulli_FloatTensor"
...
foreign import ccall "THTensorRandom.h &p_THTensorChar_bernoulli_DoubleTensor"
