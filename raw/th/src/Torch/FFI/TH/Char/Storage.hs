...
foreign import ccall "THStorage.h THCharStorage_data"
  c_data_ :: Ptr CTHCharStorage -> IO (Ptr CChar)
...
foreign import ccall "THStorage.h THCharStorage_size"
  c_size_ :: Ptr CTHCharStorage -> IO CPtrdiff
...
foreign import ccall "THStorage.h THCharStorage_set"
  c_set_ :: Ptr CTHCharStorage -> CPtrdiff -> CChar -> IO ()
...
foreign import ccall "THStorage.h THCharStorage_get"
  c_get_ :: Ptr CTHCharStorage -> CPtrdiff -> IO CChar
...
foreign import ccall "THStorage.h THCharStorage_newWithSize"
  c_newWithSize_ :: CPtrdiff -> IO (Ptr CTHCharStorage)
...
foreign import ccall "THStorage.h THCharStorage_newWithSize1"
  c_newWithSize1_ :: CChar -> IO (Ptr CTHCharStorage)
...
foreign import ccall "THStorage.h THCharStorage_newWithSize2"
  c_newWithSize2_ :: CChar -> CChar -> IO (Ptr CTHCharStorage)
...
foreign import ccall "THStorage.h THCharStorage_newWithSize3"
  c_newWithSize3_ :: CChar -> CChar -> CChar -> IO (Ptr CTHCharStorage)
...
foreign import ccall "THStorage.h THCharStorage_newWithSize4"
  c_newWithSize4_ :: CChar -> CChar -> CChar -> CChar -> IO (Ptr CTHCharStorage)
...
foreign import ccall "THStorage.h THCharStorage_newWithMapping"
  c_newWithMapping_ :: Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHCharStorage)
...
foreign import ccall "THStorage.h THCharStorage_newWithData"
  c_newWithData_ :: Ptr CChar -> CPtrdiff -> IO (Ptr CTHCharStorage)
...
foreign import ccall "THStorage.h THCharStorage_newWithAllocator"
  c_newWithAllocator_ :: CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHCharStorage)
...
foreign import ccall "THStorage.h THCharStorage_newWithDataAndAllocator"
  c_newWithDataAndAllocator_ :: Ptr CChar -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHCharStorage)
...
foreign import ccall "THStorage.h THCharStorage_setFlag"
  c_setFlag_ :: Ptr CTHCharStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THCharStorage_clearFlag"
  c_clearFlag_ :: Ptr CTHCharStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THCharStorage_retain"
  c_retain_ :: Ptr CTHCharStorage -> IO ()
...
foreign import ccall "THStorage.h THCharStorage_swap"
  c_swap_ :: Ptr CTHCharStorage -> Ptr CTHCharStorage -> IO ()
...
foreign import ccall "THStorage.h THCharStorage_resize"
  c_resize_ :: Ptr CTHCharStorage -> CPtrdiff -> IO ()
...
foreign import ccall "THStorage.h THCharStorage_fill"
  c_fill_ :: Ptr CTHCharStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h &THCharStorage_data"
  p_data_ :: FunPtr (Ptr CTHCharStorage -> IO (Ptr CChar))
...
foreign import ccall "THStorage.h &THCharStorage_size"
  p_size_ :: FunPtr (Ptr CTHCharStorage -> IO CPtrdiff)
...
foreign import ccall "THStorage.h &THCharStorage_set"
  p_set_ :: FunPtr (Ptr CTHCharStorage -> CPtrdiff -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THCharStorage_get"
  p_get_ :: FunPtr (Ptr CTHCharStorage -> CPtrdiff -> IO CChar)
...
foreign import ccall "THStorage.h &THCharStorage_new"
  p_new_ :: FunPtr (IO (Ptr CTHCharStorage))
...
foreign import ccall "THStorage.h &THCharStorage_newWithSize"
  p_newWithSize_ :: FunPtr (CPtrdiff -> IO (Ptr CTHCharStorage))
...
foreign import ccall "THStorage.h &THCharStorage_newWithSize1"
  p_newWithSize1_ :: FunPtr (CChar -> IO (Ptr CTHCharStorage))
...
foreign import ccall "THStorage.h &THCharStorage_newWithSize2"
  p_newWithSize2_ :: FunPtr (CChar -> CChar -> IO (Ptr CTHCharStorage))
...
foreign import ccall "THStorage.h &THCharStorage_newWithSize3"
  p_newWithSize3_ :: FunPtr (CChar -> CChar -> CChar -> IO (Ptr CTHCharStorage))
...
foreign import ccall "THStorage.h &THCharStorage_newWithSize4"
  p_newWithSize4_ :: FunPtr (CChar -> CChar -> CChar -> CChar -> IO (Ptr CTHCharStorage))
...
foreign import ccall "THStorage.h &THCharStorage_newWithMapping"
  p_newWithMapping_ :: FunPtr (Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHCharStorage))
...
foreign import ccall "THStorage.h &THCharStorage_newWithData"
  p_newWithData_ :: FunPtr (Ptr CChar -> CPtrdiff -> IO (Ptr CTHCharStorage))
...
foreign import ccall "THStorage.h &THCharStorage_newWithAllocator"
  p_newWithAllocator_ :: FunPtr (CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHCharStorage))
...
foreign import ccall "THStorage.h &THCharStorage_newWithDataAndAllocator"
  p_newWithDataAndAllocator_ :: FunPtr (Ptr CChar -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHCharStorage))
...
foreign import ccall "THStorage.h &THCharStorage_setFlag"
  p_setFlag_ :: FunPtr (Ptr CTHCharStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THCharStorage_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr CTHCharStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THCharStorage_retain"
  p_retain_ :: FunPtr (Ptr CTHCharStorage -> IO ())
...
foreign import ccall "THStorage.h &THCharStorage_swap"
  p_swap_ :: FunPtr (Ptr CTHCharStorage -> Ptr CTHCharStorage -> IO ())
...
foreign import ccall "THStorage.h &THCharStorage_free"
  p_free_ :: FunPtr (Ptr CTHCharStorage -> IO ())
...
foreign import ccall "THStorage.h &THCharStorage_resize"
  p_resize_ :: FunPtr (Ptr CTHCharStorage -> CPtrdiff -> IO ())
...
foreign import ccall "THStorage.h &THCharStorage_fill"
  p_fill_ :: FunPtr (Ptr CTHCharStorage -> CChar -> IO ())
