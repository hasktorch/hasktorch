...
foreign import ccall "THTensorCopy.h THCharTensor_copy"
  c_copy_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THCharTensor_copyByte"
  c_copyByte_ :: Ptr CTHCharTensor -> Ptr CTHByteTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THCharTensor_copyChar"
  c_copyChar_ :: Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THCharTensor_copyShort"
  c_copyShort_ :: Ptr CTHCharTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THCharTensor_copyInt"
  c_copyInt_ :: Ptr CTHCharTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THCharTensor_copyLong"
  c_copyLong_ :: Ptr CTHCharTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THCharTensor_copyFloat"
  c_copyFloat_ :: Ptr CTHCharTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THCharTensor_copyDouble"
  c_copyDouble_ :: Ptr CTHCharTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THCharTensor_copyHalf"
  c_copyHalf_ :: Ptr CTHCharTensor -> Ptr CTHHalfTensor -> IO ()
...
foreign import ccall "THTensorCopy.h &THCharTensor_copy"
  p_copy_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THCharTensor_copyByte"
  p_copyByte_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHByteTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THCharTensor_copyChar"
  p_copyChar_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THCharTensor_copyShort"
  p_copyShort_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THCharTensor_copyInt"
  p_copyInt_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THCharTensor_copyLong"
  p_copyLong_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THCharTensor_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THCharTensor_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THCharTensor_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr CTHCharTensor -> Ptr CTHHalfTensor -> IO ())
