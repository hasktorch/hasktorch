...
foreign import ccall "THStorage.h THIntStorage_data"
  c_data_ :: Ptr CTHIntStorage -> IO (Ptr CInt)
...
foreign import ccall "THStorage.h THIntStorage_size"
  c_size_ :: Ptr CTHIntStorage -> IO CPtrdiff
...
foreign import ccall "THStorage.h THIntStorage_set"
  c_set_ :: Ptr CTHIntStorage -> CPtrdiff -> CInt -> IO ()
...
foreign import ccall "THStorage.h THIntStorage_get"
  c_get_ :: Ptr CTHIntStorage -> CPtrdiff -> IO CInt
...
foreign import ccall "THStorage.h THIntStorage_newWithSize"
  c_newWithSize_ :: CPtrdiff -> IO (Ptr CTHIntStorage)
...
foreign import ccall "THStorage.h THIntStorage_newWithSize1"
  c_newWithSize1_ :: CInt -> IO (Ptr CTHIntStorage)
...
foreign import ccall "THStorage.h THIntStorage_newWithSize2"
  c_newWithSize2_ :: CInt -> CInt -> IO (Ptr CTHIntStorage)
...
foreign import ccall "THStorage.h THIntStorage_newWithSize3"
  c_newWithSize3_ :: CInt -> CInt -> CInt -> IO (Ptr CTHIntStorage)
...
foreign import ccall "THStorage.h THIntStorage_newWithSize4"
  c_newWithSize4_ :: CInt -> CInt -> CInt -> CInt -> IO (Ptr CTHIntStorage)
...
foreign import ccall "THStorage.h THIntStorage_newWithMapping"
  c_newWithMapping_ :: Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHIntStorage)
...
foreign import ccall "THStorage.h THIntStorage_newWithData"
  c_newWithData_ :: Ptr CInt -> CPtrdiff -> IO (Ptr CTHIntStorage)
...
foreign import ccall "THStorage.h THIntStorage_newWithAllocator"
  c_newWithAllocator_ :: CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHIntStorage)
...
foreign import ccall "THStorage.h THIntStorage_newWithDataAndAllocator"
  c_newWithDataAndAllocator_ :: Ptr CInt -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHIntStorage)
...
foreign import ccall "THStorage.h THIntStorage_setFlag"
  c_setFlag_ :: Ptr CTHIntStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THIntStorage_clearFlag"
  c_clearFlag_ :: Ptr CTHIntStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THIntStorage_retain"
  c_retain_ :: Ptr CTHIntStorage -> IO ()
...
foreign import ccall "THStorage.h THIntStorage_swap"
  c_swap_ :: Ptr CTHIntStorage -> Ptr CTHIntStorage -> IO ()
...
foreign import ccall "THStorage.h THIntStorage_resize"
  c_resize_ :: Ptr CTHIntStorage -> CPtrdiff -> IO ()
...
foreign import ccall "THStorage.h THIntStorage_fill"
  c_fill_ :: Ptr CTHIntStorage -> CInt -> IO ()
...
foreign import ccall "THStorage.h &THIntStorage_data"
  p_data_ :: FunPtr (Ptr CTHIntStorage -> IO (Ptr CInt))
...
foreign import ccall "THStorage.h &THIntStorage_size"
  p_size_ :: FunPtr (Ptr CTHIntStorage -> IO CPtrdiff)
...
foreign import ccall "THStorage.h &THIntStorage_set"
  p_set_ :: FunPtr (Ptr CTHIntStorage -> CPtrdiff -> CInt -> IO ())
...
foreign import ccall "THStorage.h &THIntStorage_get"
  p_get_ :: FunPtr (Ptr CTHIntStorage -> CPtrdiff -> IO CInt)
...
foreign import ccall "THStorage.h &THIntStorage_new"
  p_new_ :: FunPtr (IO (Ptr CTHIntStorage))
...
foreign import ccall "THStorage.h &THIntStorage_newWithSize"
  p_newWithSize_ :: FunPtr (CPtrdiff -> IO (Ptr CTHIntStorage))
...
foreign import ccall "THStorage.h &THIntStorage_newWithSize1"
  p_newWithSize1_ :: FunPtr (CInt -> IO (Ptr CTHIntStorage))
...
foreign import ccall "THStorage.h &THIntStorage_newWithSize2"
  p_newWithSize2_ :: FunPtr (CInt -> CInt -> IO (Ptr CTHIntStorage))
...
foreign import ccall "THStorage.h &THIntStorage_newWithSize3"
  p_newWithSize3_ :: FunPtr (CInt -> CInt -> CInt -> IO (Ptr CTHIntStorage))
...
foreign import ccall "THStorage.h &THIntStorage_newWithSize4"
  p_newWithSize4_ :: FunPtr (CInt -> CInt -> CInt -> CInt -> IO (Ptr CTHIntStorage))
...
foreign import ccall "THStorage.h &THIntStorage_newWithMapping"
  p_newWithMapping_ :: FunPtr (Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHIntStorage))
...
foreign import ccall "THStorage.h &THIntStorage_newWithData"
  p_newWithData_ :: FunPtr (Ptr CInt -> CPtrdiff -> IO (Ptr CTHIntStorage))
...
foreign import ccall "THStorage.h &THIntStorage_newWithAllocator"
  p_newWithAllocator_ :: FunPtr (CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHIntStorage))
...
foreign import ccall "THStorage.h &THIntStorage_newWithDataAndAllocator"
  p_newWithDataAndAllocator_ :: FunPtr (Ptr CInt -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHIntStorage))
...
foreign import ccall "THStorage.h &THIntStorage_setFlag"
  p_setFlag_ :: FunPtr (Ptr CTHIntStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THIntStorage_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr CTHIntStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THIntStorage_retain"
  p_retain_ :: FunPtr (Ptr CTHIntStorage -> IO ())
...
foreign import ccall "THStorage.h &THIntStorage_swap"
  p_swap_ :: FunPtr (Ptr CTHIntStorage -> Ptr CTHIntStorage -> IO ())
...
foreign import ccall "THStorage.h &THIntStorage_free"
  p_free_ :: FunPtr (Ptr CTHIntStorage -> IO ())
...
foreign import ccall "THStorage.h &THIntStorage_resize"
  p_resize_ :: FunPtr (Ptr CTHIntStorage -> CPtrdiff -> IO ())
...
foreign import ccall "THStorage.h &THIntStorage_fill"
  p_fill_ :: FunPtr (Ptr CTHIntStorage -> CInt -> IO ())
