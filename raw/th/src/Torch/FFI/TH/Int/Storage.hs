...
foreign import ccall "THStorage.h THIntStorage_newWithAllocator"
  c_newWithAllocator :: CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHIntStorage)
...
foreign import ccall "THStorage.h THIntStorage_newWithDataAndAllocator"
  c_newWithDataAndAllocator :: Ptr CInt -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHIntStorage)
...
foreign import ccall "THStorage.h &THIntStorage_newWithAllocator"
  p_newWithAllocator :: FunPtr (CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHIntStorage))

-- | p_newWithDataAndAllocator : Pointer to function : data size allocator allocatorContext -> THStorage *
foreign import ccall "THStorage.h &THIntStorage_newWithDataAndAllocator"
  p_newWithDataAndAllocator :: FunPtr (Ptr CInt -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHIntStorage))
