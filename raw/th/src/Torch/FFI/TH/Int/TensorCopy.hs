...
foreign import ccall "THTensorCopy.h &THIntTensor_copy"
  p_copy_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THIntTensor_copyByte"
  p_copyByte_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THIntTensor_copyChar"
  p_copyChar_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THIntTensor_copyShort"
  p_copyShort_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THIntTensor_copyInt"
  p_copyInt_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THIntTensor_copyLong"
  p_copyLong_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THIntTensor_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THIntTensor_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THIntTensor_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THHalfTensor -> IO ())
