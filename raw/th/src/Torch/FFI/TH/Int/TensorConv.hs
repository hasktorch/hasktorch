...
foreign import ccall "THTensorConv.h &THIntTensor_validXCorr2Dptr"
  p_validXCorr2Dptr_ :: FunPtr (Ptr CInt -> CInt -> Ptr CInt -> CLLong -> CLLong -> Ptr CInt -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THIntTensor_validConv2Dptr"
  p_validConv2Dptr_ :: FunPtr (Ptr CInt -> CInt -> Ptr CInt -> CLLong -> CLLong -> Ptr CInt -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THIntTensor_fullXCorr2Dptr"
  p_fullXCorr2Dptr_ :: FunPtr (Ptr CInt -> CInt -> Ptr CInt -> CLLong -> CLLong -> Ptr CInt -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THIntTensor_fullConv2Dptr"
  p_fullConv2Dptr_ :: FunPtr (Ptr CInt -> CInt -> Ptr CInt -> CLLong -> CLLong -> Ptr CInt -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THIntTensor_validXCorr2DRevptr"
  p_validXCorr2DRevptr_ :: FunPtr (Ptr CInt -> CInt -> Ptr CInt -> CLLong -> CLLong -> Ptr CInt -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THIntTensor_validXCorr3Dptr"
  p_validXCorr3Dptr_ :: FunPtr (Ptr CInt -> CInt -> Ptr CInt -> CLLong -> CLLong -> CLLong -> Ptr CInt -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THIntTensor_validConv3Dptr"
  p_validConv3Dptr_ :: FunPtr (Ptr CInt -> CInt -> Ptr CInt -> CLLong -> CLLong -> CLLong -> Ptr CInt -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THIntTensor_fullXCorr3Dptr"
  p_fullXCorr3Dptr_ :: FunPtr (Ptr CInt -> CInt -> Ptr CInt -> CLLong -> CLLong -> CLLong -> Ptr CInt -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THIntTensor_fullConv3Dptr"
  p_fullConv3Dptr_ :: FunPtr (Ptr CInt -> CInt -> Ptr CInt -> CLLong -> CLLong -> CLLong -> Ptr CInt -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THIntTensor_validXCorr3DRevptr"
  p_validXCorr3DRevptr_ :: FunPtr (Ptr CInt -> CInt -> Ptr CInt -> CLLong -> CLLong -> CLLong -> Ptr CInt -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
