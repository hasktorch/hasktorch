...
foreign import ccall "THStorageCopy.h &THIntStorage_rawCopy"
  p_rawCopy_ :: FunPtr (Ptr C'THIntStorage -> Ptr CInt -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copy"
  p_copy_ :: FunPtr (Ptr C'THIntStorage -> Ptr C'THIntStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyByte"
  p_copyByte_ :: FunPtr (Ptr C'THIntStorage -> Ptr C'THByteStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyChar"
  p_copyChar_ :: FunPtr (Ptr C'THIntStorage -> Ptr C'THCharStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyShort"
  p_copyShort_ :: FunPtr (Ptr C'THIntStorage -> Ptr C'THShortStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyInt"
  p_copyInt_ :: FunPtr (Ptr C'THIntStorage -> Ptr C'THIntStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyLong"
  p_copyLong_ :: FunPtr (Ptr C'THIntStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr C'THIntStorage -> Ptr C'THFloatStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr C'THIntStorage -> Ptr C'THDoubleStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr C'THIntStorage -> Ptr C'THHalfStorage -> IO ())
