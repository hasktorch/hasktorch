...
foreign import ccall "THStorageCopy.h THIntStorage_rawCopy"
  c_rawCopy_ :: Ptr CTHIntStorage -> Ptr CInt -> IO ()
...
foreign import ccall "THStorageCopy.h THIntStorage_copy"
  c_copy_ :: Ptr CTHIntStorage -> Ptr CTHIntStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THIntStorage_copyByte"
  c_copyByte_ :: Ptr CTHIntStorage -> Ptr CTHByteStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THIntStorage_copyChar"
  c_copyChar_ :: Ptr CTHIntStorage -> Ptr CTHCharStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THIntStorage_copyShort"
  c_copyShort_ :: Ptr CTHIntStorage -> Ptr CTHShortStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THIntStorage_copyInt"
  c_copyInt_ :: Ptr CTHIntStorage -> Ptr CTHIntStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THIntStorage_copyLong"
  c_copyLong_ :: Ptr CTHIntStorage -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THIntStorage_copyFloat"
  c_copyFloat_ :: Ptr CTHIntStorage -> Ptr CTHFloatStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THIntStorage_copyDouble"
  c_copyDouble_ :: Ptr CTHIntStorage -> Ptr CTHDoubleStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THIntStorage_copyHalf"
  c_copyHalf_ :: Ptr CTHIntStorage -> Ptr CTHHalfStorage -> IO ()
...
foreign import ccall "THStorageCopy.h &THIntStorage_rawCopy"
  p_rawCopy_ :: FunPtr (Ptr CTHIntStorage -> Ptr CInt -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copy"
  p_copy_ :: FunPtr (Ptr CTHIntStorage -> Ptr CTHIntStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyByte"
  p_copyByte_ :: FunPtr (Ptr CTHIntStorage -> Ptr CTHByteStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyChar"
  p_copyChar_ :: FunPtr (Ptr CTHIntStorage -> Ptr CTHCharStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyShort"
  p_copyShort_ :: FunPtr (Ptr CTHIntStorage -> Ptr CTHShortStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyInt"
  p_copyInt_ :: FunPtr (Ptr CTHIntStorage -> Ptr CTHIntStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyLong"
  p_copyLong_ :: FunPtr (Ptr CTHIntStorage -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr CTHIntStorage -> Ptr CTHFloatStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr CTHIntStorage -> Ptr CTHDoubleStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THIntStorage_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr CTHIntStorage -> Ptr CTHHalfStorage -> IO ())
