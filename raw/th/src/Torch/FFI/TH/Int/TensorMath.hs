...
foreign import ccall "THTensorMath.h THIntTensor_fill"
  c_fill_ :: Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_maskedFill"
  c_maskedFill_ :: Ptr CTHIntTensor -> Ptr CTHByteTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_maskedCopy"
  c_maskedCopy_ :: Ptr CTHIntTensor -> Ptr CTHByteTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_maskedSelect"
  c_maskedSelect_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHByteTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_nonzero"
  c_nonzero_ :: Ptr CTHLongTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_indexSelect"
  c_indexSelect_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_indexCopy"
  c_indexCopy_ :: Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_indexAdd"
  c_indexAdd_ :: Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_indexFill"
  c_indexFill_ :: Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_take"
  c_take_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_put"
  c_put_ :: Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_gather"
  c_gather_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_scatter"
  c_scatter_ :: Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_scatterAdd"
  c_scatterAdd_ :: Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_scatterFill"
  c_scatterFill_ :: Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_dot"
  c_dot_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THIntTensor_minall"
  c_minall_ :: Ptr CTHIntTensor -> IO CInt
...
foreign import ccall "THTensorMath.h THIntTensor_maxall"
  c_maxall_ :: Ptr CTHIntTensor -> IO CInt
...
foreign import ccall "THTensorMath.h THIntTensor_medianall"
  c_medianall_ :: Ptr CTHIntTensor -> IO CInt
...
foreign import ccall "THTensorMath.h THIntTensor_sumall"
  c_sumall_ :: Ptr CTHIntTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THIntTensor_prodall"
  c_prodall_ :: Ptr CTHIntTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THIntTensor_neg"
  c_neg_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_add"
  c_add_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_sub"
  c_sub_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_add_scaled"
  c_add_scaled_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_sub_scaled"
  c_sub_scaled_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_mul"
  c_mul_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_div"
  c_div_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_lshift"
  c_lshift_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_rshift"
  c_rshift_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_fmod"
  c_fmod_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_remainder"
  c_remainder_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_clamp"
  c_clamp_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_bitand"
  c_bitand_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_bitor"
  c_bitor_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_bitxor"
  c_bitxor_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cadd"
  c_cadd_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_csub"
  c_csub_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cmul"
  c_cmul_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cpow"
  c_cpow_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cdiv"
  c_cdiv_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_clshift"
  c_clshift_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_crshift"
  c_crshift_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cfmod"
  c_cfmod_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cremainder"
  c_cremainder_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cbitand"
  c_cbitand_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cbitor"
  c_cbitor_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cbitxor"
  c_cbitxor_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_addcmul"
  c_addcmul_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_addcdiv"
  c_addcdiv_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_addmv"
  c_addmv_ :: Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_addmm"
  c_addmm_ :: Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_addr"
  c_addr_ :: Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_addbmm"
  c_addbmm_ :: Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_baddbmm"
  c_baddbmm_ :: Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_match"
  c_match_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_numel"
  c_numel_ :: Ptr CTHIntTensor -> IO CPtrdiff
...
foreign import ccall "THTensorMath.h THIntTensor_max"
  c_max_ :: Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_min"
  c_min_ :: Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_kthvalue"
  c_kthvalue_ :: Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CLLong -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_mode"
  c_mode_ :: Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_median"
  c_median_ :: Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_sum"
  c_sum_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_prod"
  c_prod_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cumsum"
  c_cumsum_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cumprod"
  c_cumprod_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_sign"
  c_sign_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_trace"
  c_trace_ :: Ptr CTHIntTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THIntTensor_cross"
  c_cross_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cmax"
  c_cmax_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cmin"
  c_cmin_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cmaxValue"
  c_cmaxValue_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cminValue"
  c_cminValue_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_zeros"
  c_zeros_ :: Ptr CTHIntTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_zerosLike"
  c_zerosLike_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_ones"
  c_ones_ :: Ptr CTHIntTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_onesLike"
  c_onesLike_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_diag"
  c_diag_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_eye"
  c_eye_ :: Ptr CTHIntTensor -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_arange"
  c_arange_ :: Ptr CTHIntTensor -> CLong -> CLong -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_range"
  c_range_ :: Ptr CTHIntTensor -> CLong -> CLong -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_randperm"
  c_randperm_ :: Ptr CTHIntTensor -> Ptr CTHGenerator -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_reshape"
  c_reshape_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_sort"
  c_sort_ :: Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_topk"
  c_topk_ :: Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CLLong -> CInt -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_tril"
  c_tril_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_triu"
  c_triu_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_cat"
  c_cat_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_catArray"
  c_catArray_ :: Ptr CTHIntTensor -> Ptr (Ptr CTHIntTensor) -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_equal"
  c_equal_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO CInt
...
foreign import ccall "THTensorMath.h THIntTensor_ltValue"
  c_ltValue_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_leValue"
  c_leValue_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_gtValue"
  c_gtValue_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_geValue"
  c_geValue_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_neValue"
  c_neValue_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_eqValue"
  c_eqValue_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_ltValueT"
  c_ltValueT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_leValueT"
  c_leValueT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_gtValueT"
  c_gtValueT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_geValueT"
  c_geValueT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_neValueT"
  c_neValueT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_eqValueT"
  c_eqValueT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_ltTensor"
  c_ltTensor_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_leTensor"
  c_leTensor_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_gtTensor"
  c_gtTensor_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_geTensor"
  c_geTensor_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_neTensor"
  c_neTensor_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_eqTensor"
  c_eqTensor_ :: Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_ltTensorT"
  c_ltTensorT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_leTensorT"
  c_leTensorT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_gtTensorT"
  c_gtTensorT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_geTensorT"
  c_geTensorT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_neTensorT"
  c_neTensorT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_eqTensorT"
  c_eqTensorT_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h THIntTensor_abs"
  c_abs_ :: Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorMath.h &THIntTensor_fill"
  p_fill_ :: FunPtr (Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_zero"
  p_zero_ :: FunPtr (Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_maskedFill"
  p_maskedFill_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHByteTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_maskedCopy"
  p_maskedCopy_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHByteTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_maskedSelect"
  p_maskedSelect_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_nonzero"
  p_nonzero_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_indexSelect"
  p_indexSelect_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_indexCopy"
  p_indexCopy_ :: FunPtr (Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_indexAdd"
  p_indexAdd_ :: FunPtr (Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_indexFill"
  p_indexFill_ :: FunPtr (Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_take"
  p_take_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_put"
  p_put_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_gather"
  p_gather_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_scatter"
  p_scatter_ :: FunPtr (Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_scatterAdd"
  p_scatterAdd_ :: FunPtr (Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_scatterFill"
  p_scatterFill_ :: FunPtr (Ptr CTHIntTensor -> CInt -> Ptr CTHLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_dot"
  p_dot_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THIntTensor_minall"
  p_minall_ :: FunPtr (Ptr CTHIntTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THIntTensor_maxall"
  p_maxall_ :: FunPtr (Ptr CTHIntTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THIntTensor_medianall"
  p_medianall_ :: FunPtr (Ptr CTHIntTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THIntTensor_sumall"
  p_sumall_ :: FunPtr (Ptr CTHIntTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THIntTensor_prodall"
  p_prodall_ :: FunPtr (Ptr CTHIntTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THIntTensor_neg"
  p_neg_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_add"
  p_add_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_sub"
  p_sub_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_add_scaled"
  p_add_scaled_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_sub_scaled"
  p_sub_scaled_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_mul"
  p_mul_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_div"
  p_div_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_lshift"
  p_lshift_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_rshift"
  p_rshift_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_fmod"
  p_fmod_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_remainder"
  p_remainder_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_clamp"
  p_clamp_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_bitand"
  p_bitand_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_bitor"
  p_bitor_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_bitxor"
  p_bitxor_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cadd"
  p_cadd_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_csub"
  p_csub_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cmul"
  p_cmul_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cpow"
  p_cpow_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cdiv"
  p_cdiv_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_clshift"
  p_clshift_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_crshift"
  p_crshift_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cfmod"
  p_cfmod_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cremainder"
  p_cremainder_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cbitand"
  p_cbitand_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cbitor"
  p_cbitor_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cbitxor"
  p_cbitxor_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addcmul"
  p_addcmul_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addcdiv"
  p_addcdiv_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addmv"
  p_addmv_ :: FunPtr (Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addmm"
  p_addmm_ :: FunPtr (Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addr"
  p_addr_ :: FunPtr (Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addbmm"
  p_addbmm_ :: FunPtr (Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_baddbmm"
  p_baddbmm_ :: FunPtr (Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> CInt -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_match"
  p_match_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_numel"
  p_numel_ :: FunPtr (Ptr CTHIntTensor -> IO CPtrdiff)
...
foreign import ccall "THTensorMath.h &THIntTensor_max"
  p_max_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_min"
  p_min_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_kthvalue"
  p_kthvalue_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_mode"
  p_mode_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_median"
  p_median_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_sum"
  p_sum_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_prod"
  p_prod_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cumsum"
  p_cumsum_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cumprod"
  p_cumprod_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_sign"
  p_sign_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_trace"
  p_trace_ :: FunPtr (Ptr CTHIntTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THIntTensor_cross"
  p_cross_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cmax"
  p_cmax_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cmin"
  p_cmin_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cmaxValue"
  p_cmaxValue_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cminValue"
  p_cminValue_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_zeros"
  p_zeros_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_zerosLike"
  p_zerosLike_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_ones"
  p_ones_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_onesLike"
  p_onesLike_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_diag"
  p_diag_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_eye"
  p_eye_ :: FunPtr (Ptr CTHIntTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_arange"
  p_arange_ :: FunPtr (Ptr CTHIntTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_range"
  p_range_ :: FunPtr (Ptr CTHIntTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_randperm"
  p_randperm_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_reshape"
  p_reshape_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_sort"
  p_sort_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_topk"
  p_topk_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHLongTensor -> Ptr CTHIntTensor -> CLLong -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_tril"
  p_tril_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_triu"
  p_triu_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cat"
  p_cat_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_catArray"
  p_catArray_ :: FunPtr (Ptr CTHIntTensor -> Ptr (Ptr CTHIntTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_equal"
  p_equal_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THIntTensor_ltValue"
  p_ltValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_leValue"
  p_leValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_gtValue"
  p_gtValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_geValue"
  p_geValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_neValue"
  p_neValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_eqValue"
  p_eqValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_ltValueT"
  p_ltValueT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_leValueT"
  p_leValueT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_gtValueT"
  p_gtValueT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_geValueT"
  p_geValueT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_neValueT"
  p_neValueT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_eqValueT"
  p_eqValueT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_ltTensor"
  p_ltTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_leTensor"
  p_leTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_gtTensor"
  p_gtTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_geTensor"
  p_geTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_neTensor"
  p_neTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_eqTensor"
  p_eqTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_ltTensorT"
  p_ltTensorT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_leTensorT"
  p_leTensorT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_gtTensorT"
  p_gtTensorT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_geTensorT"
  p_geTensorT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_neTensorT"
  p_neTensorT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_eqTensorT"
  p_eqTensorT_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_abs"
  p_abs_ :: FunPtr (Ptr CTHIntTensor -> Ptr CTHIntTensor -> IO ())
