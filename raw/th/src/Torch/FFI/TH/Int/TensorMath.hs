...
foreign import ccall "THTensorMath.h &THIntTensor_fill"
  p_fill_ :: FunPtr (Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_zero"
  p_zero_ :: FunPtr (Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_maskedFill"
  p_maskedFill_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THByteTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_maskedCopy"
  p_maskedCopy_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THByteTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_maskedSelect"
  p_maskedSelect_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_nonzero"
  p_nonzero_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_indexSelect"
  p_indexSelect_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_indexCopy"
  p_indexCopy_ :: FunPtr (Ptr C'THIntTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_indexAdd"
  p_indexAdd_ :: FunPtr (Ptr C'THIntTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_indexFill"
  p_indexFill_ :: FunPtr (Ptr C'THIntTensor -> CInt -> Ptr C'THLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_take"
  p_take_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_put"
  p_put_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_gather"
  p_gather_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_scatter"
  p_scatter_ :: FunPtr (Ptr C'THIntTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_scatterAdd"
  p_scatterAdd_ :: FunPtr (Ptr C'THIntTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_scatterFill"
  p_scatterFill_ :: FunPtr (Ptr C'THIntTensor -> CInt -> Ptr C'THLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_dot"
  p_dot_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THIntTensor_minall"
  p_minall_ :: FunPtr (Ptr C'THIntTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THIntTensor_maxall"
  p_maxall_ :: FunPtr (Ptr C'THIntTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THIntTensor_medianall"
  p_medianall_ :: FunPtr (Ptr C'THIntTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THIntTensor_sumall"
  p_sumall_ :: FunPtr (Ptr C'THIntTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THIntTensor_prodall"
  p_prodall_ :: FunPtr (Ptr C'THIntTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THIntTensor_neg"
  p_neg_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_add"
  p_add_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_sub"
  p_sub_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_add_scaled"
  p_add_scaled_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_sub_scaled"
  p_sub_scaled_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_mul"
  p_mul_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_div"
  p_div_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_lshift"
  p_lshift_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_rshift"
  p_rshift_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_fmod"
  p_fmod_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_remainder"
  p_remainder_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_clamp"
  p_clamp_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_bitand"
  p_bitand_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_bitor"
  p_bitor_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_bitxor"
  p_bitxor_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cadd"
  p_cadd_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_csub"
  p_csub_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cmul"
  p_cmul_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cpow"
  p_cpow_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cdiv"
  p_cdiv_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_clshift"
  p_clshift_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_crshift"
  p_crshift_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cfmod"
  p_cfmod_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cremainder"
  p_cremainder_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cbitand"
  p_cbitand_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cbitor"
  p_cbitor_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cbitxor"
  p_cbitxor_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addcmul"
  p_addcmul_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addcdiv"
  p_addcdiv_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addmv"
  p_addmv_ :: FunPtr (Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addmm"
  p_addmm_ :: FunPtr (Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addr"
  p_addr_ :: FunPtr (Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_addbmm"
  p_addbmm_ :: FunPtr (Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_baddbmm"
  p_baddbmm_ :: FunPtr (Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> CInt -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_match"
  p_match_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_numel"
  p_numel_ :: FunPtr (Ptr C'THIntTensor -> IO CPtrdiff)
...
foreign import ccall "THTensorMath.h &THIntTensor_preserveReduceDimSemantics"
  p_preserveReduceDimSemantics_ :: FunPtr (Ptr C'THIntTensor -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_max"
  p_max_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_min"
  p_min_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_kthvalue"
  p_kthvalue_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_mode"
  p_mode_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_median"
  p_median_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_sum"
  p_sum_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_prod"
  p_prod_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cumsum"
  p_cumsum_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cumprod"
  p_cumprod_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_sign"
  p_sign_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_trace"
  p_trace_ :: FunPtr (Ptr C'THIntTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THIntTensor_cross"
  p_cross_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cmax"
  p_cmax_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cmin"
  p_cmin_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cmaxValue"
  p_cmaxValue_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cminValue"
  p_cminValue_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_zeros"
  p_zeros_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_zerosLike"
  p_zerosLike_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_ones"
  p_ones_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_onesLike"
  p_onesLike_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_diag"
  p_diag_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_eye"
  p_eye_ :: FunPtr (Ptr C'THIntTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_arange"
  p_arange_ :: FunPtr (Ptr C'THIntTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_range"
  p_range_ :: FunPtr (Ptr C'THIntTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_randperm"
  p_randperm_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_reshape"
  p_reshape_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_sort"
  p_sort_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_topk"
  p_topk_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THLongTensor -> Ptr C'THIntTensor -> CLLong -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_tril"
  p_tril_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_triu"
  p_triu_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_cat"
  p_cat_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_catArray"
  p_catArray_ :: FunPtr (Ptr C'THIntTensor -> Ptr (Ptr C'THIntTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_equal"
  p_equal_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THIntTensor_ltValue"
  p_ltValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_leValue"
  p_leValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_gtValue"
  p_gtValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_geValue"
  p_geValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_neValue"
  p_neValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_eqValue"
  p_eqValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_ltValueT"
  p_ltValueT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_leValueT"
  p_leValueT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_gtValueT"
  p_gtValueT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_geValueT"
  p_geValueT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_neValueT"
  p_neValueT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_eqValueT"
  p_eqValueT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_ltTensor"
  p_ltTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_leTensor"
  p_leTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_gtTensor"
  p_gtTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_geTensor"
  p_geTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_neTensor"
  p_neTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_eqTensor"
  p_eqTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_ltTensorT"
  p_ltTensorT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_leTensorT"
  p_leTensorT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_gtTensorT"
  p_gtTensorT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_geTensorT"
  p_geTensorT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_neTensorT"
  p_neTensorT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_eqTensorT"
  p_eqTensorT_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THIntTensor_abs"
  p_abs_ :: FunPtr (Ptr C'THIntTensor -> Ptr C'THIntTensor -> IO ())
