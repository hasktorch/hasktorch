...
foreign import ccall "THBlas.h &THIntBlas_swap"
  p_swap_ :: FunPtr (CLLong -> Ptr CInt -> CLLong -> Ptr CInt -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THIntBlas_scal"
  p_scal_ :: FunPtr (CLLong -> CInt -> Ptr CInt -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THIntBlas_copy"
  p_copy_ :: FunPtr (CLLong -> Ptr CInt -> CLLong -> Ptr CInt -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THIntBlas_axpy"
  p_axpy_ :: FunPtr (CLLong -> CInt -> Ptr CInt -> CLLong -> Ptr CInt -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THIntBlas_dot"
  p_dot_ :: FunPtr (CLLong -> Ptr CInt -> CLLong -> Ptr CInt -> CLLong -> IO CInt)
...
foreign import ccall "THBlas.h &THIntBlas_gemv"
  p_gemv_ :: FunPtr (CChar -> CLLong -> CLLong -> CInt -> Ptr CInt -> CLLong -> Ptr CInt -> CLLong -> CInt -> Ptr CInt -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THIntBlas_ger"
  p_ger_ :: FunPtr (CLLong -> CLLong -> CInt -> Ptr CInt -> CLLong -> Ptr CInt -> CLLong -> Ptr CInt -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THIntBlas_gemm"
  p_gemm_ :: FunPtr (CChar -> CChar -> CLLong -> CLLong -> CLLong -> CInt -> Ptr CInt -> CLLong -> Ptr CInt -> CLLong -> CInt -> Ptr CInt -> CLLong -> IO ())
