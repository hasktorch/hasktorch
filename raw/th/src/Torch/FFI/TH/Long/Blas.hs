...
foreign import ccall "THBlas.h &THLongBlas_swap"
  p_swap_ :: FunPtr (CLLong -> Ptr CLong -> CLLong -> Ptr CLong -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THLongBlas_scal"
  p_scal_ :: FunPtr (CLLong -> CLong -> Ptr CLong -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THLongBlas_copy"
  p_copy_ :: FunPtr (CLLong -> Ptr CLong -> CLLong -> Ptr CLong -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THLongBlas_axpy"
  p_axpy_ :: FunPtr (CLLong -> CLong -> Ptr CLong -> CLLong -> Ptr CLong -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THLongBlas_dot"
  p_dot_ :: FunPtr (CLLong -> Ptr CLong -> CLLong -> Ptr CLong -> CLLong -> IO CLong)
...
foreign import ccall "THBlas.h &THLongBlas_gemv"
  p_gemv_ :: FunPtr (CChar -> CLLong -> CLLong -> CLong -> Ptr CLong -> CLLong -> Ptr CLong -> CLLong -> CLong -> Ptr CLong -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THLongBlas_ger"
  p_ger_ :: FunPtr (CLLong -> CLLong -> CLong -> Ptr CLong -> CLLong -> Ptr CLong -> CLLong -> Ptr CLong -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THLongBlas_gemm"
  p_gemm_ :: FunPtr (CChar -> CChar -> CLLong -> CLLong -> CLLong -> CLong -> Ptr CLong -> CLLong -> Ptr CLong -> CLLong -> CLong -> Ptr CLong -> CLLong -> IO ())
