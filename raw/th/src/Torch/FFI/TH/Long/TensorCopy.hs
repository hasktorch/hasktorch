...
foreign import ccall "THTensorCopy.h &THLongTensor_copy"
  p_copy_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THLongTensor_copyByte"
  p_copyByte_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THLongTensor_copyChar"
  p_copyChar_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THLongTensor_copyShort"
  p_copyShort_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THLongTensor_copyInt"
  p_copyInt_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THLongTensor_copyLong"
  p_copyLong_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THLongTensor_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THLongTensor_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THLongTensor_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THHalfTensor -> IO ())
