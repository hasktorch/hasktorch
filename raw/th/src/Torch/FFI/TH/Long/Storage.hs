...
foreign import ccall "THStorage.h THLongStorage_data"
  c_data_ :: Ptr CTHLongStorage -> IO (Ptr CLong)
...
foreign import ccall "THStorage.h THLongStorage_size"
  c_size_ :: Ptr CTHLongStorage -> IO CPtrdiff
...
foreign import ccall "THStorage.h THLongStorage_set"
  c_set_ :: Ptr CTHLongStorage -> CPtrdiff -> CLong -> IO ()
...
foreign import ccall "THStorage.h THLongStorage_get"
  c_get_ :: Ptr CTHLongStorage -> CPtrdiff -> IO CLong
...
foreign import ccall "THStorage.h THLongStorage_newWithSize"
  c_newWithSize_ :: CPtrdiff -> IO (Ptr CTHLongStorage)
...
foreign import ccall "THStorage.h THLongStorage_newWithSize1"
  c_newWithSize1_ :: CLong -> IO (Ptr CTHLongStorage)
...
foreign import ccall "THStorage.h THLongStorage_newWithSize2"
  c_newWithSize2_ :: CLong -> CLong -> IO (Ptr CTHLongStorage)
...
foreign import ccall "THStorage.h THLongStorage_newWithSize3"
  c_newWithSize3_ :: CLong -> CLong -> CLong -> IO (Ptr CTHLongStorage)
...
foreign import ccall "THStorage.h THLongStorage_newWithSize4"
  c_newWithSize4_ :: CLong -> CLong -> CLong -> CLong -> IO (Ptr CTHLongStorage)
...
foreign import ccall "THStorage.h THLongStorage_newWithMapping"
  c_newWithMapping_ :: Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHLongStorage)
...
foreign import ccall "THStorage.h THLongStorage_newWithData"
  c_newWithData_ :: Ptr CLong -> CPtrdiff -> IO (Ptr CTHLongStorage)
...
foreign import ccall "THStorage.h THLongStorage_newWithAllocator"
  c_newWithAllocator_ :: CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHLongStorage)
...
foreign import ccall "THStorage.h THLongStorage_newWithDataAndAllocator"
  c_newWithDataAndAllocator_ :: Ptr CLong -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHLongStorage)
...
foreign import ccall "THStorage.h THLongStorage_setFlag"
  c_setFlag_ :: Ptr CTHLongStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THLongStorage_clearFlag"
  c_clearFlag_ :: Ptr CTHLongStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THLongStorage_retain"
  c_retain_ :: Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THStorage.h THLongStorage_swap"
  c_swap_ :: Ptr CTHLongStorage -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THStorage.h THLongStorage_resize"
  c_resize_ :: Ptr CTHLongStorage -> CPtrdiff -> IO ()
...
foreign import ccall "THStorage.h THLongStorage_fill"
  c_fill_ :: Ptr CTHLongStorage -> CLong -> IO ()
...
foreign import ccall "THStorage.h &THLongStorage_data"
  p_data_ :: FunPtr (Ptr CTHLongStorage -> IO (Ptr CLong))
...
foreign import ccall "THStorage.h &THLongStorage_size"
  p_size_ :: FunPtr (Ptr CTHLongStorage -> IO CPtrdiff)
...
foreign import ccall "THStorage.h &THLongStorage_set"
  p_set_ :: FunPtr (Ptr CTHLongStorage -> CPtrdiff -> CLong -> IO ())
...
foreign import ccall "THStorage.h &THLongStorage_get"
  p_get_ :: FunPtr (Ptr CTHLongStorage -> CPtrdiff -> IO CLong)
...
foreign import ccall "THStorage.h &THLongStorage_new"
  p_new_ :: FunPtr (IO (Ptr CTHLongStorage))
...
foreign import ccall "THStorage.h &THLongStorage_newWithSize"
  p_newWithSize_ :: FunPtr (CPtrdiff -> IO (Ptr CTHLongStorage))
...
foreign import ccall "THStorage.h &THLongStorage_newWithSize1"
  p_newWithSize1_ :: FunPtr (CLong -> IO (Ptr CTHLongStorage))
...
foreign import ccall "THStorage.h &THLongStorage_newWithSize2"
  p_newWithSize2_ :: FunPtr (CLong -> CLong -> IO (Ptr CTHLongStorage))
...
foreign import ccall "THStorage.h &THLongStorage_newWithSize3"
  p_newWithSize3_ :: FunPtr (CLong -> CLong -> CLong -> IO (Ptr CTHLongStorage))
...
foreign import ccall "THStorage.h &THLongStorage_newWithSize4"
  p_newWithSize4_ :: FunPtr (CLong -> CLong -> CLong -> CLong -> IO (Ptr CTHLongStorage))
...
foreign import ccall "THStorage.h &THLongStorage_newWithMapping"
  p_newWithMapping_ :: FunPtr (Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHLongStorage))
...
foreign import ccall "THStorage.h &THLongStorage_newWithData"
  p_newWithData_ :: FunPtr (Ptr CLong -> CPtrdiff -> IO (Ptr CTHLongStorage))
...
foreign import ccall "THStorage.h &THLongStorage_newWithAllocator"
  p_newWithAllocator_ :: FunPtr (CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHLongStorage))
...
foreign import ccall "THStorage.h &THLongStorage_newWithDataAndAllocator"
  p_newWithDataAndAllocator_ :: FunPtr (Ptr CLong -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHLongStorage))
...
foreign import ccall "THStorage.h &THLongStorage_setFlag"
  p_setFlag_ :: FunPtr (Ptr CTHLongStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THLongStorage_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr CTHLongStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THLongStorage_retain"
  p_retain_ :: FunPtr (Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THStorage.h &THLongStorage_swap"
  p_swap_ :: FunPtr (Ptr CTHLongStorage -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THStorage.h &THLongStorage_free"
  p_free_ :: FunPtr (Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THStorage.h &THLongStorage_resize"
  p_resize_ :: FunPtr (Ptr CTHLongStorage -> CPtrdiff -> IO ())
...
foreign import ccall "THStorage.h &THLongStorage_fill"
  p_fill_ :: FunPtr (Ptr CTHLongStorage -> CLong -> IO ())
