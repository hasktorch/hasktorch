...
foreign import ccall "THTensorMath.h THLongTensor_fill"
  c_fill_ :: Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_maskedFill"
  c_maskedFill_ :: Ptr CTHLongTensor -> Ptr CTHByteTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_maskedCopy"
  c_maskedCopy_ :: Ptr CTHLongTensor -> Ptr CTHByteTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_maskedSelect"
  c_maskedSelect_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHByteTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_nonzero"
  c_nonzero_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_indexSelect"
  c_indexSelect_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_indexCopy"
  c_indexCopy_ :: Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_indexAdd"
  c_indexAdd_ :: Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_indexFill"
  c_indexFill_ :: Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_take"
  c_take_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_put"
  c_put_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_gather"
  c_gather_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_scatter"
  c_scatter_ :: Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_scatterAdd"
  c_scatterAdd_ :: Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_scatterFill"
  c_scatterFill_ :: Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_dot"
  c_dot_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THLongTensor_minall"
  c_minall_ :: Ptr CTHLongTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THLongTensor_maxall"
  c_maxall_ :: Ptr CTHLongTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THLongTensor_medianall"
  c_medianall_ :: Ptr CTHLongTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THLongTensor_sumall"
  c_sumall_ :: Ptr CTHLongTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THLongTensor_prodall"
  c_prodall_ :: Ptr CTHLongTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THLongTensor_neg"
  c_neg_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_add"
  c_add_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_sub"
  c_sub_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_add_scaled"
  c_add_scaled_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_sub_scaled"
  c_sub_scaled_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_mul"
  c_mul_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_div"
  c_div_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_lshift"
  c_lshift_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_rshift"
  c_rshift_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_fmod"
  c_fmod_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_remainder"
  c_remainder_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_clamp"
  c_clamp_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_bitand"
  c_bitand_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_bitor"
  c_bitor_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_bitxor"
  c_bitxor_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cadd"
  c_cadd_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_csub"
  c_csub_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cmul"
  c_cmul_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cpow"
  c_cpow_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cdiv"
  c_cdiv_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_clshift"
  c_clshift_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_crshift"
  c_crshift_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cfmod"
  c_cfmod_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cremainder"
  c_cremainder_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cbitand"
  c_cbitand_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cbitor"
  c_cbitor_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cbitxor"
  c_cbitxor_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_addcmul"
  c_addcmul_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_addcdiv"
  c_addcdiv_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_addmv"
  c_addmv_ :: Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_addmm"
  c_addmm_ :: Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_addr"
  c_addr_ :: Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_addbmm"
  c_addbmm_ :: Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_baddbmm"
  c_baddbmm_ :: Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_match"
  c_match_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_numel"
  c_numel_ :: Ptr CTHLongTensor -> IO CPtrdiff
...
foreign import ccall "THTensorMath.h THLongTensor_max"
  c_max_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_min"
  c_min_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_kthvalue"
  c_kthvalue_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLLong -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_mode"
  c_mode_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_median"
  c_median_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_sum"
  c_sum_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_prod"
  c_prod_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cumsum"
  c_cumsum_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cumprod"
  c_cumprod_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_sign"
  c_sign_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_trace"
  c_trace_ :: Ptr CTHLongTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THLongTensor_cross"
  c_cross_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cmax"
  c_cmax_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cmin"
  c_cmin_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cmaxValue"
  c_cmaxValue_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cminValue"
  c_cminValue_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_zeros"
  c_zeros_ :: Ptr CTHLongTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_zerosLike"
  c_zerosLike_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_ones"
  c_ones_ :: Ptr CTHLongTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_onesLike"
  c_onesLike_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_diag"
  c_diag_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_eye"
  c_eye_ :: Ptr CTHLongTensor -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_arange"
  c_arange_ :: Ptr CTHLongTensor -> CLong -> CLong -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_range"
  c_range_ :: Ptr CTHLongTensor -> CLong -> CLong -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_randperm"
  c_randperm_ :: Ptr CTHLongTensor -> Ptr CTHGenerator -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_reshape"
  c_reshape_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_sort"
  c_sort_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_topk"
  c_topk_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLLong -> CInt -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_tril"
  c_tril_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_triu"
  c_triu_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_cat"
  c_cat_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_catArray"
  c_catArray_ :: Ptr CTHLongTensor -> Ptr (Ptr CTHLongTensor) -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_equal"
  c_equal_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO CInt
...
foreign import ccall "THTensorMath.h THLongTensor_ltValue"
  c_ltValue_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_leValue"
  c_leValue_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_gtValue"
  c_gtValue_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_geValue"
  c_geValue_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_neValue"
  c_neValue_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_eqValue"
  c_eqValue_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_ltValueT"
  c_ltValueT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_leValueT"
  c_leValueT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_gtValueT"
  c_gtValueT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_geValueT"
  c_geValueT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_neValueT"
  c_neValueT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_eqValueT"
  c_eqValueT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_ltTensor"
  c_ltTensor_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_leTensor"
  c_leTensor_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_gtTensor"
  c_gtTensor_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_geTensor"
  c_geTensor_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_neTensor"
  c_neTensor_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_eqTensor"
  c_eqTensor_ :: Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_ltTensorT"
  c_ltTensorT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_leTensorT"
  c_leTensorT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_gtTensorT"
  c_gtTensorT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_geTensorT"
  c_geTensorT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_neTensorT"
  c_neTensorT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_eqTensorT"
  c_eqTensorT_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THLongTensor_abs"
  c_abs_ :: Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h &THLongTensor_fill"
  p_fill_ :: FunPtr (Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_zero"
  p_zero_ :: FunPtr (Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_maskedFill"
  p_maskedFill_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHByteTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_maskedCopy"
  p_maskedCopy_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHByteTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_maskedSelect"
  p_maskedSelect_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_nonzero"
  p_nonzero_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_indexSelect"
  p_indexSelect_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_indexCopy"
  p_indexCopy_ :: FunPtr (Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_indexAdd"
  p_indexAdd_ :: FunPtr (Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_indexFill"
  p_indexFill_ :: FunPtr (Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_take"
  p_take_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_put"
  p_put_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_gather"
  p_gather_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_scatter"
  p_scatter_ :: FunPtr (Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_scatterAdd"
  p_scatterAdd_ :: FunPtr (Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_scatterFill"
  p_scatterFill_ :: FunPtr (Ptr CTHLongTensor -> CInt -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_dot"
  p_dot_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THLongTensor_minall"
  p_minall_ :: FunPtr (Ptr CTHLongTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THLongTensor_maxall"
  p_maxall_ :: FunPtr (Ptr CTHLongTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THLongTensor_medianall"
  p_medianall_ :: FunPtr (Ptr CTHLongTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THLongTensor_sumall"
  p_sumall_ :: FunPtr (Ptr CTHLongTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THLongTensor_prodall"
  p_prodall_ :: FunPtr (Ptr CTHLongTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THLongTensor_neg"
  p_neg_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_add"
  p_add_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_sub"
  p_sub_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_add_scaled"
  p_add_scaled_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_sub_scaled"
  p_sub_scaled_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_mul"
  p_mul_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_div"
  p_div_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_lshift"
  p_lshift_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_rshift"
  p_rshift_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_fmod"
  p_fmod_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_remainder"
  p_remainder_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_clamp"
  p_clamp_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_bitand"
  p_bitand_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_bitor"
  p_bitor_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_bitxor"
  p_bitxor_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cadd"
  p_cadd_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_csub"
  p_csub_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cmul"
  p_cmul_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cpow"
  p_cpow_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cdiv"
  p_cdiv_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_clshift"
  p_clshift_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_crshift"
  p_crshift_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cfmod"
  p_cfmod_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cremainder"
  p_cremainder_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cbitand"
  p_cbitand_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cbitor"
  p_cbitor_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cbitxor"
  p_cbitxor_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_addcmul"
  p_addcmul_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_addcdiv"
  p_addcdiv_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_addmv"
  p_addmv_ :: FunPtr (Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_addmm"
  p_addmm_ :: FunPtr (Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_addr"
  p_addr_ :: FunPtr (Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_addbmm"
  p_addbmm_ :: FunPtr (Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_baddbmm"
  p_baddbmm_ :: FunPtr (Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> CLong -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_match"
  p_match_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_numel"
  p_numel_ :: FunPtr (Ptr CTHLongTensor -> IO CPtrdiff)
...
foreign import ccall "THTensorMath.h &THLongTensor_max"
  p_max_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_min"
  p_min_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_kthvalue"
  p_kthvalue_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_mode"
  p_mode_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_median"
  p_median_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_sum"
  p_sum_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_prod"
  p_prod_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cumsum"
  p_cumsum_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cumprod"
  p_cumprod_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_sign"
  p_sign_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_trace"
  p_trace_ :: FunPtr (Ptr CTHLongTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THLongTensor_cross"
  p_cross_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cmax"
  p_cmax_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cmin"
  p_cmin_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cmaxValue"
  p_cmaxValue_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cminValue"
  p_cminValue_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_zeros"
  p_zeros_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_zerosLike"
  p_zerosLike_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_ones"
  p_ones_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_onesLike"
  p_onesLike_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_diag"
  p_diag_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_eye"
  p_eye_ :: FunPtr (Ptr CTHLongTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_arange"
  p_arange_ :: FunPtr (Ptr CTHLongTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_range"
  p_range_ :: FunPtr (Ptr CTHLongTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_randperm"
  p_randperm_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_reshape"
  p_reshape_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_sort"
  p_sort_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_topk"
  p_topk_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLLong -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_tril"
  p_tril_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_triu"
  p_triu_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_cat"
  p_cat_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_catArray"
  p_catArray_ :: FunPtr (Ptr CTHLongTensor -> Ptr (Ptr CTHLongTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_equal"
  p_equal_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THLongTensor_ltValue"
  p_ltValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_leValue"
  p_leValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_gtValue"
  p_gtValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_geValue"
  p_geValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_neValue"
  p_neValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_eqValue"
  p_eqValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_ltValueT"
  p_ltValueT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_leValueT"
  p_leValueT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_gtValueT"
  p_gtValueT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_geValueT"
  p_geValueT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_neValueT"
  p_neValueT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_eqValueT"
  p_eqValueT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_ltTensor"
  p_ltTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_leTensor"
  p_leTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_gtTensor"
  p_gtTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_geTensor"
  p_geTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_neTensor"
  p_neTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_eqTensor"
  p_eqTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_ltTensorT"
  p_ltTensorT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_leTensorT"
  p_leTensorT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_gtTensorT"
  p_gtTensorT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_geTensorT"
  p_geTensorT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_neTensorT"
  p_neTensorT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_eqTensorT"
  p_eqTensorT_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THLongTensor_abs"
  p_abs_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHLongTensor -> IO ())
