...
foreign import ccall "THStorageCopy.h &THLongStorage_rawCopy"
  p_rawCopy_ :: FunPtr (Ptr C'THLongStorage -> Ptr CLong -> IO ())
...
foreign import ccall "THStorageCopy.h &THLongStorage_copy"
  p_copy_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THLongStorage_copyByte"
  p_copyByte_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THByteStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THLongStorage_copyChar"
  p_copyChar_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THCharStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THLongStorage_copyShort"
  p_copyShort_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THShortStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THLongStorage_copyInt"
  p_copyInt_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THIntStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THLongStorage_copyLong"
  p_copyLong_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THLongStorage_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THFloatStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THLongStorage_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THDoubleStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THLongStorage_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THHalfStorage -> IO ())
