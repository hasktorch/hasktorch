...
foreign import ccall "THTensor.h &THLongTensor_storage"
  p_storage_ :: FunPtr (Ptr C'THLongTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THLongTensor_storageOffset"
  p_storageOffset_ :: FunPtr (Ptr C'THLongTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THLongTensor_nDimension"
  p_nDimension_ :: FunPtr (Ptr C'THLongTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THLongTensor_size"
  p_size_ :: FunPtr (Ptr C'THLongTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THLongTensor_stride"
  p_stride_ :: FunPtr (Ptr C'THLongTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THLongTensor_newSizeOf"
  p_newSizeOf_ :: FunPtr (Ptr C'THLongTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THLongTensor_newStrideOf"
  p_newStrideOf_ :: FunPtr (Ptr C'THLongTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THLongTensor_data"
  p_data_ :: FunPtr (Ptr C'THLongTensor -> IO (Ptr CLong))
...
foreign import ccall "THTensor.h &THLongTensor_setFlag"
  p_setFlag_ :: FunPtr (Ptr C'THLongTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr C'THLongTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_new"
  p_new_ :: FunPtr (IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newWithTensor"
  p_newWithTensor_ :: FunPtr (Ptr C'THLongTensor -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newWithStorage"
  p_newWithStorage_ :: FunPtr (Ptr C'THLongStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newWithStorage1d"
  p_newWithStorage1d_ :: FunPtr (Ptr C'THLongStorage -> CPtrdiff -> CLLong -> CLLong -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newWithStorage2d"
  p_newWithStorage2d_ :: FunPtr (Ptr C'THLongStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newWithStorage3d"
  p_newWithStorage3d_ :: FunPtr (Ptr C'THLongStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newWithStorage4d"
  p_newWithStorage4d_ :: FunPtr (Ptr C'THLongStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newWithSize"
  p_newWithSize_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newWithSize1d"
  p_newWithSize1d_ :: FunPtr (CLLong -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newWithSize2d"
  p_newWithSize2d_ :: FunPtr (CLLong -> CLLong -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newWithSize3d"
  p_newWithSize3d_ :: FunPtr (CLLong -> CLLong -> CLLong -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newWithSize4d"
  p_newWithSize4d_ :: FunPtr (CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newClone"
  p_newClone_ :: FunPtr (Ptr C'THLongTensor -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newContiguous"
  p_newContiguous_ :: FunPtr (Ptr C'THLongTensor -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newSelect"
  p_newSelect_ :: FunPtr (Ptr C'THLongTensor -> CInt -> CLLong -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newNarrow"
  p_newNarrow_ :: FunPtr (Ptr C'THLongTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newTranspose"
  p_newTranspose_ :: FunPtr (Ptr C'THLongTensor -> CInt -> CInt -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newUnfold"
  p_newUnfold_ :: FunPtr (Ptr C'THLongTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newView"
  p_newView_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongStorage -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_newExpand"
  p_newExpand_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongStorage -> IO (Ptr C'THLongTensor))
...
foreign import ccall "THTensor.h &THLongTensor_expand"
  p_expand_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_expandNd"
  p_expandNd_ :: FunPtr (Ptr (Ptr C'THLongTensor) -> Ptr (Ptr C'THLongTensor) -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_resize"
  p_resize_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_resizeAs"
  p_resizeAs_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_resizeNd"
  p_resizeNd_ :: FunPtr (Ptr C'THLongTensor -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_resize1d"
  p_resize1d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_resize2d"
  p_resize2d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_resize3d"
  p_resize3d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_resize4d"
  p_resize4d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_resize5d"
  p_resize5d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_set"
  p_set_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_setStorage"
  p_setStorage_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_setStorageNd"
  p_setStorageNd_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongStorage -> CPtrdiff -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_setStorage1d"
  p_setStorage1d_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongStorage -> CPtrdiff -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_setStorage2d"
  p_setStorage2d_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_setStorage3d"
  p_setStorage3d_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_setStorage4d"
  p_setStorage4d_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_narrow"
  p_narrow_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_select"
  p_select_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> CInt -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_transpose"
  p_transpose_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_unfold"
  p_unfold_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_squeeze"
  p_squeeze_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_squeeze1d"
  p_squeeze1d_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_unsqueeze1d"
  p_unsqueeze1d_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_isContiguous"
  p_isContiguous_ :: FunPtr (Ptr C'THLongTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THLongTensor_isSameSizeAs"
  p_isSameSizeAs_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THLongTensor_isSetTo"
  p_isSetTo_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THLongTensor_isSize"
  p_isSize_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongStorage -> IO CInt)
...
foreign import ccall "THTensor.h &THLongTensor_nElement"
  p_nElement_ :: FunPtr (Ptr C'THLongTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THLongTensor_retain"
  p_retain_ :: FunPtr (Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_free"
  p_free_ :: FunPtr (Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_freeCopyTo"
  p_freeCopyTo_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_set1d"
  p_set1d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> CLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_set2d"
  p_set2d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> CLLong -> CLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_set3d"
  p_set3d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> CLLong -> CLLong -> CLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_set4d"
  p_set4d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CLong -> IO ())
...
foreign import ccall "THTensor.h &THLongTensor_get1d"
  p_get1d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> IO CLong)
...
foreign import ccall "THTensor.h &THLongTensor_get2d"
  p_get2d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> CLLong -> IO CLong)
...
foreign import ccall "THTensor.h &THLongTensor_get3d"
  p_get3d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> CLLong -> CLLong -> IO CLong)
...
foreign import ccall "THTensor.h &THLongTensor_get4d"
  p_get4d_ :: FunPtr (Ptr C'THLongTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO CLong)
...
foreign import ccall "THTensor.h &THLongTensor_desc"
  p_desc_ :: FunPtr (Ptr C'THLongTensor -> IO (Ptr C'THDescBuff))
...
foreign import ccall "THTensor.h &THLongTensor_sizeDesc"
  p_sizeDesc_ :: FunPtr (Ptr C'THLongTensor -> IO (Ptr C'THDescBuff))
