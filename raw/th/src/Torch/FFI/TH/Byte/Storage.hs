...
foreign import ccall "THStorage.h THByteStorage_newWithAllocator"
  c_newWithAllocator :: CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHByteStorage)
...
foreign import ccall "THStorage.h THByteStorage_newWithDataAndAllocator"
  c_newWithDataAndAllocator :: Ptr CUChar -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHByteStorage)
...
foreign import ccall "THStorage.h &THByteStorage_newWithAllocator"
  p_newWithAllocator :: FunPtr (CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHByteStorage))

-- | p_newWithDataAndAllocator : Pointer to function : data size allocator allocatorContext -> THStorage *
foreign import ccall "THStorage.h &THByteStorage_newWithDataAndAllocator"
  p_newWithDataAndAllocator :: FunPtr (Ptr CUChar -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHByteStorage))
