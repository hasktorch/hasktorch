...
foreign import ccall "THStorage.h THByteStorage_data"
  c_data_ :: Ptr CTHByteStorage -> IO (Ptr CUChar)
...
foreign import ccall "THStorage.h THByteStorage_size"
  c_size_ :: Ptr CTHByteStorage -> IO CPtrdiff
...
foreign import ccall "THStorage.h THByteStorage_set"
  c_set_ :: Ptr CTHByteStorage -> CPtrdiff -> CUChar -> IO ()
...
foreign import ccall "THStorage.h THByteStorage_get"
  c_get_ :: Ptr CTHByteStorage -> CPtrdiff -> IO CUChar
...
foreign import ccall "THStorage.h THByteStorage_newWithSize"
  c_newWithSize_ :: CPtrdiff -> IO (Ptr CTHByteStorage)
...
foreign import ccall "THStorage.h THByteStorage_newWithSize1"
  c_newWithSize1_ :: CUChar -> IO (Ptr CTHByteStorage)
...
foreign import ccall "THStorage.h THByteStorage_newWithSize2"
  c_newWithSize2_ :: CUChar -> CUChar -> IO (Ptr CTHByteStorage)
...
foreign import ccall "THStorage.h THByteStorage_newWithSize3"
  c_newWithSize3_ :: CUChar -> CUChar -> CUChar -> IO (Ptr CTHByteStorage)
...
foreign import ccall "THStorage.h THByteStorage_newWithSize4"
  c_newWithSize4_ :: CUChar -> CUChar -> CUChar -> CUChar -> IO (Ptr CTHByteStorage)
...
foreign import ccall "THStorage.h THByteStorage_newWithMapping"
  c_newWithMapping_ :: Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHByteStorage)
...
foreign import ccall "THStorage.h THByteStorage_newWithData"
  c_newWithData_ :: Ptr CUChar -> CPtrdiff -> IO (Ptr CTHByteStorage)
...
foreign import ccall "THStorage.h THByteStorage_newWithAllocator"
  c_newWithAllocator_ :: CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHByteStorage)
...
foreign import ccall "THStorage.h THByteStorage_newWithDataAndAllocator"
  c_newWithDataAndAllocator_ :: Ptr CUChar -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHByteStorage)
...
foreign import ccall "THStorage.h THByteStorage_setFlag"
  c_setFlag_ :: Ptr CTHByteStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THByteStorage_clearFlag"
  c_clearFlag_ :: Ptr CTHByteStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THByteStorage_retain"
  c_retain_ :: Ptr CTHByteStorage -> IO ()
...
foreign import ccall "THStorage.h THByteStorage_swap"
  c_swap_ :: Ptr CTHByteStorage -> Ptr CTHByteStorage -> IO ()
...
foreign import ccall "THStorage.h THByteStorage_resize"
  c_resize_ :: Ptr CTHByteStorage -> CPtrdiff -> IO ()
...
foreign import ccall "THStorage.h THByteStorage_fill"
  c_fill_ :: Ptr CTHByteStorage -> CUChar -> IO ()
...
foreign import ccall "THStorage.h &THByteStorage_data"
  p_data_ :: FunPtr (Ptr CTHByteStorage -> IO (Ptr CUChar))
...
foreign import ccall "THStorage.h &THByteStorage_size"
  p_size_ :: FunPtr (Ptr CTHByteStorage -> IO CPtrdiff)
...
foreign import ccall "THStorage.h &THByteStorage_set"
  p_set_ :: FunPtr (Ptr CTHByteStorage -> CPtrdiff -> CUChar -> IO ())
...
foreign import ccall "THStorage.h &THByteStorage_get"
  p_get_ :: FunPtr (Ptr CTHByteStorage -> CPtrdiff -> IO CUChar)
...
foreign import ccall "THStorage.h &THByteStorage_new"
  p_new_ :: FunPtr (IO (Ptr CTHByteStorage))
...
foreign import ccall "THStorage.h &THByteStorage_newWithSize"
  p_newWithSize_ :: FunPtr (CPtrdiff -> IO (Ptr CTHByteStorage))
...
foreign import ccall "THStorage.h &THByteStorage_newWithSize1"
  p_newWithSize1_ :: FunPtr (CUChar -> IO (Ptr CTHByteStorage))
...
foreign import ccall "THStorage.h &THByteStorage_newWithSize2"
  p_newWithSize2_ :: FunPtr (CUChar -> CUChar -> IO (Ptr CTHByteStorage))
...
foreign import ccall "THStorage.h &THByteStorage_newWithSize3"
  p_newWithSize3_ :: FunPtr (CUChar -> CUChar -> CUChar -> IO (Ptr CTHByteStorage))
...
foreign import ccall "THStorage.h &THByteStorage_newWithSize4"
  p_newWithSize4_ :: FunPtr (CUChar -> CUChar -> CUChar -> CUChar -> IO (Ptr CTHByteStorage))
...
foreign import ccall "THStorage.h &THByteStorage_newWithMapping"
  p_newWithMapping_ :: FunPtr (Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHByteStorage))
...
foreign import ccall "THStorage.h &THByteStorage_newWithData"
  p_newWithData_ :: FunPtr (Ptr CUChar -> CPtrdiff -> IO (Ptr CTHByteStorage))
...
foreign import ccall "THStorage.h &THByteStorage_newWithAllocator"
  p_newWithAllocator_ :: FunPtr (CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHByteStorage))
...
foreign import ccall "THStorage.h &THByteStorage_newWithDataAndAllocator"
  p_newWithDataAndAllocator_ :: FunPtr (Ptr CUChar -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHByteStorage))
...
foreign import ccall "THStorage.h &THByteStorage_setFlag"
  p_setFlag_ :: FunPtr (Ptr CTHByteStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THByteStorage_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr CTHByteStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THByteStorage_retain"
  p_retain_ :: FunPtr (Ptr CTHByteStorage -> IO ())
...
foreign import ccall "THStorage.h &THByteStorage_swap"
  p_swap_ :: FunPtr (Ptr CTHByteStorage -> Ptr CTHByteStorage -> IO ())
...
foreign import ccall "THStorage.h &THByteStorage_free"
  p_free_ :: FunPtr (Ptr CTHByteStorage -> IO ())
...
foreign import ccall "THStorage.h &THByteStorage_resize"
  p_resize_ :: FunPtr (Ptr CTHByteStorage -> CPtrdiff -> IO ())
...
foreign import ccall "THStorage.h &THByteStorage_fill"
  p_fill_ :: FunPtr (Ptr CTHByteStorage -> CUChar -> IO ())
