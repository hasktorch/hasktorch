...
foreign import ccall "THTensorMath.h &THByteTensor_fill"
  p_fill_ :: FunPtr (Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_zero"
  p_zero_ :: FunPtr (Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_maskedFill"
  p_maskedFill_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_maskedCopy"
  p_maskedCopy_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_maskedSelect"
  p_maskedSelect_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_nonzero"
  p_nonzero_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_indexSelect"
  p_indexSelect_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_indexCopy"
  p_indexCopy_ :: FunPtr (Ptr C'THByteTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_indexAdd"
  p_indexAdd_ :: FunPtr (Ptr C'THByteTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_indexFill"
  p_indexFill_ :: FunPtr (Ptr C'THByteTensor -> CInt -> Ptr C'THLongTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_take"
  p_take_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_put"
  p_put_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_gather"
  p_gather_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_scatter"
  p_scatter_ :: FunPtr (Ptr C'THByteTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_scatterAdd"
  p_scatterAdd_ :: FunPtr (Ptr C'THByteTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_scatterFill"
  p_scatterFill_ :: FunPtr (Ptr C'THByteTensor -> CInt -> Ptr C'THLongTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_dot"
  p_dot_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THByteTensor_minall"
  p_minall_ :: FunPtr (Ptr C'THByteTensor -> IO CUChar)
...
foreign import ccall "THTensorMath.h &THByteTensor_maxall"
  p_maxall_ :: FunPtr (Ptr C'THByteTensor -> IO CUChar)
...
foreign import ccall "THTensorMath.h &THByteTensor_medianall"
  p_medianall_ :: FunPtr (Ptr C'THByteTensor -> IO CUChar)
...
foreign import ccall "THTensorMath.h &THByteTensor_sumall"
  p_sumall_ :: FunPtr (Ptr C'THByteTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THByteTensor_prodall"
  p_prodall_ :: FunPtr (Ptr C'THByteTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THByteTensor_add"
  p_add_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_sub"
  p_sub_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_add_scaled"
  p_add_scaled_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_sub_scaled"
  p_sub_scaled_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_mul"
  p_mul_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_div"
  p_div_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_lshift"
  p_lshift_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_rshift"
  p_rshift_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_fmod"
  p_fmod_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_remainder"
  p_remainder_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_clamp"
  p_clamp_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_bitand"
  p_bitand_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_bitor"
  p_bitor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_bitxor"
  p_bitxor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cadd"
  p_cadd_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_csub"
  p_csub_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cmul"
  p_cmul_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cpow"
  p_cpow_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cdiv"
  p_cdiv_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_clshift"
  p_clshift_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_crshift"
  p_crshift_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cfmod"
  p_cfmod_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cremainder"
  p_cremainder_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cbitand"
  p_cbitand_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cbitor"
  p_cbitor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cbitxor"
  p_cbitxor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_addcmul"
  p_addcmul_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_addcdiv"
  p_addcdiv_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_addmv"
  p_addmv_ :: FunPtr (Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_addmm"
  p_addmm_ :: FunPtr (Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_addr"
  p_addr_ :: FunPtr (Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_addbmm"
  p_addbmm_ :: FunPtr (Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_baddbmm"
  p_baddbmm_ :: FunPtr (Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> CUChar -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_match"
  p_match_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_numel"
  p_numel_ :: FunPtr (Ptr C'THByteTensor -> IO CPtrdiff)
...
foreign import ccall "THTensorMath.h &THByteTensor_preserveReduceDimSemantics"
  p_preserveReduceDimSemantics_ :: FunPtr (Ptr C'THByteTensor -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_max"
  p_max_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_min"
  p_min_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_kthvalue"
  p_kthvalue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_mode"
  p_mode_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_median"
  p_median_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_sum"
  p_sum_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_prod"
  p_prod_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cumsum"
  p_cumsum_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cumprod"
  p_cumprod_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_sign"
  p_sign_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_trace"
  p_trace_ :: FunPtr (Ptr C'THByteTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THByteTensor_cross"
  p_cross_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cmax"
  p_cmax_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cmin"
  p_cmin_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cmaxValue"
  p_cmaxValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cminValue"
  p_cminValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_zeros"
  p_zeros_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_zerosLike"
  p_zerosLike_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_ones"
  p_ones_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_onesLike"
  p_onesLike_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_diag"
  p_diag_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_eye"
  p_eye_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_arange"
  p_arange_ :: FunPtr (Ptr C'THByteTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_range"
  p_range_ :: FunPtr (Ptr C'THByteTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_randperm"
  p_randperm_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_reshape"
  p_reshape_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_sort"
  p_sort_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_topk"
  p_topk_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongTensor -> Ptr C'THByteTensor -> CLLong -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_tril"
  p_tril_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_triu"
  p_triu_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_cat"
  p_cat_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_catArray"
  p_catArray_ :: FunPtr (Ptr C'THByteTensor -> Ptr (Ptr C'THByteTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_equal"
  p_equal_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THByteTensor_ltValue"
  p_ltValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_leValue"
  p_leValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_gtValue"
  p_gtValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_geValue"
  p_geValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_neValue"
  p_neValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_eqValue"
  p_eqValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_ltValueT"
  p_ltValueT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_leValueT"
  p_leValueT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_gtValueT"
  p_gtValueT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_geValueT"
  p_geValueT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_neValueT"
  p_neValueT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_eqValueT"
  p_eqValueT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CUChar -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_ltTensor"
  p_ltTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_leTensor"
  p_leTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_gtTensor"
  p_gtTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_geTensor"
  p_geTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_neTensor"
  p_neTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_eqTensor"
  p_eqTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_ltTensorT"
  p_ltTensorT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_leTensorT"
  p_leTensorT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_gtTensorT"
  p_gtTensorT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_geTensorT"
  p_geTensorT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_neTensorT"
  p_neTensorT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_eqTensorT"
  p_eqTensorT_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THByteTensor_logicalall"
  p_logicalall_ :: FunPtr (Ptr C'THByteTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THByteTensor_logicalany"
  p_logicalany_ :: FunPtr (Ptr C'THByteTensor -> IO CInt)
