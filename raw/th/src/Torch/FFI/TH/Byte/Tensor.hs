...
foreign import ccall "THTensor.h &THByteTensor_storage"
  p_storage_ :: FunPtr (Ptr C'THByteTensor -> IO (Ptr C'THByteStorage))
...
foreign import ccall "THTensor.h &THByteTensor_storageOffset"
  p_storageOffset_ :: FunPtr (Ptr C'THByteTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THByteTensor_nDimension"
  p_nDimension_ :: FunPtr (Ptr C'THByteTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THByteTensor_size"
  p_size_ :: FunPtr (Ptr C'THByteTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THByteTensor_stride"
  p_stride_ :: FunPtr (Ptr C'THByteTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THByteTensor_newSizeOf"
  p_newSizeOf_ :: FunPtr (Ptr C'THByteTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THByteTensor_newStrideOf"
  p_newStrideOf_ :: FunPtr (Ptr C'THByteTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THByteTensor_data"
  p_data_ :: FunPtr (Ptr C'THByteTensor -> IO (Ptr CUChar))
...
foreign import ccall "THTensor.h &THByteTensor_setFlag"
  p_setFlag_ :: FunPtr (Ptr C'THByteTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr C'THByteTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_new"
  p_new_ :: FunPtr (IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newWithTensor"
  p_newWithTensor_ :: FunPtr (Ptr C'THByteTensor -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newWithStorage"
  p_newWithStorage_ :: FunPtr (Ptr C'THByteStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newWithStorage1d"
  p_newWithStorage1d_ :: FunPtr (Ptr C'THByteStorage -> CPtrdiff -> CLLong -> CLLong -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newWithStorage2d"
  p_newWithStorage2d_ :: FunPtr (Ptr C'THByteStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newWithStorage3d"
  p_newWithStorage3d_ :: FunPtr (Ptr C'THByteStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newWithStorage4d"
  p_newWithStorage4d_ :: FunPtr (Ptr C'THByteStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newWithSize"
  p_newWithSize_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newWithSize1d"
  p_newWithSize1d_ :: FunPtr (CLLong -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newWithSize2d"
  p_newWithSize2d_ :: FunPtr (CLLong -> CLLong -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newWithSize3d"
  p_newWithSize3d_ :: FunPtr (CLLong -> CLLong -> CLLong -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newWithSize4d"
  p_newWithSize4d_ :: FunPtr (CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newClone"
  p_newClone_ :: FunPtr (Ptr C'THByteTensor -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newContiguous"
  p_newContiguous_ :: FunPtr (Ptr C'THByteTensor -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newSelect"
  p_newSelect_ :: FunPtr (Ptr C'THByteTensor -> CInt -> CLLong -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newNarrow"
  p_newNarrow_ :: FunPtr (Ptr C'THByteTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newTranspose"
  p_newTranspose_ :: FunPtr (Ptr C'THByteTensor -> CInt -> CInt -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newUnfold"
  p_newUnfold_ :: FunPtr (Ptr C'THByteTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newView"
  p_newView_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongStorage -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_newExpand"
  p_newExpand_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongStorage -> IO (Ptr C'THByteTensor))
...
foreign import ccall "THTensor.h &THByteTensor_expand"
  p_expand_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_expandNd"
  p_expandNd_ :: FunPtr (Ptr (Ptr C'THByteTensor) -> Ptr (Ptr C'THByteTensor) -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_resize"
  p_resize_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_resizeAs"
  p_resizeAs_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_resizeNd"
  p_resizeNd_ :: FunPtr (Ptr C'THByteTensor -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_resize1d"
  p_resize1d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_resize2d"
  p_resize2d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_resize3d"
  p_resize3d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_resize4d"
  p_resize4d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_resize5d"
  p_resize5d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_set"
  p_set_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_setStorage"
  p_setStorage_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_setStorageNd"
  p_setStorageNd_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteStorage -> CPtrdiff -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_setStorage1d"
  p_setStorage1d_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteStorage -> CPtrdiff -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_setStorage2d"
  p_setStorage2d_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_setStorage3d"
  p_setStorage3d_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_setStorage4d"
  p_setStorage4d_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_narrow"
  p_narrow_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_select"
  p_select_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_transpose"
  p_transpose_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_unfold"
  p_unfold_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_squeeze"
  p_squeeze_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_squeeze1d"
  p_squeeze1d_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_unsqueeze1d"
  p_unsqueeze1d_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_isContiguous"
  p_isContiguous_ :: FunPtr (Ptr C'THByteTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THByteTensor_isSameSizeAs"
  p_isSameSizeAs_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THByteTensor_isSetTo"
  p_isSetTo_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THByteTensor_isSize"
  p_isSize_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THLongStorage -> IO CInt)
...
foreign import ccall "THTensor.h &THByteTensor_nElement"
  p_nElement_ :: FunPtr (Ptr C'THByteTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THByteTensor_retain"
  p_retain_ :: FunPtr (Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_free"
  p_free_ :: FunPtr (Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_freeCopyTo"
  p_freeCopyTo_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_set1d"
  p_set1d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CUChar -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_set2d"
  p_set2d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CLLong -> CUChar -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_set3d"
  p_set3d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CLLong -> CLLong -> CUChar -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_set4d"
  p_set4d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CUChar -> IO ())
...
foreign import ccall "THTensor.h &THByteTensor_get1d"
  p_get1d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> IO CUChar)
...
foreign import ccall "THTensor.h &THByteTensor_get2d"
  p_get2d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CLLong -> IO CUChar)
...
foreign import ccall "THTensor.h &THByteTensor_get3d"
  p_get3d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CLLong -> CLLong -> IO CUChar)
...
foreign import ccall "THTensor.h &THByteTensor_get4d"
  p_get4d_ :: FunPtr (Ptr C'THByteTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO CUChar)
...
foreign import ccall "THTensor.h &THByteTensor_desc"
  p_desc_ :: FunPtr (Ptr C'THByteTensor -> IO (Ptr C'THDescBuff))
...
foreign import ccall "THTensor.h &THByteTensor_sizeDesc"
  p_sizeDesc_ :: FunPtr (Ptr C'THByteTensor -> IO (Ptr C'THDescBuff))
