...
foreign import ccall "THTensor.h &THFloatTensor_storage"
  p_storage_ :: FunPtr (Ptr C'THFloatTensor -> IO (Ptr C'THFloatStorage))
...
foreign import ccall "THTensor.h &THFloatTensor_storageOffset"
  p_storageOffset_ :: FunPtr (Ptr C'THFloatTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THFloatTensor_nDimension"
  p_nDimension_ :: FunPtr (Ptr C'THFloatTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THFloatTensor_size"
  p_size_ :: FunPtr (Ptr C'THFloatTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THFloatTensor_stride"
  p_stride_ :: FunPtr (Ptr C'THFloatTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THFloatTensor_newSizeOf"
  p_newSizeOf_ :: FunPtr (Ptr C'THFloatTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THFloatTensor_newStrideOf"
  p_newStrideOf_ :: FunPtr (Ptr C'THFloatTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THFloatTensor_data"
  p_data_ :: FunPtr (Ptr C'THFloatTensor -> IO (Ptr CFloat))
...
foreign import ccall "THTensor.h &THFloatTensor_setFlag"
  p_setFlag_ :: FunPtr (Ptr C'THFloatTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr C'THFloatTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_new"
  p_new_ :: FunPtr (IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newWithTensor"
  p_newWithTensor_ :: FunPtr (Ptr C'THFloatTensor -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newWithStorage"
  p_newWithStorage_ :: FunPtr (Ptr C'THFloatStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newWithStorage1d"
  p_newWithStorage1d_ :: FunPtr (Ptr C'THFloatStorage -> CPtrdiff -> CLLong -> CLLong -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newWithStorage2d"
  p_newWithStorage2d_ :: FunPtr (Ptr C'THFloatStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newWithStorage3d"
  p_newWithStorage3d_ :: FunPtr (Ptr C'THFloatStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newWithStorage4d"
  p_newWithStorage4d_ :: FunPtr (Ptr C'THFloatStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newWithSize"
  p_newWithSize_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newWithSize1d"
  p_newWithSize1d_ :: FunPtr (CLLong -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newWithSize2d"
  p_newWithSize2d_ :: FunPtr (CLLong -> CLLong -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newWithSize3d"
  p_newWithSize3d_ :: FunPtr (CLLong -> CLLong -> CLLong -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newWithSize4d"
  p_newWithSize4d_ :: FunPtr (CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newClone"
  p_newClone_ :: FunPtr (Ptr C'THFloatTensor -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newContiguous"
  p_newContiguous_ :: FunPtr (Ptr C'THFloatTensor -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newSelect"
  p_newSelect_ :: FunPtr (Ptr C'THFloatTensor -> CInt -> CLLong -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newNarrow"
  p_newNarrow_ :: FunPtr (Ptr C'THFloatTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newTranspose"
  p_newTranspose_ :: FunPtr (Ptr C'THFloatTensor -> CInt -> CInt -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newUnfold"
  p_newUnfold_ :: FunPtr (Ptr C'THFloatTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newView"
  p_newView_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THLongStorage -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_newExpand"
  p_newExpand_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THLongStorage -> IO (Ptr C'THFloatTensor))
...
foreign import ccall "THTensor.h &THFloatTensor_expand"
  p_expand_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_expandNd"
  p_expandNd_ :: FunPtr (Ptr (Ptr C'THFloatTensor) -> Ptr (Ptr C'THFloatTensor) -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_resize"
  p_resize_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_resizeAs"
  p_resizeAs_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_resizeNd"
  p_resizeNd_ :: FunPtr (Ptr C'THFloatTensor -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_resize1d"
  p_resize1d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_resize2d"
  p_resize2d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_resize3d"
  p_resize3d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_resize4d"
  p_resize4d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_resize5d"
  p_resize5d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_set"
  p_set_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_setStorage"
  p_setStorage_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_setStorageNd"
  p_setStorageNd_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatStorage -> CPtrdiff -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_setStorage1d"
  p_setStorage1d_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatStorage -> CPtrdiff -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_setStorage2d"
  p_setStorage2d_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_setStorage3d"
  p_setStorage3d_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_setStorage4d"
  p_setStorage4d_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_narrow"
  p_narrow_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_select"
  p_select_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CInt -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_transpose"
  p_transpose_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_unfold"
  p_unfold_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_squeeze"
  p_squeeze_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_squeeze1d"
  p_squeeze1d_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_unsqueeze1d"
  p_unsqueeze1d_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_isContiguous"
  p_isContiguous_ :: FunPtr (Ptr C'THFloatTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THFloatTensor_isSameSizeAs"
  p_isSameSizeAs_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THFloatTensor_isSetTo"
  p_isSetTo_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THFloatTensor_isSize"
  p_isSize_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THLongStorage -> IO CInt)
...
foreign import ccall "THTensor.h &THFloatTensor_nElement"
  p_nElement_ :: FunPtr (Ptr C'THFloatTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THFloatTensor_retain"
  p_retain_ :: FunPtr (Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_free"
  p_free_ :: FunPtr (Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_freeCopyTo"
  p_freeCopyTo_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_set1d"
  p_set1d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> CFloat -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_set2d"
  p_set2d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> CLLong -> CFloat -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_set3d"
  p_set3d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> CFloat -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_set4d"
  p_set4d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CFloat -> IO ())
...
foreign import ccall "THTensor.h &THFloatTensor_get1d"
  p_get1d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> IO CFloat)
...
foreign import ccall "THTensor.h &THFloatTensor_get2d"
  p_get2d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> CLLong -> IO CFloat)
...
foreign import ccall "THTensor.h &THFloatTensor_get3d"
  p_get3d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> IO CFloat)
...
foreign import ccall "THTensor.h &THFloatTensor_get4d"
  p_get4d_ :: FunPtr (Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO CFloat)
...
foreign import ccall "THTensor.h &THFloatTensor_desc"
  p_desc_ :: FunPtr (Ptr C'THFloatTensor -> IO (Ptr C'THDescBuff))
...
foreign import ccall "THTensor.h &THFloatTensor_sizeDesc"
  p_sizeDesc_ :: FunPtr (Ptr C'THFloatTensor -> IO (Ptr C'THDescBuff))
