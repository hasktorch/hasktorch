...
foreign import ccall "THStorage.h THFloatStorage_newWithAllocator"
  c_newWithAllocator :: CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHFloatStorage)
...
foreign import ccall "THStorage.h THFloatStorage_newWithDataAndAllocator"
  c_newWithDataAndAllocator :: Ptr CFloat -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHFloatStorage)
...
foreign import ccall "THStorage.h &THFloatStorage_newWithAllocator"
  p_newWithAllocator :: FunPtr (CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHFloatStorage))

-- | p_newWithDataAndAllocator : Pointer to function : data size allocator allocatorContext -> THStorage *
foreign import ccall "THStorage.h &THFloatStorage_newWithDataAndAllocator"
  p_newWithDataAndAllocator :: FunPtr (Ptr CFloat -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHFloatStorage))
