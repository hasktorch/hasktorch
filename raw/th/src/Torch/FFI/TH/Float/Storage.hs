...
foreign import ccall "THStorage.h &THFloatStorage_data"
  p_data_ :: FunPtr (Ptr C'THFloatStorage -> IO (Ptr CFloat))
...
foreign import ccall "THStorage.h &THFloatStorage_size"
  p_size_ :: FunPtr (Ptr C'THFloatStorage -> IO CPtrdiff)
...
foreign import ccall "THStorage.h &THFloatStorage_set"
  p_set_ :: FunPtr (Ptr C'THFloatStorage -> CPtrdiff -> CFloat -> IO ())
...
foreign import ccall "THStorage.h &THFloatStorage_get"
  p_get_ :: FunPtr (Ptr C'THFloatStorage -> CPtrdiff -> IO CFloat)
...
foreign import ccall "THStorage.h &THFloatStorage_new"
  p_new_ :: FunPtr (IO (Ptr C'THFloatStorage))
...
foreign import ccall "THStorage.h &THFloatStorage_newWithSize"
  p_newWithSize_ :: FunPtr (CPtrdiff -> IO (Ptr C'THFloatStorage))
...
foreign import ccall "THStorage.h &THFloatStorage_newWithSize1"
  p_newWithSize1_ :: FunPtr (CFloat -> IO (Ptr C'THFloatStorage))
...
foreign import ccall "THStorage.h &THFloatStorage_newWithSize2"
  p_newWithSize2_ :: FunPtr (CFloat -> CFloat -> IO (Ptr C'THFloatStorage))
...
foreign import ccall "THStorage.h &THFloatStorage_newWithSize3"
  p_newWithSize3_ :: FunPtr (CFloat -> CFloat -> CFloat -> IO (Ptr C'THFloatStorage))
...
foreign import ccall "THStorage.h &THFloatStorage_newWithSize4"
  p_newWithSize4_ :: FunPtr (CFloat -> CFloat -> CFloat -> CFloat -> IO (Ptr C'THFloatStorage))
...
foreign import ccall "THStorage.h &THFloatStorage_newWithMapping"
  p_newWithMapping_ :: FunPtr (Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr C'THFloatStorage))
...
foreign import ccall "THStorage.h &THFloatStorage_newWithData"
  p_newWithData_ :: FunPtr (Ptr CFloat -> CPtrdiff -> IO (Ptr C'THFloatStorage))
...
foreign import ccall "THStorage.h &THFloatStorage_newWithAllocator"
  p_newWithAllocator_ :: FunPtr (CPtrdiff -> Ptr C'THAllocator -> Ptr () -> IO (Ptr C'THFloatStorage))
...
foreign import ccall "THStorage.h &THFloatStorage_newWithDataAndAllocator"
  p_newWithDataAndAllocator_ :: FunPtr (Ptr CFloat -> CPtrdiff -> Ptr C'THAllocator -> Ptr () -> IO (Ptr C'THFloatStorage))
...
foreign import ccall "THStorage.h &THFloatStorage_setFlag"
  p_setFlag_ :: FunPtr (Ptr C'THFloatStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THFloatStorage_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr C'THFloatStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THFloatStorage_retain"
  p_retain_ :: FunPtr (Ptr C'THFloatStorage -> IO ())
...
foreign import ccall "THStorage.h &THFloatStorage_swap"
  p_swap_ :: FunPtr (Ptr C'THFloatStorage -> Ptr C'THFloatStorage -> IO ())
...
foreign import ccall "THStorage.h &THFloatStorage_free"
  p_free_ :: FunPtr (Ptr C'THFloatStorage -> IO ())
...
foreign import ccall "THStorage.h &THFloatStorage_resize"
  p_resize_ :: FunPtr (Ptr C'THFloatStorage -> CPtrdiff -> IO ())
...
foreign import ccall "THStorage.h &THFloatStorage_fill"
  p_fill_ :: FunPtr (Ptr C'THFloatStorage -> CFloat -> IO ())
