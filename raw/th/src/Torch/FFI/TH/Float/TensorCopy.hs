...
foreign import ccall "THTensorCopy.h &THFloatTensor_copy"
  p_copy_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THFloatTensor_copyByte"
  p_copyByte_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THFloatTensor_copyChar"
  p_copyChar_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THFloatTensor_copyShort"
  p_copyShort_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THFloatTensor_copyInt"
  p_copyInt_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THFloatTensor_copyLong"
  p_copyLong_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THFloatTensor_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THFloatTensor_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THFloatTensor_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr C'THFloatTensor -> Ptr C'THHalfTensor -> IO ())
