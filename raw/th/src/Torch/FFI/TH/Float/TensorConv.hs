...
foreign import ccall "THTensorConv.h &THFloatTensor_conv2DRevger"
  p_conv2DRevger_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THFloatTensor_conv2DRevgerm"
  p_conv2DRevgerm_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THFloatTensor_conv2Dger"
  p_conv2Dger_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THFloatTensor_conv2Dmv"
  p_conv2Dmv_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THFloatTensor_conv2Dmm"
  p_conv2Dmm_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THFloatTensor_conv2Dmul"
  p_conv2Dmul_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THFloatTensor_conv2Dcmul"
  p_conv2Dcmul_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THFloatTensor_conv3DRevger"
  p_conv3DRevger_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THFloatTensor_conv3Dger"
  p_conv3Dger_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THFloatTensor_conv3Dmv"
  p_conv3Dmv_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THFloatTensor_conv3Dmul"
  p_conv3Dmul_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THFloatTensor_conv3Dcmul"
  p_conv3Dcmul_ :: FunPtr (Ptr C'THFloatTensor -> CFloat -> CFloat -> Ptr C'THFloatTensor -> Ptr C'THFloatTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
