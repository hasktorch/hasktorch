...
foreign import ccall "THTensorMath.h THFloatTensor_fill"
  c_fill_ :: Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_maskedFill"
  c_maskedFill_ :: Ptr CTHFloatTensor -> Ptr CTHByteTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_maskedCopy"
  c_maskedCopy_ :: Ptr CTHFloatTensor -> Ptr CTHByteTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_maskedSelect"
  c_maskedSelect_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHByteTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_nonzero"
  c_nonzero_ :: Ptr CTHLongTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_indexSelect"
  c_indexSelect_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_indexCopy"
  c_indexCopy_ :: Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_indexAdd"
  c_indexAdd_ :: Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_indexFill"
  c_indexFill_ :: Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_take"
  c_take_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_put"
  c_put_ :: Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_gather"
  c_gather_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_scatter"
  c_scatter_ :: Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_scatterAdd"
  c_scatterAdd_ :: Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_scatterFill"
  c_scatterFill_ :: Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_dot"
  c_dot_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THFloatTensor_minall"
  c_minall_ :: Ptr CTHFloatTensor -> IO CFloat
...
foreign import ccall "THTensorMath.h THFloatTensor_maxall"
  c_maxall_ :: Ptr CTHFloatTensor -> IO CFloat
...
foreign import ccall "THTensorMath.h THFloatTensor_medianall"
  c_medianall_ :: Ptr CTHFloatTensor -> IO CFloat
...
foreign import ccall "THTensorMath.h THFloatTensor_sumall"
  c_sumall_ :: Ptr CTHFloatTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THFloatTensor_prodall"
  c_prodall_ :: Ptr CTHFloatTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THFloatTensor_neg"
  c_neg_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cinv"
  c_cinv_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_add"
  c_add_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_sub"
  c_sub_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_add_scaled"
  c_add_scaled_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_sub_scaled"
  c_sub_scaled_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_mul"
  c_mul_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_div"
  c_div_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_lshift"
  c_lshift_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_rshift"
  c_rshift_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_fmod"
  c_fmod_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_remainder"
  c_remainder_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_clamp"
  c_clamp_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_bitand"
  c_bitand_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_bitor"
  c_bitor_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_bitxor"
  c_bitxor_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cadd"
  c_cadd_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_csub"
  c_csub_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cmul"
  c_cmul_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cpow"
  c_cpow_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cdiv"
  c_cdiv_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_clshift"
  c_clshift_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_crshift"
  c_crshift_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cfmod"
  c_cfmod_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cremainder"
  c_cremainder_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cbitand"
  c_cbitand_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cbitor"
  c_cbitor_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cbitxor"
  c_cbitxor_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_addcmul"
  c_addcmul_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_addcdiv"
  c_addcdiv_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_addmv"
  c_addmv_ :: Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_addmm"
  c_addmm_ :: Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_addr"
  c_addr_ :: Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_addbmm"
  c_addbmm_ :: Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_baddbmm"
  c_baddbmm_ :: Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_match"
  c_match_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_numel"
  c_numel_ :: Ptr CTHFloatTensor -> IO CPtrdiff
...
foreign import ccall "THTensorMath.h THFloatTensor_max"
  c_max_ :: Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_min"
  c_min_ :: Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_kthvalue"
  c_kthvalue_ :: Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CLLong -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_mode"
  c_mode_ :: Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_median"
  c_median_ :: Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_sum"
  c_sum_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_prod"
  c_prod_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cumsum"
  c_cumsum_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cumprod"
  c_cumprod_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_sign"
  c_sign_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_trace"
  c_trace_ :: Ptr CTHFloatTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THFloatTensor_cross"
  c_cross_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cmax"
  c_cmax_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cmin"
  c_cmin_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cmaxValue"
  c_cmaxValue_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cminValue"
  c_cminValue_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_zeros"
  c_zeros_ :: Ptr CTHFloatTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_zerosLike"
  c_zerosLike_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_ones"
  c_ones_ :: Ptr CTHFloatTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_onesLike"
  c_onesLike_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_diag"
  c_diag_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_eye"
  c_eye_ :: Ptr CTHFloatTensor -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_arange"
  c_arange_ :: Ptr CTHFloatTensor -> CDouble -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_range"
  c_range_ :: Ptr CTHFloatTensor -> CDouble -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_randperm"
  c_randperm_ :: Ptr CTHFloatTensor -> Ptr CTHGenerator -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_reshape"
  c_reshape_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_sort"
  c_sort_ :: Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_topk"
  c_topk_ :: Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CLLong -> CInt -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_tril"
  c_tril_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_triu"
  c_triu_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cat"
  c_cat_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_catArray"
  c_catArray_ :: Ptr CTHFloatTensor -> Ptr (Ptr CTHFloatTensor) -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_equal"
  c_equal_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO CInt
...
foreign import ccall "THTensorMath.h THFloatTensor_ltValue"
  c_ltValue_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_leValue"
  c_leValue_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_gtValue"
  c_gtValue_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_geValue"
  c_geValue_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_neValue"
  c_neValue_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_eqValue"
  c_eqValue_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_ltValueT"
  c_ltValueT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_leValueT"
  c_leValueT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_gtValueT"
  c_gtValueT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_geValueT"
  c_geValueT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_neValueT"
  c_neValueT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_eqValueT"
  c_eqValueT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_ltTensor"
  c_ltTensor_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_leTensor"
  c_leTensor_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_gtTensor"
  c_gtTensor_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_geTensor"
  c_geTensor_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_neTensor"
  c_neTensor_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_eqTensor"
  c_eqTensor_ :: Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_ltTensorT"
  c_ltTensorT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_leTensorT"
  c_leTensorT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_gtTensorT"
  c_gtTensorT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_geTensorT"
  c_geTensorT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_neTensorT"
  c_neTensorT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_eqTensorT"
  c_eqTensorT_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_abs"
  c_abs_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_sigmoid"
  c_sigmoid_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_log"
  c_log_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_lgamma"
  c_lgamma_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_digamma"
  c_digamma_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_trigamma"
  c_trigamma_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_polygamma"
  c_polygamma_ :: Ptr CTHFloatTensor -> CLLong -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_log1p"
  c_log1p_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_exp"
  c_exp_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_expm1"
  c_expm1_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cos"
  c_cos_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_acos"
  c_acos_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_cosh"
  c_cosh_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_sin"
  c_sin_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_asin"
  c_asin_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_sinh"
  c_sinh_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_tan"
  c_tan_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_atan"
  c_atan_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_atan2"
  c_atan2_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_tanh"
  c_tanh_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_erf"
  c_erf_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_erfinv"
  c_erfinv_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_pow"
  c_pow_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_tpow"
  c_tpow_ :: Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_sqrt"
  c_sqrt_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_rsqrt"
  c_rsqrt_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_ceil"
  c_ceil_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_floor"
  c_floor_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_round"
  c_round_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_trunc"
  c_trunc_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_frac"
  c_frac_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_lerp"
  c_lerp_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_mean"
  c_mean_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_std"
  c_std_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_var"
  c_var_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_norm"
  c_norm_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_renorm"
  c_renorm_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> CInt -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_dist"
  c_dist_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO CDouble
...
foreign import ccall "THTensorMath.h THFloatTensor_histc"
  c_histc_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CLLong -> CFloat -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_bhistc"
  c_bhistc_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CLLong -> CFloat -> CFloat -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_meanall"
  c_meanall_ :: Ptr CTHFloatTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THFloatTensor_varall"
  c_varall_ :: Ptr CTHFloatTensor -> CInt -> IO CDouble
...
foreign import ccall "THTensorMath.h THFloatTensor_stdall"
  c_stdall_ :: Ptr CTHFloatTensor -> CInt -> IO CDouble
...
foreign import ccall "THTensorMath.h THFloatTensor_normall"
  c_normall_ :: Ptr CTHFloatTensor -> CFloat -> IO CDouble
...
foreign import ccall "THTensorMath.h THFloatTensor_linspace"
  c_linspace_ :: Ptr CTHFloatTensor -> CFloat -> CFloat -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_logspace"
  c_logspace_ :: Ptr CTHFloatTensor -> CFloat -> CFloat -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_rand"
  c_rand_ :: Ptr CTHFloatTensor -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_randn"
  c_randn_ :: Ptr CTHFloatTensor -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THFloatTensor_dirichlet_grad"
  c_dirichlet_grad_ :: Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorMath.h &THFloatTensor_fill"
  p_fill_ :: FunPtr (Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_zero"
  p_zero_ :: FunPtr (Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_maskedFill"
  p_maskedFill_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHByteTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_maskedCopy"
  p_maskedCopy_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHByteTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_maskedSelect"
  p_maskedSelect_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_nonzero"
  p_nonzero_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_indexSelect"
  p_indexSelect_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_indexCopy"
  p_indexCopy_ :: FunPtr (Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_indexAdd"
  p_indexAdd_ :: FunPtr (Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_indexFill"
  p_indexFill_ :: FunPtr (Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_take"
  p_take_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_put"
  p_put_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_gather"
  p_gather_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_scatter"
  p_scatter_ :: FunPtr (Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_scatterAdd"
  p_scatterAdd_ :: FunPtr (Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_scatterFill"
  p_scatterFill_ :: FunPtr (Ptr CTHFloatTensor -> CInt -> Ptr CTHLongTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_dot"
  p_dot_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THFloatTensor_minall"
  p_minall_ :: FunPtr (Ptr CTHFloatTensor -> IO CFloat)
...
foreign import ccall "THTensorMath.h &THFloatTensor_maxall"
  p_maxall_ :: FunPtr (Ptr CTHFloatTensor -> IO CFloat)
...
foreign import ccall "THTensorMath.h &THFloatTensor_medianall"
  p_medianall_ :: FunPtr (Ptr CTHFloatTensor -> IO CFloat)
...
foreign import ccall "THTensorMath.h &THFloatTensor_sumall"
  p_sumall_ :: FunPtr (Ptr CTHFloatTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THFloatTensor_prodall"
  p_prodall_ :: FunPtr (Ptr CTHFloatTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THFloatTensor_neg"
  p_neg_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cinv"
  p_cinv_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_add"
  p_add_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_sub"
  p_sub_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_add_scaled"
  p_add_scaled_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_sub_scaled"
  p_sub_scaled_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_mul"
  p_mul_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_div"
  p_div_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_lshift"
  p_lshift_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_rshift"
  p_rshift_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_fmod"
  p_fmod_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_remainder"
  p_remainder_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_clamp"
  p_clamp_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_bitand"
  p_bitand_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_bitor"
  p_bitor_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_bitxor"
  p_bitxor_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cadd"
  p_cadd_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_csub"
  p_csub_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cmul"
  p_cmul_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cpow"
  p_cpow_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cdiv"
  p_cdiv_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_clshift"
  p_clshift_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_crshift"
  p_crshift_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cfmod"
  p_cfmod_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cremainder"
  p_cremainder_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cbitand"
  p_cbitand_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cbitor"
  p_cbitor_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cbitxor"
  p_cbitxor_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_addcmul"
  p_addcmul_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_addcdiv"
  p_addcdiv_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_addmv"
  p_addmv_ :: FunPtr (Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_addmm"
  p_addmm_ :: FunPtr (Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_addr"
  p_addr_ :: FunPtr (Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_addbmm"
  p_addbmm_ :: FunPtr (Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_baddbmm"
  p_baddbmm_ :: FunPtr (Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_match"
  p_match_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_numel"
  p_numel_ :: FunPtr (Ptr CTHFloatTensor -> IO CPtrdiff)
...
foreign import ccall "THTensorMath.h &THFloatTensor_max"
  p_max_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_min"
  p_min_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_kthvalue"
  p_kthvalue_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_mode"
  p_mode_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_median"
  p_median_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_sum"
  p_sum_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_prod"
  p_prod_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cumsum"
  p_cumsum_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cumprod"
  p_cumprod_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_sign"
  p_sign_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_trace"
  p_trace_ :: FunPtr (Ptr CTHFloatTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THFloatTensor_cross"
  p_cross_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cmax"
  p_cmax_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cmin"
  p_cmin_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cmaxValue"
  p_cmaxValue_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cminValue"
  p_cminValue_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_zeros"
  p_zeros_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_zerosLike"
  p_zerosLike_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_ones"
  p_ones_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_onesLike"
  p_onesLike_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_diag"
  p_diag_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_eye"
  p_eye_ :: FunPtr (Ptr CTHFloatTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_arange"
  p_arange_ :: FunPtr (Ptr CTHFloatTensor -> CDouble -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_range"
  p_range_ :: FunPtr (Ptr CTHFloatTensor -> CDouble -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_randperm"
  p_randperm_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_reshape"
  p_reshape_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_sort"
  p_sort_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_topk"
  p_topk_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHLongTensor -> Ptr CTHFloatTensor -> CLLong -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_tril"
  p_tril_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_triu"
  p_triu_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cat"
  p_cat_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_catArray"
  p_catArray_ :: FunPtr (Ptr CTHFloatTensor -> Ptr (Ptr CTHFloatTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_equal"
  p_equal_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THFloatTensor_ltValue"
  p_ltValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_leValue"
  p_leValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_gtValue"
  p_gtValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_geValue"
  p_geValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_neValue"
  p_neValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_eqValue"
  p_eqValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_ltValueT"
  p_ltValueT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_leValueT"
  p_leValueT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_gtValueT"
  p_gtValueT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_geValueT"
  p_geValueT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_neValueT"
  p_neValueT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_eqValueT"
  p_eqValueT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_ltTensor"
  p_ltTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_leTensor"
  p_leTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_gtTensor"
  p_gtTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_geTensor"
  p_geTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_neTensor"
  p_neTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_eqTensor"
  p_eqTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_ltTensorT"
  p_ltTensorT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_leTensorT"
  p_leTensorT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_gtTensorT"
  p_gtTensorT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_geTensorT"
  p_geTensorT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_neTensorT"
  p_neTensorT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_eqTensorT"
  p_eqTensorT_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_abs"
  p_abs_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_sigmoid"
  p_sigmoid_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_log"
  p_log_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_lgamma"
  p_lgamma_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_digamma"
  p_digamma_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_trigamma"
  p_trigamma_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_polygamma"
  p_polygamma_ :: FunPtr (Ptr CTHFloatTensor -> CLLong -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_log1p"
  p_log1p_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_exp"
  p_exp_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_expm1"
  p_expm1_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cos"
  p_cos_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_acos"
  p_acos_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_cosh"
  p_cosh_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_sin"
  p_sin_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_asin"
  p_asin_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_sinh"
  p_sinh_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_tan"
  p_tan_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_atan"
  p_atan_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_atan2"
  p_atan2_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_tanh"
  p_tanh_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_erf"
  p_erf_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_erfinv"
  p_erfinv_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_pow"
  p_pow_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_tpow"
  p_tpow_ :: FunPtr (Ptr CTHFloatTensor -> CFloat -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_sqrt"
  p_sqrt_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_rsqrt"
  p_rsqrt_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_ceil"
  p_ceil_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_floor"
  p_floor_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_round"
  p_round_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_trunc"
  p_trunc_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_frac"
  p_frac_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_lerp"
  p_lerp_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_mean"
  p_mean_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_std"
  p_std_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_var"
  p_var_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_norm"
  p_norm_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_renorm"
  p_renorm_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> CInt -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_dist"
  p_dist_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CFloat -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THFloatTensor_histc"
  p_histc_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CLLong -> CFloat -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_bhistc"
  p_bhistc_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> CLLong -> CFloat -> CFloat -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_meanall"
  p_meanall_ :: FunPtr (Ptr CTHFloatTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THFloatTensor_varall"
  p_varall_ :: FunPtr (Ptr CTHFloatTensor -> CInt -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THFloatTensor_stdall"
  p_stdall_ :: FunPtr (Ptr CTHFloatTensor -> CInt -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THFloatTensor_normall"
  p_normall_ :: FunPtr (Ptr CTHFloatTensor -> CFloat -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THFloatTensor_linspace"
  p_linspace_ :: FunPtr (Ptr CTHFloatTensor -> CFloat -> CFloat -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_logspace"
  p_logspace_ :: FunPtr (Ptr CTHFloatTensor -> CFloat -> CFloat -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_rand"
  p_rand_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_randn"
  p_randn_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THFloatTensor_dirichlet_grad"
  p_dirichlet_grad_ :: FunPtr (Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> Ptr CTHFloatTensor -> IO ())
