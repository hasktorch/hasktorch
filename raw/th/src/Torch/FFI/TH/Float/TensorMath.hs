...
foreign import ccall "THTensorMath.h c_THTensorFloat_addcdiv"
...
foreign import ccall "THTensorMath.h c_THTensorFloat_addmv"
...
foreign import ccall "THTensorMath.h c_THTensorFloat_addmm"
...
foreign import ccall "THTensorMath.h c_THTensorFloat_addr"
...
foreign import ccall "THTensorMath.h c_THTensorFloat_addbmm"
...
foreign import ccall "THTensorMath.h c_THTensorFloat_baddbmm"
...
foreign import ccall "THTensorMath.h c_THTensorFloat_match"
  c_match :: Ptr (CTHFloatTensor) -> Ptr (CTHFloatTensor) -> Ptr (CTHFloatTensor) -> CFloat -> IO (())

-- | c_numel :  t -> ptrdiff_t
foreign import ccall "THTensorMath.h c_THTensorFloat_numel"
  c_numel :: Ptr (CTHFloatTensor) -> IO (CPtrdiff)

-- | c_max :  values_ indices_ t dimension keepdim -> void
foreign import ccall "THTensorMath.h c_THTensorFloat_max"
...
foreign import ccall "THTensorMath.h c_THTensorFloat_min"
...
foreign import ccall "THTensorMath.h c_THTensorFloat_kthvalue"
...
foreign import ccall "THTensorMath.h c_THTensorFloat_mode"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_maskedSelect"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_nonzero"
  p_nonzero :: FunPtr (Ptr (CTHLongTensor) -> Ptr (CTHFloatTensor) -> IO (()))

-- | p_indexSelect : Pointer to function : tensor src dim index -> void
foreign import ccall "THTensorMath.h &p_THTensorFloat_indexSelect"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_indexCopy"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_indexAdd"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_put"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_gather"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_scatter"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_scatterAdd"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_addcmul"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_addcdiv"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_addmv"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_addmm"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_addr"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_addbmm"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_baddbmm"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_min"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_kthvalue"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_mode"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_median"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_sort"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_topk"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_ltTensorT"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_leTensorT"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_gtTensorT"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_geTensorT"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_neTensorT"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_mean"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_std"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_var"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_norm"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_histc"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_randn"
...
foreign import ccall "THTensorMath.h &p_THTensorFloat_dirichlet_grad"
