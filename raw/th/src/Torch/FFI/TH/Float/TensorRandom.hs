...
foreign import ccall "THTensorRandom.h c_THTensorFloat_normal_stddevs"
...
foreign import ccall "THTensorRandom.h c_THTensorFloat_normal_means_stddevs"
...
foreign import ccall "THTensorRandom.h c_THTensorFloat_multinomial"
...
foreign import ccall "THTensorRandom.h c_THTensorFloat_multinomialAliasSetup"
...
foreign import ccall "THTensorRandom.h c_THTensorFloat_multinomialAliasDraw"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_random"
  p_random :: FunPtr (Ptr (CTHFloatTensor) -> Ptr (CTHGenerator) -> IO (()))

-- | p_clampedRandom : Pointer to function : self _generator min max -> void
foreign import ccall "THTensorRandom.h &p_THTensorFloat_clampedRandom"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_cappedRandom"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_geometric"
  p_geometric :: FunPtr (Ptr (CTHFloatTensor) -> Ptr (CTHGenerator) -> CDouble -> IO (()))

-- | p_bernoulli : Pointer to function : self _generator p -> void
foreign import ccall "THTensorRandom.h &p_THTensorFloat_bernoulli"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_bernoulli_FloatTensor"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_bernoulli_DoubleTensor"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_uniform"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_normal"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_normal_means"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_normal_stddevs"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_normal_means_stddevs"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_exponential"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_standard_gamma"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_cauchy"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_logNormal"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_multinomial"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_multinomialAliasSetup"
...
foreign import ccall "THTensorRandom.h &p_THTensorFloat_multinomialAliasDraw"
