...
foreign import ccall "THTensorRandom.h c_THTensorDouble_normal_stddevs"
...
foreign import ccall "THTensorRandom.h c_THTensorDouble_normal_means_stddevs"
...
foreign import ccall "THTensorRandom.h c_THTensorDouble_multinomial"
...
foreign import ccall "THTensorRandom.h c_THTensorDouble_multinomialAliasSetup"
...
foreign import ccall "THTensorRandom.h c_THTensorDouble_multinomialAliasDraw"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_random"
  p_random :: FunPtr (Ptr (CTHDoubleTensor) -> Ptr (CTHGenerator) -> IO (()))

-- | p_clampedRandom : Pointer to function : self _generator min max -> void
foreign import ccall "THTensorRandom.h &p_THTensorDouble_clampedRandom"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_cappedRandom"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_geometric"
  p_geometric :: FunPtr (Ptr (CTHDoubleTensor) -> Ptr (CTHGenerator) -> CDouble -> IO (()))

-- | p_bernoulli : Pointer to function : self _generator p -> void
foreign import ccall "THTensorRandom.h &p_THTensorDouble_bernoulli"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_bernoulli_FloatTensor"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_bernoulli_DoubleTensor"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_uniform"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_normal"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_normal_means"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_normal_stddevs"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_normal_means_stddevs"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_exponential"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_standard_gamma"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_cauchy"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_logNormal"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_multinomial"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_multinomialAliasSetup"
...
foreign import ccall "THTensorRandom.h &p_THTensorDouble_multinomialAliasDraw"
