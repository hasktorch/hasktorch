...
foreign import ccall "THStorageCopy.h &THDoubleStorage_rawCopy"
  p_rawCopy_ :: FunPtr (Ptr C'THDoubleStorage -> Ptr CDouble -> IO ())
...
foreign import ccall "THStorageCopy.h &THDoubleStorage_copy"
  p_copy_ :: FunPtr (Ptr C'THDoubleStorage -> Ptr C'THDoubleStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THDoubleStorage_copyByte"
  p_copyByte_ :: FunPtr (Ptr C'THDoubleStorage -> Ptr C'THByteStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THDoubleStorage_copyChar"
  p_copyChar_ :: FunPtr (Ptr C'THDoubleStorage -> Ptr C'THCharStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THDoubleStorage_copyShort"
  p_copyShort_ :: FunPtr (Ptr C'THDoubleStorage -> Ptr C'THShortStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THDoubleStorage_copyInt"
  p_copyInt_ :: FunPtr (Ptr C'THDoubleStorage -> Ptr C'THIntStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THDoubleStorage_copyLong"
  p_copyLong_ :: FunPtr (Ptr C'THDoubleStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THDoubleStorage_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr C'THDoubleStorage -> Ptr C'THFloatStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THDoubleStorage_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr C'THDoubleStorage -> Ptr C'THDoubleStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THDoubleStorage_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr C'THDoubleStorage -> Ptr C'THHalfStorage -> IO ())
