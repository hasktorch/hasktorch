...
foreign import ccall "THLapack.h &THDoubleLapack_gesv"
  p_gesv_ :: FunPtr (CInt -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_trtrs"
  p_trtrs_ :: FunPtr (CChar -> CChar -> CChar -> CInt -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_gels"
  p_gels_ :: FunPtr (CChar -> CInt -> CInt -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_syev"
  p_syev_ :: FunPtr (CChar -> CChar -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_geev"
  p_geev_ :: FunPtr (CChar -> CChar -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> Ptr CDouble -> Ptr CDouble -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_gesvd"
  p_gesvd_ :: FunPtr (CChar -> CChar -> CInt -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> Ptr CDouble -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_getrf"
  p_getrf_ :: FunPtr (CInt -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_getrs"
  p_getrs_ :: FunPtr (CChar -> CInt -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_getri"
  p_getri_ :: FunPtr (CInt -> Ptr CDouble -> CInt -> Ptr CInt -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_potrf"
  p_potrf_ :: FunPtr (CChar -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_potri"
  p_potri_ :: FunPtr (CChar -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_potrs"
  p_potrs_ :: FunPtr (CChar -> CInt -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_pstrf"
  p_pstrf_ :: FunPtr (CChar -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> Ptr CInt -> CDouble -> Ptr CDouble -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_geqrf"
  p_geqrf_ :: FunPtr (CInt -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_orgqr"
  p_orgqr_ :: FunPtr (CInt -> CInt -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
...
foreign import ccall "THLapack.h &THDoubleLapack_ormqr"
  p_ormqr_ :: FunPtr (CChar -> CChar -> CInt -> CInt -> CInt -> Ptr CDouble -> CInt -> Ptr CDouble -> Ptr CDouble -> CInt -> Ptr CDouble -> CInt -> Ptr CInt -> IO ())
