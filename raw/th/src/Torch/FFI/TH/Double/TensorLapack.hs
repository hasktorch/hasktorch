...
foreign import ccall "THTensorLapack.h THDoubleTensor_gesv"
  c_gesv_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_trtrs"
  c_trtrs_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_gels"
  c_gels_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_syev"
  c_syev_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_geev"
  c_geev_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_gesvd"
  c_gesvd_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_gesvd2"
  c_gesvd2_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_getri"
  c_getri_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_potrf"
  c_potrf_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_potrs"
  c_potrs_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_potri"
  c_potri_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_qr"
  c_qr_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_geqrf"
  c_geqrf_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_orgqr"
  c_orgqr_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_ormqr"
  c_ormqr_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_pstrf"
  c_pstrf_ :: Ptr CTHDoubleTensor -> Ptr CTHIntTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> CDouble -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_btrifact"
  c_btrifact_ :: Ptr CTHDoubleTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorLapack.h THDoubleTensor_btrisolve"
  c_btrisolve_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_gesv"
  p_gesv_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_trtrs"
  p_trtrs_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_gels"
  p_gels_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_syev"
  p_syev_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_geev"
  p_geev_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_gesvd"
  p_gesvd_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_gesvd2"
  p_gesvd2_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_getri"
  p_getri_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_potrf"
  p_potrf_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_potrs"
  p_potrs_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_potri"
  p_potri_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_qr"
  p_qr_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_geqrf"
  p_geqrf_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_orgqr"
  p_orgqr_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_ormqr"
  p_ormqr_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_pstrf"
  p_pstrf_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHIntTensor -> Ptr CTHDoubleTensor -> Ptr CChar -> CDouble -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_btrifact"
  p_btrifact_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHIntTensor -> Ptr CTHIntTensor -> CInt -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorLapack.h &THDoubleTensor_btrisolve"
  p_btrisolve_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHIntTensor -> IO ())
