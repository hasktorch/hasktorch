...
foreign import ccall "THTensor.h &THDoubleTensor_storage"
  p_storage_ :: FunPtr (Ptr C'THDoubleTensor -> IO (Ptr C'THDoubleStorage))
...
foreign import ccall "THTensor.h &THDoubleTensor_storageOffset"
  p_storageOffset_ :: FunPtr (Ptr C'THDoubleTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THDoubleTensor_nDimension"
  p_nDimension_ :: FunPtr (Ptr C'THDoubleTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THDoubleTensor_size"
  p_size_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THDoubleTensor_stride"
  p_stride_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THDoubleTensor_newSizeOf"
  p_newSizeOf_ :: FunPtr (Ptr C'THDoubleTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THDoubleTensor_newStrideOf"
  p_newStrideOf_ :: FunPtr (Ptr C'THDoubleTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THDoubleTensor_data"
  p_data_ :: FunPtr (Ptr C'THDoubleTensor -> IO (Ptr CDouble))
...
foreign import ccall "THTensor.h &THDoubleTensor_setFlag"
  p_setFlag_ :: FunPtr (Ptr C'THDoubleTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr C'THDoubleTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_new"
  p_new_ :: FunPtr (IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newWithTensor"
  p_newWithTensor_ :: FunPtr (Ptr C'THDoubleTensor -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newWithStorage"
  p_newWithStorage_ :: FunPtr (Ptr C'THDoubleStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newWithStorage1d"
  p_newWithStorage1d_ :: FunPtr (Ptr C'THDoubleStorage -> CPtrdiff -> CLLong -> CLLong -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newWithStorage2d"
  p_newWithStorage2d_ :: FunPtr (Ptr C'THDoubleStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newWithStorage3d"
  p_newWithStorage3d_ :: FunPtr (Ptr C'THDoubleStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newWithStorage4d"
  p_newWithStorage4d_ :: FunPtr (Ptr C'THDoubleStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newWithSize"
  p_newWithSize_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newWithSize1d"
  p_newWithSize1d_ :: FunPtr (CLLong -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newWithSize2d"
  p_newWithSize2d_ :: FunPtr (CLLong -> CLLong -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newWithSize3d"
  p_newWithSize3d_ :: FunPtr (CLLong -> CLLong -> CLLong -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newWithSize4d"
  p_newWithSize4d_ :: FunPtr (CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newClone"
  p_newClone_ :: FunPtr (Ptr C'THDoubleTensor -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newContiguous"
  p_newContiguous_ :: FunPtr (Ptr C'THDoubleTensor -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newSelect"
  p_newSelect_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> CLLong -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newNarrow"
  p_newNarrow_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newTranspose"
  p_newTranspose_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> CInt -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newUnfold"
  p_newUnfold_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newView"
  p_newView_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongStorage -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_newExpand"
  p_newExpand_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongStorage -> IO (Ptr C'THDoubleTensor))
...
foreign import ccall "THTensor.h &THDoubleTensor_expand"
  p_expand_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_expandNd"
  p_expandNd_ :: FunPtr (Ptr (Ptr C'THDoubleTensor) -> Ptr (Ptr C'THDoubleTensor) -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_resize"
  p_resize_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_resizeAs"
  p_resizeAs_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_resizeNd"
  p_resizeNd_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_resize1d"
  p_resize1d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_resize2d"
  p_resize2d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_resize3d"
  p_resize3d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_resize4d"
  p_resize4d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_resize5d"
  p_resize5d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_set"
  p_set_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_setStorage"
  p_setStorage_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_setStorageNd"
  p_setStorageNd_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleStorage -> CPtrdiff -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_setStorage1d"
  p_setStorage1d_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleStorage -> CPtrdiff -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_setStorage2d"
  p_setStorage2d_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_setStorage3d"
  p_setStorage3d_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_setStorage4d"
  p_setStorage4d_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_narrow"
  p_narrow_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_select"
  p_select_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_transpose"
  p_transpose_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_unfold"
  p_unfold_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_squeeze"
  p_squeeze_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_squeeze1d"
  p_squeeze1d_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_unsqueeze1d"
  p_unsqueeze1d_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_isContiguous"
  p_isContiguous_ :: FunPtr (Ptr C'THDoubleTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THDoubleTensor_isSameSizeAs"
  p_isSameSizeAs_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THDoubleTensor_isSetTo"
  p_isSetTo_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THDoubleTensor_isSize"
  p_isSize_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongStorage -> IO CInt)
...
foreign import ccall "THTensor.h &THDoubleTensor_nElement"
  p_nElement_ :: FunPtr (Ptr C'THDoubleTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THDoubleTensor_retain"
  p_retain_ :: FunPtr (Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_free"
  p_free_ :: FunPtr (Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_freeCopyTo"
  p_freeCopyTo_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_set1d"
  p_set1d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CDouble -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_set2d"
  p_set2d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CLLong -> CDouble -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_set3d"
  p_set3d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CLLong -> CLLong -> CDouble -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_set4d"
  p_set4d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CDouble -> IO ())
...
foreign import ccall "THTensor.h &THDoubleTensor_get1d"
  p_get1d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> IO CDouble)
...
foreign import ccall "THTensor.h &THDoubleTensor_get2d"
  p_get2d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CLLong -> IO CDouble)
...
foreign import ccall "THTensor.h &THDoubleTensor_get3d"
  p_get3d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CLLong -> CLLong -> IO CDouble)
...
foreign import ccall "THTensor.h &THDoubleTensor_get4d"
  p_get4d_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO CDouble)
...
foreign import ccall "THTensor.h &THDoubleTensor_desc"
  p_desc_ :: FunPtr (Ptr C'THDoubleTensor -> IO (Ptr C'THDescBuff))
...
foreign import ccall "THTensor.h &THDoubleTensor_sizeDesc"
  p_sizeDesc_ :: FunPtr (Ptr C'THDoubleTensor -> IO (Ptr C'THDescBuff))
