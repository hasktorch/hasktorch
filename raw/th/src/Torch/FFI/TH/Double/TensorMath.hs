...
foreign import ccall "THTensorMath.h THDoubleTensor_fill"
  c_fill_ :: Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_zero"
  c_zero_ :: Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_maskedFill"
  c_maskedFill_ :: Ptr CTHDoubleTensor -> Ptr CTHByteTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_maskedCopy"
  c_maskedCopy_ :: Ptr CTHDoubleTensor -> Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_maskedSelect"
  c_maskedSelect_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHByteTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_nonzero"
  c_nonzero_ :: Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_indexSelect"
  c_indexSelect_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_indexCopy"
  c_indexCopy_ :: Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_indexAdd"
  c_indexAdd_ :: Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_indexFill"
  c_indexFill_ :: Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_take"
  c_take_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_put"
  c_put_ :: Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_gather"
  c_gather_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_scatter"
  c_scatter_ :: Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_scatterAdd"
  c_scatterAdd_ :: Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_scatterFill"
  c_scatterFill_ :: Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_dot"
  c_dot_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_minall"
  c_minall_ :: Ptr CTHDoubleTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_maxall"
  c_maxall_ :: Ptr CTHDoubleTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_medianall"
  c_medianall_ :: Ptr CTHDoubleTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_sumall"
  c_sumall_ :: Ptr CTHDoubleTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_prodall"
  c_prodall_ :: Ptr CTHDoubleTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_neg"
  c_neg_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cinv"
  c_cinv_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_add"
  c_add_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_sub"
  c_sub_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_add_scaled"
  c_add_scaled_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_sub_scaled"
  c_sub_scaled_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_mul"
  c_mul_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_div"
  c_div_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_lshift"
  c_lshift_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_rshift"
  c_rshift_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_fmod"
  c_fmod_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_remainder"
  c_remainder_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_clamp"
  c_clamp_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_bitand"
  c_bitand_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_bitor"
  c_bitor_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_bitxor"
  c_bitxor_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cadd"
  c_cadd_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_csub"
  c_csub_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cmul"
  c_cmul_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cpow"
  c_cpow_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cdiv"
  c_cdiv_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_clshift"
  c_clshift_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_crshift"
  c_crshift_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cfmod"
  c_cfmod_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cremainder"
  c_cremainder_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cbitand"
  c_cbitand_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cbitor"
  c_cbitor_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cbitxor"
  c_cbitxor_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_addcmul"
  c_addcmul_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_addcdiv"
  c_addcdiv_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_addmv"
  c_addmv_ :: Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_addmm"
  c_addmm_ :: Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_addr"
  c_addr_ :: Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_addbmm"
  c_addbmm_ :: Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_baddbmm"
  c_baddbmm_ :: Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_match"
  c_match_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_numel"
  c_numel_ :: Ptr CTHDoubleTensor -> IO CPtrdiff
...
foreign import ccall "THTensorMath.h THDoubleTensor_max"
  c_max_ :: Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_min"
  c_min_ :: Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_kthvalue"
  c_kthvalue_ :: Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CLLong -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_mode"
  c_mode_ :: Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_median"
  c_median_ :: Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_sum"
  c_sum_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_prod"
  c_prod_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cumsum"
  c_cumsum_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cumprod"
  c_cumprod_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_sign"
  c_sign_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_trace"
  c_trace_ :: Ptr CTHDoubleTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_cross"
  c_cross_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cmax"
  c_cmax_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cmin"
  c_cmin_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cmaxValue"
  c_cmaxValue_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cminValue"
  c_cminValue_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_zeros"
  c_zeros_ :: Ptr CTHDoubleTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_zerosLike"
  c_zerosLike_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_ones"
  c_ones_ :: Ptr CTHDoubleTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_onesLike"
  c_onesLike_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_diag"
  c_diag_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_eye"
  c_eye_ :: Ptr CTHDoubleTensor -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_arange"
  c_arange_ :: Ptr CTHDoubleTensor -> CDouble -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_range"
  c_range_ :: Ptr CTHDoubleTensor -> CDouble -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_randperm"
  c_randperm_ :: Ptr CTHDoubleTensor -> Ptr CTHGenerator -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_reshape"
  c_reshape_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_sort"
  c_sort_ :: Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_topk"
  c_topk_ :: Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CLLong -> CInt -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_tril"
  c_tril_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_triu"
  c_triu_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cat"
  c_cat_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_catArray"
  c_catArray_ :: Ptr CTHDoubleTensor -> Ptr (Ptr CTHDoubleTensor) -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_equal"
  c_equal_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO CInt
...
foreign import ccall "THTensorMath.h THDoubleTensor_ltValue"
  c_ltValue_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_leValue"
  c_leValue_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_gtValue"
  c_gtValue_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_geValue"
  c_geValue_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_neValue"
  c_neValue_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_eqValue"
  c_eqValue_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_ltValueT"
  c_ltValueT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_leValueT"
  c_leValueT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_gtValueT"
  c_gtValueT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_geValueT"
  c_geValueT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_neValueT"
  c_neValueT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_eqValueT"
  c_eqValueT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_ltTensor"
  c_ltTensor_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_leTensor"
  c_leTensor_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_gtTensor"
  c_gtTensor_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_geTensor"
  c_geTensor_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_neTensor"
  c_neTensor_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_eqTensor"
  c_eqTensor_ :: Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_ltTensorT"
  c_ltTensorT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_leTensorT"
  c_leTensorT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_gtTensorT"
  c_gtTensorT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_geTensorT"
  c_geTensorT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_neTensorT"
  c_neTensorT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_eqTensorT"
  c_eqTensorT_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_abs"
  c_abs_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_sigmoid"
  c_sigmoid_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_log"
  c_log_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_lgamma"
  c_lgamma_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_digamma"
  c_digamma_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_trigamma"
  c_trigamma_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_polygamma"
  c_polygamma_ :: Ptr CTHDoubleTensor -> CLLong -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_log1p"
  c_log1p_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_exp"
  c_exp_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_expm1"
  c_expm1_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cos"
  c_cos_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_acos"
  c_acos_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_cosh"
  c_cosh_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_sin"
  c_sin_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_asin"
  c_asin_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_sinh"
  c_sinh_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_tan"
  c_tan_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_atan"
  c_atan_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_atan2"
  c_atan2_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_tanh"
  c_tanh_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_erf"
  c_erf_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_erfinv"
  c_erfinv_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_pow"
  c_pow_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_tpow"
  c_tpow_ :: Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_sqrt"
  c_sqrt_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_rsqrt"
  c_rsqrt_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_ceil"
  c_ceil_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_floor"
  c_floor_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_round"
  c_round_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_trunc"
  c_trunc_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_frac"
  c_frac_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_lerp"
  c_lerp_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_mean"
  c_mean_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_std"
  c_std_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_var"
  c_var_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_norm"
  c_norm_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_renorm"
  c_renorm_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CInt -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_dist"
  c_dist_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_histc"
  c_histc_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CLLong -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_bhistc"
  c_bhistc_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CLLong -> CDouble -> CDouble -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_meanall"
  c_meanall_ :: Ptr CTHDoubleTensor -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_varall"
  c_varall_ :: Ptr CTHDoubleTensor -> CInt -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_stdall"
  c_stdall_ :: Ptr CTHDoubleTensor -> CInt -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_normall"
  c_normall_ :: Ptr CTHDoubleTensor -> CDouble -> IO CDouble
...
foreign import ccall "THTensorMath.h THDoubleTensor_linspace"
  c_linspace_ :: Ptr CTHDoubleTensor -> CDouble -> CDouble -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_logspace"
  c_logspace_ :: Ptr CTHDoubleTensor -> CDouble -> CDouble -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_rand"
  c_rand_ :: Ptr CTHDoubleTensor -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_randn"
  c_randn_ :: Ptr CTHDoubleTensor -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THDoubleTensor_dirichlet_grad"
  c_dirichlet_grad_ :: Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorMath.h &THDoubleTensor_fill"
  p_fill_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_zero"
  p_zero_ :: FunPtr (Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_maskedFill"
  p_maskedFill_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHByteTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_maskedCopy"
  p_maskedCopy_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_maskedSelect"
  p_maskedSelect_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_nonzero"
  p_nonzero_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_indexSelect"
  p_indexSelect_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_indexCopy"
  p_indexCopy_ :: FunPtr (Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_indexAdd"
  p_indexAdd_ :: FunPtr (Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_indexFill"
  p_indexFill_ :: FunPtr (Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_take"
  p_take_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_put"
  p_put_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_gather"
  p_gather_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_scatter"
  p_scatter_ :: FunPtr (Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_scatterAdd"
  p_scatterAdd_ :: FunPtr (Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_scatterFill"
  p_scatterFill_ :: FunPtr (Ptr CTHDoubleTensor -> CInt -> Ptr CTHLongTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_dot"
  p_dot_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_minall"
  p_minall_ :: FunPtr (Ptr CTHDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_maxall"
  p_maxall_ :: FunPtr (Ptr CTHDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_medianall"
  p_medianall_ :: FunPtr (Ptr CTHDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sumall"
  p_sumall_ :: FunPtr (Ptr CTHDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_prodall"
  p_prodall_ :: FunPtr (Ptr CTHDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_neg"
  p_neg_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cinv"
  p_cinv_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_add"
  p_add_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sub"
  p_sub_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_add_scaled"
  p_add_scaled_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sub_scaled"
  p_sub_scaled_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_mul"
  p_mul_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_div"
  p_div_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_lshift"
  p_lshift_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_rshift"
  p_rshift_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_fmod"
  p_fmod_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_remainder"
  p_remainder_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_clamp"
  p_clamp_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_bitand"
  p_bitand_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_bitor"
  p_bitor_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_bitxor"
  p_bitxor_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cadd"
  p_cadd_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_csub"
  p_csub_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cmul"
  p_cmul_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cpow"
  p_cpow_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cdiv"
  p_cdiv_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_clshift"
  p_clshift_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_crshift"
  p_crshift_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cfmod"
  p_cfmod_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cremainder"
  p_cremainder_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cbitand"
  p_cbitand_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cbitor"
  p_cbitor_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cbitxor"
  p_cbitxor_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addcmul"
  p_addcmul_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addcdiv"
  p_addcdiv_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addmv"
  p_addmv_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addmm"
  p_addmm_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addr"
  p_addr_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addbmm"
  p_addbmm_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_baddbmm"
  p_baddbmm_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_match"
  p_match_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_numel"
  p_numel_ :: FunPtr (Ptr CTHDoubleTensor -> IO CPtrdiff)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_max"
  p_max_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_min"
  p_min_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_kthvalue"
  p_kthvalue_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_mode"
  p_mode_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_median"
  p_median_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sum"
  p_sum_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_prod"
  p_prod_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cumsum"
  p_cumsum_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cumprod"
  p_cumprod_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sign"
  p_sign_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_trace"
  p_trace_ :: FunPtr (Ptr CTHDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cross"
  p_cross_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cmax"
  p_cmax_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cmin"
  p_cmin_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cmaxValue"
  p_cmaxValue_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cminValue"
  p_cminValue_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_zeros"
  p_zeros_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_zerosLike"
  p_zerosLike_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ones"
  p_ones_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_onesLike"
  p_onesLike_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_diag"
  p_diag_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_eye"
  p_eye_ :: FunPtr (Ptr CTHDoubleTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_arange"
  p_arange_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_range"
  p_range_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_randperm"
  p_randperm_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_reshape"
  p_reshape_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sort"
  p_sort_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_topk"
  p_topk_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHLongTensor -> Ptr CTHDoubleTensor -> CLLong -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_tril"
  p_tril_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_triu"
  p_triu_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cat"
  p_cat_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_catArray"
  p_catArray_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr (Ptr CTHDoubleTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_equal"
  p_equal_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ltValue"
  p_ltValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_leValue"
  p_leValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_gtValue"
  p_gtValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_geValue"
  p_geValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_neValue"
  p_neValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_eqValue"
  p_eqValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ltValueT"
  p_ltValueT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_leValueT"
  p_leValueT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_gtValueT"
  p_gtValueT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_geValueT"
  p_geValueT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_neValueT"
  p_neValueT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_eqValueT"
  p_eqValueT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ltTensor"
  p_ltTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_leTensor"
  p_leTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_gtTensor"
  p_gtTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_geTensor"
  p_geTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_neTensor"
  p_neTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_eqTensor"
  p_eqTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ltTensorT"
  p_ltTensorT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_leTensorT"
  p_leTensorT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_gtTensorT"
  p_gtTensorT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_geTensorT"
  p_geTensorT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_neTensorT"
  p_neTensorT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_eqTensorT"
  p_eqTensorT_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_abs"
  p_abs_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sigmoid"
  p_sigmoid_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_log"
  p_log_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_lgamma"
  p_lgamma_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_digamma"
  p_digamma_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_trigamma"
  p_trigamma_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_polygamma"
  p_polygamma_ :: FunPtr (Ptr CTHDoubleTensor -> CLLong -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_log1p"
  p_log1p_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_exp"
  p_exp_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_expm1"
  p_expm1_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cos"
  p_cos_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_acos"
  p_acos_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cosh"
  p_cosh_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sin"
  p_sin_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_asin"
  p_asin_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sinh"
  p_sinh_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_tan"
  p_tan_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_atan"
  p_atan_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_atan2"
  p_atan2_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_tanh"
  p_tanh_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_erf"
  p_erf_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_erfinv"
  p_erfinv_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_pow"
  p_pow_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_tpow"
  p_tpow_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sqrt"
  p_sqrt_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_rsqrt"
  p_rsqrt_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ceil"
  p_ceil_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_floor"
  p_floor_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_round"
  p_round_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_trunc"
  p_trunc_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_frac"
  p_frac_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_lerp"
  p_lerp_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_mean"
  p_mean_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_std"
  p_std_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_var"
  p_var_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_norm"
  p_norm_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_renorm"
  p_renorm_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> CInt -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_dist"
  p_dist_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CDouble -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_histc"
  p_histc_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CLLong -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_bhistc"
  p_bhistc_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> CLLong -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_meanall"
  p_meanall_ :: FunPtr (Ptr CTHDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_varall"
  p_varall_ :: FunPtr (Ptr CTHDoubleTensor -> CInt -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_stdall"
  p_stdall_ :: FunPtr (Ptr CTHDoubleTensor -> CInt -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_normall"
  p_normall_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_linspace"
  p_linspace_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> CDouble -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_logspace"
  p_logspace_ :: FunPtr (Ptr CTHDoubleTensor -> CDouble -> CDouble -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_rand"
  p_rand_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_randn"
  p_randn_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHGenerator -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_dirichlet_grad"
  p_dirichlet_grad_ :: FunPtr (Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> Ptr CTHDoubleTensor -> IO ())
