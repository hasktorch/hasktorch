...
foreign import ccall "THTensorMath.h &THDoubleTensor_fill"
  p_fill_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_zero"
  p_zero_ :: FunPtr (Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_maskedFill"
  p_maskedFill_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THByteTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_maskedCopy"
  p_maskedCopy_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_maskedSelect"
  p_maskedSelect_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_nonzero"
  p_nonzero_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_indexSelect"
  p_indexSelect_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_indexCopy"
  p_indexCopy_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_indexAdd"
  p_indexAdd_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_indexFill"
  p_indexFill_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> Ptr C'THLongTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_take"
  p_take_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_put"
  p_put_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_gather"
  p_gather_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_scatter"
  p_scatter_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_scatterAdd"
  p_scatterAdd_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_scatterFill"
  p_scatterFill_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> Ptr C'THLongTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_dot"
  p_dot_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_minall"
  p_minall_ :: FunPtr (Ptr C'THDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_maxall"
  p_maxall_ :: FunPtr (Ptr C'THDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_medianall"
  p_medianall_ :: FunPtr (Ptr C'THDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sumall"
  p_sumall_ :: FunPtr (Ptr C'THDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_prodall"
  p_prodall_ :: FunPtr (Ptr C'THDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_neg"
  p_neg_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cinv"
  p_cinv_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_add"
  p_add_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sub"
  p_sub_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_add_scaled"
  p_add_scaled_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sub_scaled"
  p_sub_scaled_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_mul"
  p_mul_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_div"
  p_div_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_lshift"
  p_lshift_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_rshift"
  p_rshift_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_fmod"
  p_fmod_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_remainder"
  p_remainder_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_clamp"
  p_clamp_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_bitand"
  p_bitand_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_bitor"
  p_bitor_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_bitxor"
  p_bitxor_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cadd"
  p_cadd_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_csub"
  p_csub_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cmul"
  p_cmul_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cpow"
  p_cpow_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cdiv"
  p_cdiv_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_clshift"
  p_clshift_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_crshift"
  p_crshift_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cfmod"
  p_cfmod_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cremainder"
  p_cremainder_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cbitand"
  p_cbitand_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cbitor"
  p_cbitor_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cbitxor"
  p_cbitxor_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addcmul"
  p_addcmul_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addcdiv"
  p_addcdiv_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addmv"
  p_addmv_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addmm"
  p_addmm_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addr"
  p_addr_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_addbmm"
  p_addbmm_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_baddbmm"
  p_baddbmm_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_match"
  p_match_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_numel"
  p_numel_ :: FunPtr (Ptr C'THDoubleTensor -> IO CPtrdiff)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_preserveReduceDimSemantics"
  p_preserveReduceDimSemantics_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_max"
  p_max_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_min"
  p_min_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_kthvalue"
  p_kthvalue_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_mode"
  p_mode_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_median"
  p_median_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sum"
  p_sum_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_prod"
  p_prod_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cumsum"
  p_cumsum_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cumprod"
  p_cumprod_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sign"
  p_sign_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_trace"
  p_trace_ :: FunPtr (Ptr C'THDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cross"
  p_cross_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cmax"
  p_cmax_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cmin"
  p_cmin_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cmaxValue"
  p_cmaxValue_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cminValue"
  p_cminValue_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_zeros"
  p_zeros_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_zerosLike"
  p_zerosLike_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ones"
  p_ones_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_onesLike"
  p_onesLike_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_diag"
  p_diag_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_eye"
  p_eye_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_arange"
  p_arange_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_range"
  p_range_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_randperm"
  p_randperm_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_reshape"
  p_reshape_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sort"
  p_sort_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_topk"
  p_topk_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongTensor -> Ptr C'THDoubleTensor -> CLLong -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_tril"
  p_tril_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_triu"
  p_triu_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cat"
  p_cat_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_catArray"
  p_catArray_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr (Ptr C'THDoubleTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_equal"
  p_equal_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ltValue"
  p_ltValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_leValue"
  p_leValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_gtValue"
  p_gtValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_geValue"
  p_geValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_neValue"
  p_neValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_eqValue"
  p_eqValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ltValueT"
  p_ltValueT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_leValueT"
  p_leValueT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_gtValueT"
  p_gtValueT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_geValueT"
  p_geValueT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_neValueT"
  p_neValueT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_eqValueT"
  p_eqValueT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ltTensor"
  p_ltTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_leTensor"
  p_leTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_gtTensor"
  p_gtTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_geTensor"
  p_geTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_neTensor"
  p_neTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_eqTensor"
  p_eqTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ltTensorT"
  p_ltTensorT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_leTensorT"
  p_leTensorT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_gtTensorT"
  p_gtTensorT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_geTensorT"
  p_geTensorT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_neTensorT"
  p_neTensorT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_eqTensorT"
  p_eqTensorT_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_pow"
  p_pow_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_tpow"
  p_tpow_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_abs"
  p_abs_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sigmoid"
  p_sigmoid_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_log"
  p_log_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_lgamma"
  p_lgamma_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_digamma"
  p_digamma_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_trigamma"
  p_trigamma_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_polygamma"
  p_polygamma_ :: FunPtr (Ptr C'THDoubleTensor -> CLLong -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_log1p"
  p_log1p_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_exp"
  p_exp_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_expm1"
  p_expm1_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cos"
  p_cos_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_acos"
  p_acos_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_cosh"
  p_cosh_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sin"
  p_sin_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_asin"
  p_asin_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sinh"
  p_sinh_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_tan"
  p_tan_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_atan"
  p_atan_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_atan2"
  p_atan2_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_tanh"
  p_tanh_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_erf"
  p_erf_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_erfinv"
  p_erfinv_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_sqrt"
  p_sqrt_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_rsqrt"
  p_rsqrt_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_ceil"
  p_ceil_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_floor"
  p_floor_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_round"
  p_round_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_trunc"
  p_trunc_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_frac"
  p_frac_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_lerp"
  p_lerp_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_mean"
  p_mean_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_std"
  p_std_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_var"
  p_var_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_norm"
  p_norm_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_renorm"
  p_renorm_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> CInt -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_dist"
  p_dist_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CDouble -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_histc"
  p_histc_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CLLong -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_bhistc"
  p_bhistc_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> CLLong -> CDouble -> CDouble -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_meanall"
  p_meanall_ :: FunPtr (Ptr C'THDoubleTensor -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_varall"
  p_varall_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_stdall"
  p_stdall_ :: FunPtr (Ptr C'THDoubleTensor -> CInt -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_normall"
  p_normall_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> IO CDouble)
...
foreign import ccall "THTensorMath.h &THDoubleTensor_linspace"
  p_linspace_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> CDouble -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_logspace"
  p_logspace_ :: FunPtr (Ptr C'THDoubleTensor -> CDouble -> CDouble -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_rand"
  p_rand_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THGenerator -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_randn"
  p_randn_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THGenerator -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THDoubleTensor_dirichlet_grad"
  p_dirichlet_grad_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
