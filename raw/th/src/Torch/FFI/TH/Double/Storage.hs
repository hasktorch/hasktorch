...
foreign import ccall "THStorage.h THDoubleStorage_data"
  c_data_ :: Ptr CTHDoubleStorage -> IO (Ptr CDouble)
...
foreign import ccall "THStorage.h THDoubleStorage_size"
  c_size_ :: Ptr CTHDoubleStorage -> IO CPtrdiff
...
foreign import ccall "THStorage.h THDoubleStorage_set"
  c_set_ :: Ptr CTHDoubleStorage -> CPtrdiff -> CDouble -> IO ()
...
foreign import ccall "THStorage.h THDoubleStorage_get"
  c_get_ :: Ptr CTHDoubleStorage -> CPtrdiff -> IO CDouble
...
foreign import ccall "THStorage.h THDoubleStorage_new"
  c_new_ :: IO (Ptr CTHDoubleStorage)
...
foreign import ccall "THStorage.h THDoubleStorage_newWithSize"
  c_newWithSize_ :: CPtrdiff -> IO (Ptr CTHDoubleStorage)
...
foreign import ccall "THStorage.h THDoubleStorage_newWithSize1"
  c_newWithSize1_ :: CDouble -> IO (Ptr CTHDoubleStorage)
...
foreign import ccall "THStorage.h THDoubleStorage_newWithSize2"
  c_newWithSize2_ :: CDouble -> CDouble -> IO (Ptr CTHDoubleStorage)
...
foreign import ccall "THStorage.h THDoubleStorage_newWithSize3"
  c_newWithSize3_ :: CDouble -> CDouble -> CDouble -> IO (Ptr CTHDoubleStorage)
...
foreign import ccall "THStorage.h THDoubleStorage_newWithSize4"
  c_newWithSize4_ :: CDouble -> CDouble -> CDouble -> CDouble -> IO (Ptr CTHDoubleStorage)
...
foreign import ccall "THStorage.h THDoubleStorage_newWithMapping"
  c_newWithMapping_ :: Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHDoubleStorage)
...
foreign import ccall "THStorage.h THDoubleStorage_newWithData"
  c_newWithData_ :: Ptr CDouble -> CPtrdiff -> IO (Ptr CTHDoubleStorage)
...
foreign import ccall "THStorage.h THDoubleStorage_newWithAllocator"
  c_newWithAllocator_ :: CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHDoubleStorage)
...
foreign import ccall "THStorage.h THDoubleStorage_newWithDataAndAllocator"
  c_newWithDataAndAllocator_ :: Ptr CDouble -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHDoubleStorage)
...
foreign import ccall "THStorage.h THDoubleStorage_setFlag"
  c_setFlag_ :: Ptr CTHDoubleStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THDoubleStorage_clearFlag"
  c_clearFlag_ :: Ptr CTHDoubleStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THDoubleStorage_retain"
  c_retain_ :: Ptr CTHDoubleStorage -> IO ()
...
foreign import ccall "THStorage.h THDoubleStorage_swap"
  c_swap_ :: Ptr CTHDoubleStorage -> Ptr CTHDoubleStorage -> IO ()
...
foreign import ccall "THStorage.h THDoubleStorage_free"
  c_free_ :: Ptr CTHDoubleStorage -> IO ()
...
foreign import ccall "THStorage.h THDoubleStorage_resize"
  c_resize_ :: Ptr CTHDoubleStorage -> CPtrdiff -> IO ()
...
foreign import ccall "THStorage.h THDoubleStorage_fill"
  c_fill_ :: Ptr CTHDoubleStorage -> CDouble -> IO ()
...
foreign import ccall "THStorage.h &THDoubleStorage_data"
  p_data_ :: FunPtr (Ptr CTHDoubleStorage -> IO (Ptr CDouble))
...
foreign import ccall "THStorage.h &THDoubleStorage_size"
  p_size_ :: FunPtr (Ptr CTHDoubleStorage -> IO CPtrdiff)
...
foreign import ccall "THStorage.h &THDoubleStorage_set"
  p_set_ :: FunPtr (Ptr CTHDoubleStorage -> CPtrdiff -> CDouble -> IO ())
...
foreign import ccall "THStorage.h &THDoubleStorage_get"
  p_get_ :: FunPtr (Ptr CTHDoubleStorage -> CPtrdiff -> IO CDouble)
...
foreign import ccall "THStorage.h &THDoubleStorage_new"
  p_new_ :: FunPtr (IO (Ptr CTHDoubleStorage))
...
foreign import ccall "THStorage.h &THDoubleStorage_newWithSize"
  p_newWithSize_ :: FunPtr (CPtrdiff -> IO (Ptr CTHDoubleStorage))
...
foreign import ccall "THStorage.h &THDoubleStorage_newWithSize1"
  p_newWithSize1_ :: FunPtr (CDouble -> IO (Ptr CTHDoubleStorage))
...
foreign import ccall "THStorage.h &THDoubleStorage_newWithSize2"
  p_newWithSize2_ :: FunPtr (CDouble -> CDouble -> IO (Ptr CTHDoubleStorage))
...
foreign import ccall "THStorage.h &THDoubleStorage_newWithSize3"
  p_newWithSize3_ :: FunPtr (CDouble -> CDouble -> CDouble -> IO (Ptr CTHDoubleStorage))
...
foreign import ccall "THStorage.h &THDoubleStorage_newWithSize4"
  p_newWithSize4_ :: FunPtr (CDouble -> CDouble -> CDouble -> CDouble -> IO (Ptr CTHDoubleStorage))
...
foreign import ccall "THStorage.h &THDoubleStorage_newWithMapping"
  p_newWithMapping_ :: FunPtr (Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHDoubleStorage))
...
foreign import ccall "THStorage.h &THDoubleStorage_newWithData"
  p_newWithData_ :: FunPtr (Ptr CDouble -> CPtrdiff -> IO (Ptr CTHDoubleStorage))
...
foreign import ccall "THStorage.h &THDoubleStorage_newWithAllocator"
  p_newWithAllocator_ :: FunPtr (CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHDoubleStorage))
...
foreign import ccall "THStorage.h &THDoubleStorage_newWithDataAndAllocator"
  p_newWithDataAndAllocator_ :: FunPtr (Ptr CDouble -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHDoubleStorage))
...
foreign import ccall "THStorage.h &THDoubleStorage_setFlag"
  p_setFlag_ :: FunPtr (Ptr CTHDoubleStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THDoubleStorage_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr CTHDoubleStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THDoubleStorage_retain"
  p_retain_ :: FunPtr (Ptr CTHDoubleStorage -> IO ())
...
foreign import ccall "THStorage.h &THDoubleStorage_swap"
  p_swap_ :: FunPtr (Ptr CTHDoubleStorage -> Ptr CTHDoubleStorage -> IO ())
...
foreign import ccall "THStorage.h &THDoubleStorage_free"
  p_free_ :: FunPtr (Ptr CTHDoubleStorage -> IO ())
...
foreign import ccall "THStorage.h &THDoubleStorage_resize"
  p_resize_ :: FunPtr (Ptr CTHDoubleStorage -> CPtrdiff -> IO ())
...
foreign import ccall "THStorage.h &THDoubleStorage_fill"
  p_fill_ :: FunPtr (Ptr CTHDoubleStorage -> CDouble -> IO ())
