...
foreign import ccall "THTensorCopy.h &THDoubleTensor_copy"
  p_copy_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THDoubleTensor_copyByte"
  p_copyByte_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THDoubleTensor_copyChar"
  p_copyChar_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THDoubleTensor_copyShort"
  p_copyShort_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THDoubleTensor_copyInt"
  p_copyInt_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THDoubleTensor_copyLong"
  p_copyLong_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THDoubleTensor_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THDoubleTensor_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THDoubleTensor_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr C'THDoubleTensor -> Ptr C'THHalfTensor -> IO ())
