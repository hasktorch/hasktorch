...
foreign import ccall "THBlas.h &THHalfBlas_swap"
  p_swap_ :: FunPtr (CLLong -> Ptr CTHHalf -> CLLong -> Ptr CTHHalf -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THHalfBlas_scal"
  p_scal_ :: FunPtr (CLLong -> CTHHalf -> Ptr CTHHalf -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THHalfBlas_copy"
  p_copy_ :: FunPtr (CLLong -> Ptr CTHHalf -> CLLong -> Ptr CTHHalf -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THHalfBlas_axpy"
  p_axpy_ :: FunPtr (CLLong -> CTHHalf -> Ptr CTHHalf -> CLLong -> Ptr CTHHalf -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THHalfBlas_dot"
  p_dot_ :: FunPtr (CLLong -> Ptr CTHHalf -> CLLong -> Ptr CTHHalf -> CLLong -> IO CTHHalf)
...
foreign import ccall "THBlas.h &THHalfBlas_gemv"
  p_gemv_ :: FunPtr (CChar -> CLLong -> CLLong -> CTHHalf -> Ptr CTHHalf -> CLLong -> Ptr CTHHalf -> CLLong -> CTHHalf -> Ptr CTHHalf -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THHalfBlas_ger"
  p_ger_ :: FunPtr (CLLong -> CLLong -> CTHHalf -> Ptr CTHHalf -> CLLong -> Ptr CTHHalf -> CLLong -> Ptr CTHHalf -> CLLong -> IO ())
...
foreign import ccall "THBlas.h &THHalfBlas_gemm"
  p_gemm_ :: FunPtr (CChar -> CChar -> CLLong -> CLLong -> CLLong -> CTHHalf -> Ptr CTHHalf -> CLLong -> Ptr CTHHalf -> CLLong -> CTHHalf -> Ptr CTHHalf -> CLLong -> IO ())
