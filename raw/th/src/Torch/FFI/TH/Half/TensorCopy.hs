...
foreign import ccall "THTensorCopy.h &THHalfTensor_copy"
  p_copy_ :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THHalfTensor_copyByte"
  p_copyByte_ :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THHalfTensor_copyChar"
  p_copyChar_ :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THHalfTensor_copyShort"
  p_copyShort_ :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THHalfTensor_copyInt"
  p_copyInt_ :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THHalfTensor_copyLong"
  p_copyLong_ :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THHalfTensor_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THHalfTensor_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THHalfTensor_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO ())
