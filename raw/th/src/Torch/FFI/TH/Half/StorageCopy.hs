...
foreign import ccall "THStorageCopy.h &THHalfStorage_rawCopy"
  p_rawCopy_ :: FunPtr (Ptr C'THHalfStorage -> Ptr CTHHalf -> IO ())
...
foreign import ccall "THStorageCopy.h &THHalfStorage_copy"
  p_copy_ :: FunPtr (Ptr C'THHalfStorage -> Ptr C'THHalfStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THHalfStorage_copyByte"
  p_copyByte_ :: FunPtr (Ptr C'THHalfStorage -> Ptr C'THByteStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THHalfStorage_copyChar"
  p_copyChar_ :: FunPtr (Ptr C'THHalfStorage -> Ptr C'THCharStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THHalfStorage_copyShort"
  p_copyShort_ :: FunPtr (Ptr C'THHalfStorage -> Ptr C'THShortStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THHalfStorage_copyInt"
  p_copyInt_ :: FunPtr (Ptr C'THHalfStorage -> Ptr C'THIntStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THHalfStorage_copyLong"
  p_copyLong_ :: FunPtr (Ptr C'THHalfStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THHalfStorage_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr C'THHalfStorage -> Ptr C'THFloatStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THHalfStorage_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr C'THHalfStorage -> Ptr C'THDoubleStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THHalfStorage_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr C'THHalfStorage -> Ptr C'THHalfStorage -> IO ())
