...
module Torch.FFI.TH.Half.Tensor where
...
foreign import ccall "THTensor.h THHalfTensor_newWithStorage"
  c_newWithStorage_ :: Ptr C'THHalfStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THHalfTensor)

-- | alias of c_newWithStorage_ with unused argument (for CTHState) to unify backpack signatures.
c_newWithStorage :: Ptr C'THState -> Ptr C'THHalfStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newWithStorage1d"
  c_newWithStorage1d_ :: Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)

-- | alias of c_newWithStorage1d_ with unused argument (for CTHState) to unify backpack signatures.
c_newWithStorage1d :: Ptr C'THState -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newWithStorage2d"
  c_newWithStorage2d_ :: Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)

-- | alias of c_newWithStorage2d_ with unused argument (for CTHState) to unify backpack signatures.
c_newWithStorage2d :: Ptr C'THState -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newWithStorage3d"
  c_newWithStorage3d_ :: Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)

-- | alias of c_newWithStorage3d_ with unused argument (for CTHState) to unify backpack signatures.
c_newWithStorage3d :: Ptr C'THState -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newWithStorage4d"
  c_newWithStorage4d_ :: Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)

-- | alias of c_newWithStorage4d_ with unused argument (for CTHState) to unify backpack signatures.
c_newWithStorage4d :: Ptr C'THState -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newWithSize"
  c_newWithSize_ :: Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THHalfTensor)

-- | alias of c_newWithSize_ with unused argument (for CTHState) to unify backpack signatures.
c_newWithSize :: Ptr C'THState -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newWithSize1d"
  c_newWithSize1d_ :: CLLong -> IO (Ptr C'THHalfTensor)

-- | alias of c_newWithSize1d_ with unused argument (for CTHState) to unify backpack signatures.
c_newWithSize1d :: Ptr C'THState -> CLLong -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newWithSize2d"
  c_newWithSize2d_ :: CLLong -> CLLong -> IO (Ptr C'THHalfTensor)

-- | alias of c_newWithSize2d_ with unused argument (for CTHState) to unify backpack signatures.
c_newWithSize2d :: Ptr C'THState -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newWithSize3d"
  c_newWithSize3d_ :: CLLong -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)

-- | alias of c_newWithSize3d_ with unused argument (for CTHState) to unify backpack signatures.
c_newWithSize3d :: Ptr C'THState -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newSelect"
  c_newSelect_ :: Ptr C'THHalfTensor -> CInt -> CLLong -> IO (Ptr C'THHalfTensor)

-- | alias of c_newSelect_ with unused argument (for CTHState) to unify backpack signatures.
c_newSelect :: Ptr C'THState -> Ptr C'THHalfTensor -> CInt -> CLLong -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newNarrow"
  c_newNarrow_ :: Ptr C'THHalfTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)

-- | alias of c_newNarrow_ with unused argument (for CTHState) to unify backpack signatures.
c_newNarrow :: Ptr C'THState -> Ptr C'THHalfTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newTranspose"
  c_newTranspose_ :: Ptr C'THHalfTensor -> CInt -> CInt -> IO (Ptr C'THHalfTensor)

-- | alias of c_newTranspose_ with unused argument (for CTHState) to unify backpack signatures.
c_newTranspose :: Ptr C'THState -> Ptr C'THHalfTensor -> CInt -> CInt -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_newUnfold"
  c_newUnfold_ :: Ptr C'THHalfTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)

-- | alias of c_newUnfold_ with unused argument (for CTHState) to unify backpack signatures.
c_newUnfold :: Ptr C'THState -> Ptr C'THHalfTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor)
c_newUnfold = const c_newUnfold_

-- | c_newView :  tensor size -> THTensor *
foreign import ccall "THTensor.h THHalfTensor_newView"
  c_newView_ :: Ptr C'THHalfTensor -> Ptr C'THLongStorage -> IO (Ptr C'THHalfTensor)

-- | alias of c_newView_ with unused argument (for CTHState) to unify backpack signatures.
c_newView :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THLongStorage -> IO (Ptr C'THHalfTensor)
...
foreign import ccall "THTensor.h THHalfTensor_resize"
  c_resize_ :: Ptr C'THHalfTensor -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ()

-- | alias of c_resize_ with unused argument (for CTHState) to unify backpack signatures.
c_resize :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ()
c_resize = const c_resize_

-- | c_resizeAs :  tensor src -> void
foreign import ccall "THTensor.h THHalfTensor_resizeAs"
  c_resizeAs_ :: Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO ()

-- | alias of c_resizeAs_ with unused argument (for CTHState) to unify backpack signatures.
c_resizeAs :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO ()
...
foreign import ccall "THTensor.h THHalfTensor_resize3d"
  c_resize3d_ :: Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_resize3d_ with unused argument (for CTHState) to unify backpack signatures.
c_resize3d :: Ptr C'THState -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensor.h THHalfTensor_resize4d"
  c_resize4d_ :: Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_resize4d_ with unused argument (for CTHState) to unify backpack signatures.
c_resize4d :: Ptr C'THState -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensor.h THHalfTensor_resize5d"
  c_resize5d_ :: Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_resize5d_ with unused argument (for CTHState) to unify backpack signatures.
c_resize5d :: Ptr C'THState -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
c_resize5d = const c_resize5d_

-- | c_set :  self src -> void
foreign import ccall "THTensor.h THHalfTensor_set"
  c_set_ :: Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO ()

-- | alias of c_set_ with unused argument (for CTHState) to unify backpack signatures.
c_set :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO ()
c_set = const c_set_

-- | c_setStorage :  self storage_ storageOffset_ size_ stride_ -> void
foreign import ccall "THTensor.h THHalfTensor_setStorage"
  c_setStorage_ :: Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ()

-- | alias of c_setStorage_ with unused argument (for CTHState) to unify backpack signatures.
c_setStorage :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ()
...
foreign import ccall "THTensor.h THHalfTensor_setStorageNd"
  c_setStorageNd_ :: Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ()

-- | alias of c_setStorageNd_ with unused argument (for CTHState) to unify backpack signatures.
c_setStorageNd :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ()
...
foreign import ccall "THTensor.h THHalfTensor_setStorage1d"
  c_setStorage1d_ :: Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> IO ()

-- | alias of c_setStorage1d_ with unused argument (for CTHState) to unify backpack signatures.
c_setStorage1d :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensor.h THHalfTensor_setStorage2d"
  c_setStorage2d_ :: Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_setStorage2d_ with unused argument (for CTHState) to unify backpack signatures.
c_setStorage2d :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensor.h THHalfTensor_setStorage3d"
  c_setStorage3d_ :: Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_setStorage3d_ with unused argument (for CTHState) to unify backpack signatures.
c_setStorage3d :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensor.h THHalfTensor_setStorage4d"
  c_setStorage4d_ :: Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_setStorage4d_ with unused argument (for CTHState) to unify backpack signatures.
c_setStorage4d :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensor.h THHalfTensor_narrow"
  c_narrow_ :: Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> CLLong -> CLLong -> IO ()

-- | alias of c_narrow_ with unused argument (for CTHState) to unify backpack signatures.
c_narrow :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> CLLong -> CLLong -> IO ()
c_narrow = const c_narrow_

-- | c_select :  self src dimension_ sliceIndex_ -> void
foreign import ccall "THTensor.h THHalfTensor_select"
  c_select_ :: Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> CLLong -> IO ()

-- | alias of c_select_ with unused argument (for CTHState) to unify backpack signatures.
c_select :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> CLLong -> IO ()
...
foreign import ccall "THTensor.h THHalfTensor_transpose"
  c_transpose_ :: Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> CInt -> IO ()

-- | alias of c_transpose_ with unused argument (for CTHState) to unify backpack signatures.
c_transpose :: Ptr C'THState -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensor.h &THHalfTensor_newWithStorage4d"
  p_newWithStorage4d :: FunPtr (Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor))

-- | p_newWithSize : Pointer to function : size_ stride_ -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newWithSize"
  p_newWithSize :: FunPtr (Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THHalfTensor))

-- | p_newWithSize1d : Pointer to function : size0_ -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newWithSize1d"
  p_newWithSize1d :: FunPtr (CLLong -> IO (Ptr C'THHalfTensor))

-- | p_newWithSize2d : Pointer to function : size0_ size1_ -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newWithSize2d"
  p_newWithSize2d :: FunPtr (CLLong -> CLLong -> IO (Ptr C'THHalfTensor))

-- | p_newWithSize3d : Pointer to function : size0_ size1_ size2_ -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newWithSize3d"
  p_newWithSize3d :: FunPtr (CLLong -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor))

-- | p_newWithSize4d : Pointer to function : size0_ size1_ size2_ size3_ -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newWithSize4d"
  p_newWithSize4d :: FunPtr (CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor))

-- | p_newClone : Pointer to function : self -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newClone"
  p_newClone :: FunPtr (Ptr C'THHalfTensor -> IO (Ptr C'THHalfTensor))

-- | p_newContiguous : Pointer to function : tensor -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newContiguous"
  p_newContiguous :: FunPtr (Ptr C'THHalfTensor -> IO (Ptr C'THHalfTensor))

-- | p_newSelect : Pointer to function : tensor dimension_ sliceIndex_ -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newSelect"
  p_newSelect :: FunPtr (Ptr C'THHalfTensor -> CInt -> CLLong -> IO (Ptr C'THHalfTensor))

-- | p_newNarrow : Pointer to function : tensor dimension_ firstIndex_ size_ -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newNarrow"
  p_newNarrow :: FunPtr (Ptr C'THHalfTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor))

-- | p_newTranspose : Pointer to function : tensor dimension1_ dimension2_ -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newTranspose"
  p_newTranspose :: FunPtr (Ptr C'THHalfTensor -> CInt -> CInt -> IO (Ptr C'THHalfTensor))

-- | p_newUnfold : Pointer to function : tensor dimension_ size_ step_ -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newUnfold"
  p_newUnfold :: FunPtr (Ptr C'THHalfTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THHalfTensor))

-- | p_newView : Pointer to function : tensor size -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newView"
  p_newView :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THLongStorage -> IO (Ptr C'THHalfTensor))

-- | p_newExpand : Pointer to function : tensor size -> THTensor *
foreign import ccall "THTensor.h &THHalfTensor_newExpand"
  p_newExpand :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THLongStorage -> IO (Ptr C'THHalfTensor))

-- | p_expand : Pointer to function : r tensor size -> void
foreign import ccall "THTensor.h &THHalfTensor_expand"
  p_expand :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> Ptr C'THLongStorage -> IO ())

-- | p_expandNd : Pointer to function : rets ops count -> void
foreign import ccall "THTensor.h &THHalfTensor_expandNd"
  p_expandNd :: FunPtr (Ptr (Ptr C'THHalfTensor) -> Ptr (Ptr C'THHalfTensor) -> CInt -> IO ())

-- | p_resize : Pointer to function : tensor size stride -> void
foreign import ccall "THTensor.h &THHalfTensor_resize"
  p_resize :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())

-- | p_resizeAs : Pointer to function : tensor src -> void
foreign import ccall "THTensor.h &THHalfTensor_resizeAs"
  p_resizeAs :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO ())

-- | p_resizeNd : Pointer to function : tensor nDimension size stride -> void
foreign import ccall "THTensor.h &THHalfTensor_resizeNd"
  p_resizeNd :: FunPtr (Ptr C'THHalfTensor -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())

-- | p_resize1d : Pointer to function : tensor size0_ -> void
foreign import ccall "THTensor.h &THHalfTensor_resize1d"
  p_resize1d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> IO ())

-- | p_resize2d : Pointer to function : tensor size0_ size1_ -> void
foreign import ccall "THTensor.h &THHalfTensor_resize2d"
  p_resize2d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> CLLong -> IO ())

-- | p_resize3d : Pointer to function : tensor size0_ size1_ size2_ -> void
foreign import ccall "THTensor.h &THHalfTensor_resize3d"
  p_resize3d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> IO ())

-- | p_resize4d : Pointer to function : tensor size0_ size1_ size2_ size3_ -> void
foreign import ccall "THTensor.h &THHalfTensor_resize4d"
  p_resize4d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())

-- | p_resize5d : Pointer to function : tensor size0_ size1_ size2_ size3_ size4_ -> void
foreign import ccall "THTensor.h &THHalfTensor_resize5d"
  p_resize5d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())

-- | p_set : Pointer to function : self src -> void
foreign import ccall "THTensor.h &THHalfTensor_set"
  p_set :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO ())

-- | p_setStorage : Pointer to function : self storage_ storageOffset_ size_ stride_ -> void
foreign import ccall "THTensor.h &THHalfTensor_setStorage"
  p_setStorage :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())

-- | p_setStorageNd : Pointer to function : self storage_ storageOffset_ nDimension size stride -> void
foreign import ccall "THTensor.h &THHalfTensor_setStorageNd"
  p_setStorageNd :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())

-- | p_setStorage1d : Pointer to function : self storage_ storageOffset_ size0_ stride0_ -> void
foreign import ccall "THTensor.h &THHalfTensor_setStorage1d"
  p_setStorage1d :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> IO ())

-- | p_setStorage2d : Pointer to function : self storage_ storageOffset_ size0_ stride0_ size1_ stride1_ -> void
foreign import ccall "THTensor.h &THHalfTensor_setStorage2d"
  p_setStorage2d :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())

-- | p_setStorage3d : Pointer to function : self storage_ storageOffset_ size0_ stride0_ size1_ stride1_ size2_ stride2_ -> void
foreign import ccall "THTensor.h &THHalfTensor_setStorage3d"
  p_setStorage3d :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THHalfTensor_setStorage4d"
  p_setStorage4d :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())

-- | p_narrow : Pointer to function : self src dimension_ firstIndex_ size_ -> void
foreign import ccall "THTensor.h &THHalfTensor_narrow"
  p_narrow :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> CLLong -> CLLong -> IO ())

-- | p_select : Pointer to function : self src dimension_ sliceIndex_ -> void
foreign import ccall "THTensor.h &THHalfTensor_select"
  p_select :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> CLLong -> IO ())

-- | p_transpose : Pointer to function : self src dimension1_ dimension2_ -> void
foreign import ccall "THTensor.h &THHalfTensor_transpose"
  p_transpose :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> CInt -> IO ())

-- | p_unfold : Pointer to function : self src dimension_ size_ step_ -> void
foreign import ccall "THTensor.h &THHalfTensor_unfold"
  p_unfold :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> CLLong -> CLLong -> IO ())

-- | p_squeeze : Pointer to function : self src -> void
foreign import ccall "THTensor.h &THHalfTensor_squeeze"
  p_squeeze :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO ())

-- | p_squeeze1d : Pointer to function : self src dimension_ -> void
foreign import ccall "THTensor.h &THHalfTensor_squeeze1d"
  p_squeeze1d :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> IO ())

-- | p_unsqueeze1d : Pointer to function : self src dimension_ -> void
foreign import ccall "THTensor.h &THHalfTensor_unsqueeze1d"
  p_unsqueeze1d :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CInt -> IO ())

-- | p_isContiguous : Pointer to function : self -> int
foreign import ccall "THTensor.h &THHalfTensor_isContiguous"
  p_isContiguous :: FunPtr (Ptr C'THHalfTensor -> IO CInt)

-- | p_isSameSizeAs : Pointer to function : self src -> int
foreign import ccall "THTensor.h &THHalfTensor_isSameSizeAs"
  p_isSameSizeAs :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO CInt)

-- | p_isSetTo : Pointer to function : self src -> int
foreign import ccall "THTensor.h &THHalfTensor_isSetTo"
  p_isSetTo :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO CInt)

-- | p_isSize : Pointer to function : self dims -> int
foreign import ccall "THTensor.h &THHalfTensor_isSize"
  p_isSize :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THLongStorage -> IO CInt)

-- | p_nElement : Pointer to function : self -> ptrdiff_t
foreign import ccall "THTensor.h &THHalfTensor_nElement"
  p_nElement :: FunPtr (Ptr C'THHalfTensor -> IO CPtrdiff)

-- | p_retain : Pointer to function : self -> void
foreign import ccall "THTensor.h &THHalfTensor_retain"
  p_retain :: FunPtr (Ptr C'THHalfTensor -> IO ())

-- | p_free : Pointer to function : self -> void
foreign import ccall "THTensor.h &THHalfTensor_free"
  p_free :: FunPtr (Ptr C'THHalfTensor -> IO ())

-- | p_freeCopyTo : Pointer to function : self dst -> void
foreign import ccall "THTensor.h &THHalfTensor_freeCopyTo"
  p_freeCopyTo :: FunPtr (Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> IO ())

-- | p_set1d : Pointer to function : tensor x0 value -> void
foreign import ccall "THTensor.h &THHalfTensor_set1d"
  p_set1d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> CTHHalf -> IO ())

-- | p_set2d : Pointer to function : tensor x0 x1 value -> void
foreign import ccall "THTensor.h &THHalfTensor_set2d"
  p_set2d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> CLLong -> CTHHalf -> IO ())

-- | p_set3d : Pointer to function : tensor x0 x1 x2 value -> void
foreign import ccall "THTensor.h &THHalfTensor_set3d"
  p_set3d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> CTHHalf -> IO ())

-- | p_set4d : Pointer to function : tensor x0 x1 x2 x3 value -> void
foreign import ccall "THTensor.h &THHalfTensor_set4d"
  p_set4d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CTHHalf -> IO ())

-- | p_get1d : Pointer to function : tensor x0 -> real
foreign import ccall "THTensor.h &THHalfTensor_get1d"
  p_get1d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> IO CTHHalf)

-- | p_get2d : Pointer to function : tensor x0 x1 -> real
foreign import ccall "THTensor.h &THHalfTensor_get2d"
  p_get2d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> CLLong -> IO CTHHalf)

-- | p_get3d : Pointer to function : tensor x0 x1 x2 -> real
foreign import ccall "THTensor.h &THHalfTensor_get3d"
  p_get3d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> IO CTHHalf)

-- | p_get4d : Pointer to function : tensor x0 x1 x2 x3 -> real
foreign import ccall "THTensor.h &THHalfTensor_get4d"
  p_get4d :: FunPtr (Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO CTHHalf)

-- | p_desc : Pointer to function : tensor -> THDescBuff
foreign import ccall "THTensor.h &THHalfTensor_desc"
  p_desc :: FunPtr (Ptr C'THHalfTensor -> IO (Ptr C'THDescBuff))

-- | p_sizeDesc : Pointer to function : tensor -> THDescBuff
foreign import ccall "THTensor.h &THHalfTensor_sizeDesc"
  p_sizeDesc :: FunPtr (Ptr C'THHalfTensor -> IO (Ptr C'THDescBuff))