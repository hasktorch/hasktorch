...
foreign import ccall "THTensorConv.h THHalfTensor_validXCorr2Dptr"
  c_validXCorr2Dptr_ :: Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_validXCorr2Dptr_ with unused argument (for CTHState) to unify backpack signatures.
c_validXCorr2Dptr :: Ptr C'THState -> Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_validConv2Dptr"
  c_validConv2Dptr_ :: Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_validConv2Dptr_ with unused argument (for CTHState) to unify backpack signatures.
c_validConv2Dptr :: Ptr C'THState -> Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_fullXCorr2Dptr"
  c_fullXCorr2Dptr_ :: Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_fullXCorr2Dptr_ with unused argument (for CTHState) to unify backpack signatures.
c_fullXCorr2Dptr :: Ptr C'THState -> Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_fullConv2Dptr"
  c_fullConv2Dptr_ :: Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_fullConv2Dptr_ with unused argument (for CTHState) to unify backpack signatures.
c_fullConv2Dptr :: Ptr C'THState -> Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_validXCorr2DRevptr"
  c_validXCorr2DRevptr_ :: Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_validXCorr2DRevptr_ with unused argument (for CTHState) to unify backpack signatures.
c_validXCorr2DRevptr :: Ptr C'THState -> Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv2DRevger"
  c_conv2DRevger_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> IO ()

-- | alias of c_conv2DRevger_ with unused argument (for CTHState) to unify backpack signatures.
c_conv2DRevger :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv2DRevgerm"
  c_conv2DRevgerm_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> IO ()

-- | alias of c_conv2DRevgerm_ with unused argument (for CTHState) to unify backpack signatures.
c_conv2DRevgerm :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv2Dger"
  c_conv2Dger_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | alias of c_conv2Dger_ with unused argument (for CTHState) to unify backpack signatures.
c_conv2Dger :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv2Dmv"
  c_conv2Dmv_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | alias of c_conv2Dmv_ with unused argument (for CTHState) to unify backpack signatures.
c_conv2Dmv :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv2Dmm"
  c_conv2Dmm_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | alias of c_conv2Dmm_ with unused argument (for CTHState) to unify backpack signatures.
c_conv2Dmm :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv2Dmul"
  c_conv2Dmul_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | alias of c_conv2Dmul_ with unused argument (for CTHState) to unify backpack signatures.
c_conv2Dmul :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv2Dcmul"
  c_conv2Dcmul_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | alias of c_conv2Dcmul_ with unused argument (for CTHState) to unify backpack signatures.
c_conv2Dcmul :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_validXCorr3Dptr"
  c_validXCorr3Dptr_ :: Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_validXCorr3Dptr_ with unused argument (for CTHState) to unify backpack signatures.
c_validXCorr3Dptr :: Ptr C'THState -> Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_validConv3Dptr"
  c_validConv3Dptr_ :: Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_validConv3Dptr_ with unused argument (for CTHState) to unify backpack signatures.
c_validConv3Dptr :: Ptr C'THState -> Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_fullXCorr3Dptr"
  c_fullXCorr3Dptr_ :: Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_fullXCorr3Dptr_ with unused argument (for CTHState) to unify backpack signatures.
c_fullXCorr3Dptr :: Ptr C'THState -> Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_fullConv3Dptr"
  c_fullConv3Dptr_ :: Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_fullConv3Dptr_ with unused argument (for CTHState) to unify backpack signatures.
c_fullConv3Dptr :: Ptr C'THState -> Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_validXCorr3DRevptr"
  c_validXCorr3DRevptr_ :: Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_validXCorr3DRevptr_ with unused argument (for CTHState) to unify backpack signatures.
c_validXCorr3DRevptr :: Ptr C'THState -> Ptr CTHHalf -> CTHHalf -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> Ptr CTHHalf -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv3DRevger"
  c_conv3DRevger_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> IO ()

-- | alias of c_conv3DRevger_ with unused argument (for CTHState) to unify backpack signatures.
c_conv3DRevger :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv3Dger"
  c_conv3Dger_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | alias of c_conv3Dger_ with unused argument (for CTHState) to unify backpack signatures.
c_conv3Dger :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv3Dmv"
  c_conv3Dmv_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | alias of c_conv3Dmv_ with unused argument (for CTHState) to unify backpack signatures.
c_conv3Dmv :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv3Dmul"
  c_conv3Dmul_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | alias of c_conv3Dmul_ with unused argument (for CTHState) to unify backpack signatures.
c_conv3Dmul :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THHalfTensor_conv3Dcmul"
  c_conv3Dcmul_ :: Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()

-- | alias of c_conv3Dcmul_ with unused argument (for CTHState) to unify backpack signatures.
c_conv3Dcmul :: Ptr C'THState -> Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h &THHalfTensor_conv2DRevger"
  p_conv2DRevger :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> IO ())

-- | p_conv2DRevgerm : Pointer to function : r_ beta alpha t_ k_ srow scol -> void
foreign import ccall "THTensorConv.h &THHalfTensor_conv2DRevgerm"
  p_conv2DRevgerm :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> IO ())

-- | p_conv2Dger : Pointer to function : r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THHalfTensor_conv2Dger"
  p_conv2Dger :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv2Dmv : Pointer to function : r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THHalfTensor_conv2Dmv"
  p_conv2Dmv :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv2Dmm : Pointer to function : r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THHalfTensor_conv2Dmm"
  p_conv2Dmm :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv2Dmul : Pointer to function : r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THHalfTensor_conv2Dmul"
  p_conv2Dmul :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv2Dcmul : Pointer to function : r_ beta alpha t_ k_ srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THHalfTensor_conv2Dcmul"
  p_conv2Dcmul :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THHalfTensor_conv3DRevger"
  p_conv3DRevger :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> IO ())

-- | p_conv3Dger : Pointer to function : r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THHalfTensor_conv3Dger"
  p_conv3Dger :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv3Dmv : Pointer to function : r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THHalfTensor_conv3Dmv"
  p_conv3Dmv :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv3Dmul : Pointer to function : r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THHalfTensor_conv3Dmul"
  p_conv3Dmul :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())

-- | p_conv3Dcmul : Pointer to function : r_ beta alpha t_ k_ sdepth srow scol vf xc -> void
foreign import ccall "THTensorConv.h &THHalfTensor_conv3Dcmul"
  p_conv3Dcmul :: FunPtr (Ptr C'THHalfTensor -> CTHHalf -> CTHHalf -> Ptr C'THHalfTensor -> Ptr C'THHalfTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())