...
foreign import ccall "THStorage.h THHalfStorage_data"
  c_data_ :: Ptr CTHHalfStorage -> IO (Ptr CTHHalf)
...
foreign import ccall "THStorage.h THHalfStorage_size"
  c_size_ :: Ptr CTHHalfStorage -> IO CPtrdiff
...
foreign import ccall "THStorage.h THHalfStorage_set"
  c_set_ :: Ptr CTHHalfStorage -> CPtrdiff -> CTHHalf -> IO ()
...
foreign import ccall "THStorage.h THHalfStorage_get"
  c_get_ :: Ptr CTHHalfStorage -> CPtrdiff -> IO CTHHalf
...
foreign import ccall "THStorage.h THHalfStorage_newWithSize"
  c_newWithSize_ :: CPtrdiff -> IO (Ptr CTHHalfStorage)
...
foreign import ccall "THStorage.h THHalfStorage_newWithSize1"
  c_newWithSize1_ :: CTHHalf -> IO (Ptr CTHHalfStorage)
...
foreign import ccall "THStorage.h THHalfStorage_newWithSize2"
  c_newWithSize2_ :: CTHHalf -> CTHHalf -> IO (Ptr CTHHalfStorage)
...
foreign import ccall "THStorage.h THHalfStorage_newWithSize3"
  c_newWithSize3_ :: CTHHalf -> CTHHalf -> CTHHalf -> IO (Ptr CTHHalfStorage)
...
foreign import ccall "THStorage.h THHalfStorage_newWithSize4"
  c_newWithSize4_ :: CTHHalf -> CTHHalf -> CTHHalf -> CTHHalf -> IO (Ptr CTHHalfStorage)
...
foreign import ccall "THStorage.h THHalfStorage_newWithMapping"
  c_newWithMapping_ :: Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHHalfStorage)
...
foreign import ccall "THStorage.h THHalfStorage_newWithData"
  c_newWithData_ :: Ptr CTHHalf -> CPtrdiff -> IO (Ptr CTHHalfStorage)
...
foreign import ccall "THStorage.h THHalfStorage_newWithAllocator"
  c_newWithAllocator_ :: CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHHalfStorage)
...
foreign import ccall "THStorage.h THHalfStorage_newWithDataAndAllocator"
  c_newWithDataAndAllocator_ :: Ptr CTHHalf -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHHalfStorage)
...
foreign import ccall "THStorage.h THHalfStorage_setFlag"
  c_setFlag_ :: Ptr CTHHalfStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THHalfStorage_clearFlag"
  c_clearFlag_ :: Ptr CTHHalfStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THHalfStorage_retain"
  c_retain_ :: Ptr CTHHalfStorage -> IO ()
...
foreign import ccall "THStorage.h THHalfStorage_swap"
  c_swap_ :: Ptr CTHHalfStorage -> Ptr CTHHalfStorage -> IO ()
...
foreign import ccall "THStorage.h THHalfStorage_resize"
  c_resize_ :: Ptr CTHHalfStorage -> CPtrdiff -> IO ()
...
foreign import ccall "THStorage.h THHalfStorage_fill"
  c_fill_ :: Ptr CTHHalfStorage -> CTHHalf -> IO ()
...
foreign import ccall "THStorage.h &THHalfStorage_data"
  p_data_ :: FunPtr (Ptr CTHHalfStorage -> IO (Ptr CTHHalf))
...
foreign import ccall "THStorage.h &THHalfStorage_size"
  p_size_ :: FunPtr (Ptr CTHHalfStorage -> IO CPtrdiff)
...
foreign import ccall "THStorage.h &THHalfStorage_set"
  p_set_ :: FunPtr (Ptr CTHHalfStorage -> CPtrdiff -> CTHHalf -> IO ())
...
foreign import ccall "THStorage.h &THHalfStorage_get"
  p_get_ :: FunPtr (Ptr CTHHalfStorage -> CPtrdiff -> IO CTHHalf)
...
foreign import ccall "THStorage.h &THHalfStorage_new"
  p_new_ :: FunPtr (IO (Ptr CTHHalfStorage))
...
foreign import ccall "THStorage.h &THHalfStorage_newWithSize"
  p_newWithSize_ :: FunPtr (CPtrdiff -> IO (Ptr CTHHalfStorage))
...
foreign import ccall "THStorage.h &THHalfStorage_newWithSize1"
  p_newWithSize1_ :: FunPtr (CTHHalf -> IO (Ptr CTHHalfStorage))
...
foreign import ccall "THStorage.h &THHalfStorage_newWithSize2"
  p_newWithSize2_ :: FunPtr (CTHHalf -> CTHHalf -> IO (Ptr CTHHalfStorage))
...
foreign import ccall "THStorage.h &THHalfStorage_newWithSize3"
  p_newWithSize3_ :: FunPtr (CTHHalf -> CTHHalf -> CTHHalf -> IO (Ptr CTHHalfStorage))
...
foreign import ccall "THStorage.h &THHalfStorage_newWithSize4"
  p_newWithSize4_ :: FunPtr (CTHHalf -> CTHHalf -> CTHHalf -> CTHHalf -> IO (Ptr CTHHalfStorage))
...
foreign import ccall "THStorage.h &THHalfStorage_newWithMapping"
  p_newWithMapping_ :: FunPtr (Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHHalfStorage))
...
foreign import ccall "THStorage.h &THHalfStorage_newWithData"
  p_newWithData_ :: FunPtr (Ptr CTHHalf -> CPtrdiff -> IO (Ptr CTHHalfStorage))
...
foreign import ccall "THStorage.h &THHalfStorage_newWithAllocator"
  p_newWithAllocator_ :: FunPtr (CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHHalfStorage))
...
foreign import ccall "THStorage.h &THHalfStorage_newWithDataAndAllocator"
  p_newWithDataAndAllocator_ :: FunPtr (Ptr CTHHalf -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHHalfStorage))
...
foreign import ccall "THStorage.h &THHalfStorage_setFlag"
  p_setFlag_ :: FunPtr (Ptr CTHHalfStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THHalfStorage_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr CTHHalfStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THHalfStorage_retain"
  p_retain_ :: FunPtr (Ptr CTHHalfStorage -> IO ())
...
foreign import ccall "THStorage.h &THHalfStorage_swap"
  p_swap_ :: FunPtr (Ptr CTHHalfStorage -> Ptr CTHHalfStorage -> IO ())
...
foreign import ccall "THStorage.h &THHalfStorage_free"
  p_free_ :: FunPtr (Ptr CTHHalfStorage -> IO ())
...
foreign import ccall "THStorage.h &THHalfStorage_resize"
  p_resize_ :: FunPtr (Ptr CTHHalfStorage -> CPtrdiff -> IO ())
...
foreign import ccall "THStorage.h &THHalfStorage_fill"
  p_fill_ :: FunPtr (Ptr CTHHalfStorage -> CTHHalf -> IO ())
