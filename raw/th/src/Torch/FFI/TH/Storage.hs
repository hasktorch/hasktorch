...
foreign import ccall "THStorage.h c_THLongStorage_sizeDesc"
  c_THLongStorage_sizeDesc :: Ptr (CTHLongStorage) -> IO (CTHDescBuff)

-- | c_THLongStorage_newInferSize :  size nElement -> THLongStorage *
foreign import ccall "THStorage.h c_THLongStorage_newInferSize"
...
foreign import ccall "THStorage.h c_THLongStorage_inferSize2"
...
foreign import ccall "THStorage.h c_THLongStorage_inferSizeN"
...
foreign import ccall "THStorage.h c_THLongStorage_inferExpandGeometry"
...
foreign import ccall "THStorage.h &p_THLongStorage_sizeDesc"
...
foreign import ccall "THStorage.h &p_THLongStorage_newInferSize"
...
foreign import ccall "THStorage.h &p_THLongStorage_inferSize2"
...
foreign import ccall "THStorage.h &p_THLongStorage_inferSizeN"
...
foreign import ccall "THStorage.h &p_THLongStorage_inferExpandGeometry"
