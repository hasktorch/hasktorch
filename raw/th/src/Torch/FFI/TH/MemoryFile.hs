...
foreign import ccall "THMemoryFile.h &p_THMemoryFile_new"
  p_THMemoryFile_new :: FunPtr (Ptr (CChar) -> IO (Ptr (CTHFile)))

-- | p_THMemoryFile_storage : Pointer to function : self -> THCharStorage *
foreign import ccall "THMemoryFile.h &p_THMemoryFile_storage"
...
foreign import ccall "THMemoryFile.h &p_THMemoryFile_longSize"
