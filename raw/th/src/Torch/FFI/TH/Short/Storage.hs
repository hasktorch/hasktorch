...
foreign import ccall "THStorage.h THShortStorage_data"
  c_data_ :: Ptr CTHShortStorage -> IO (Ptr CShort)
...
foreign import ccall "THStorage.h THShortStorage_size"
  c_size_ :: Ptr CTHShortStorage -> IO CPtrdiff
...
foreign import ccall "THStorage.h THShortStorage_set"
  c_set_ :: Ptr CTHShortStorage -> CPtrdiff -> CShort -> IO ()
...
foreign import ccall "THStorage.h THShortStorage_get"
  c_get_ :: Ptr CTHShortStorage -> CPtrdiff -> IO CShort
...
foreign import ccall "THStorage.h THShortStorage_newWithSize"
  c_newWithSize_ :: CPtrdiff -> IO (Ptr CTHShortStorage)
...
foreign import ccall "THStorage.h THShortStorage_newWithSize1"
  c_newWithSize1_ :: CShort -> IO (Ptr CTHShortStorage)
...
foreign import ccall "THStorage.h THShortStorage_newWithSize2"
  c_newWithSize2_ :: CShort -> CShort -> IO (Ptr CTHShortStorage)
...
foreign import ccall "THStorage.h THShortStorage_newWithSize3"
  c_newWithSize3_ :: CShort -> CShort -> CShort -> IO (Ptr CTHShortStorage)
...
foreign import ccall "THStorage.h THShortStorage_newWithSize4"
  c_newWithSize4_ :: CShort -> CShort -> CShort -> CShort -> IO (Ptr CTHShortStorage)
...
foreign import ccall "THStorage.h THShortStorage_newWithMapping"
  c_newWithMapping_ :: Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHShortStorage)
...
foreign import ccall "THStorage.h THShortStorage_newWithData"
  c_newWithData_ :: Ptr CShort -> CPtrdiff -> IO (Ptr CTHShortStorage)
...
foreign import ccall "THStorage.h THShortStorage_newWithAllocator"
  c_newWithAllocator_ :: CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHShortStorage)
...
foreign import ccall "THStorage.h THShortStorage_newWithDataAndAllocator"
  c_newWithDataAndAllocator_ :: Ptr CShort -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHShortStorage)
...
foreign import ccall "THStorage.h THShortStorage_setFlag"
  c_setFlag_ :: Ptr CTHShortStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THShortStorage_clearFlag"
  c_clearFlag_ :: Ptr CTHShortStorage -> CChar -> IO ()
...
foreign import ccall "THStorage.h THShortStorage_retain"
  c_retain_ :: Ptr CTHShortStorage -> IO ()
...
foreign import ccall "THStorage.h THShortStorage_swap"
  c_swap_ :: Ptr CTHShortStorage -> Ptr CTHShortStorage -> IO ()
...
foreign import ccall "THStorage.h THShortStorage_free"
  c_free_ :: Ptr CTHShortStorage -> IO ()
...
foreign import ccall "THStorage.h THShortStorage_resize"
  c_resize_ :: Ptr CTHShortStorage -> CPtrdiff -> IO ()
...
foreign import ccall "THStorage.h THShortStorage_fill"
  c_fill_ :: Ptr CTHShortStorage -> CShort -> IO ()
...
foreign import ccall "THStorage.h &THShortStorage_data"
  p_data_ :: FunPtr (Ptr CTHShortStorage -> IO (Ptr CShort))
...
foreign import ccall "THStorage.h &THShortStorage_size"
  p_size_ :: FunPtr (Ptr CTHShortStorage -> IO CPtrdiff)
...
foreign import ccall "THStorage.h &THShortStorage_set"
  p_set_ :: FunPtr (Ptr CTHShortStorage -> CPtrdiff -> CShort -> IO ())
...
foreign import ccall "THStorage.h &THShortStorage_get"
  p_get_ :: FunPtr (Ptr CTHShortStorage -> CPtrdiff -> IO CShort)
...
foreign import ccall "THStorage.h &THShortStorage_new"
  p_new_ :: FunPtr (IO (Ptr CTHShortStorage))
...
foreign import ccall "THStorage.h &THShortStorage_newWithSize"
  p_newWithSize_ :: FunPtr (CPtrdiff -> IO (Ptr CTHShortStorage))
...
foreign import ccall "THStorage.h &THShortStorage_newWithSize1"
  p_newWithSize1_ :: FunPtr (CShort -> IO (Ptr CTHShortStorage))
...
foreign import ccall "THStorage.h &THShortStorage_newWithSize2"
  p_newWithSize2_ :: FunPtr (CShort -> CShort -> IO (Ptr CTHShortStorage))
...
foreign import ccall "THStorage.h &THShortStorage_newWithSize3"
  p_newWithSize3_ :: FunPtr (CShort -> CShort -> CShort -> IO (Ptr CTHShortStorage))
...
foreign import ccall "THStorage.h &THShortStorage_newWithSize4"
  p_newWithSize4_ :: FunPtr (CShort -> CShort -> CShort -> CShort -> IO (Ptr CTHShortStorage))
...
foreign import ccall "THStorage.h &THShortStorage_newWithMapping"
  p_newWithMapping_ :: FunPtr (Ptr CChar -> CPtrdiff -> CInt -> IO (Ptr CTHShortStorage))
...
foreign import ccall "THStorage.h &THShortStorage_newWithData"
  p_newWithData_ :: FunPtr (Ptr CShort -> CPtrdiff -> IO (Ptr CTHShortStorage))
...
foreign import ccall "THStorage.h &THShortStorage_newWithAllocator"
  p_newWithAllocator_ :: FunPtr (CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHShortStorage))
...
foreign import ccall "THStorage.h &THShortStorage_newWithDataAndAllocator"
  p_newWithDataAndAllocator_ :: FunPtr (Ptr CShort -> CPtrdiff -> Ptr CTHAllocator -> Ptr () -> IO (Ptr CTHShortStorage))
...
foreign import ccall "THStorage.h &THShortStorage_setFlag"
  p_setFlag_ :: FunPtr (Ptr CTHShortStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THShortStorage_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr CTHShortStorage -> CChar -> IO ())
...
foreign import ccall "THStorage.h &THShortStorage_retain"
  p_retain_ :: FunPtr (Ptr CTHShortStorage -> IO ())
...
foreign import ccall "THStorage.h &THShortStorage_swap"
  p_swap_ :: FunPtr (Ptr CTHShortStorage -> Ptr CTHShortStorage -> IO ())
...
foreign import ccall "THStorage.h &THShortStorage_free"
  p_free_ :: FunPtr (Ptr CTHShortStorage -> IO ())
...
foreign import ccall "THStorage.h &THShortStorage_resize"
  p_resize_ :: FunPtr (Ptr CTHShortStorage -> CPtrdiff -> IO ())
...
foreign import ccall "THStorage.h &THShortStorage_fill"
  p_fill_ :: FunPtr (Ptr CTHShortStorage -> CShort -> IO ())
