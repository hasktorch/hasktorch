...
foreign import ccall "THTensorCopy.h THShortTensor_copy"
  c_copy_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THShortTensor_copyByte"
  c_copyByte_ :: Ptr CTHShortTensor -> Ptr CTHByteTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THShortTensor_copyChar"
  c_copyChar_ :: Ptr CTHShortTensor -> Ptr CTHCharTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THShortTensor_copyShort"
  c_copyShort_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THShortTensor_copyInt"
  c_copyInt_ :: Ptr CTHShortTensor -> Ptr CTHIntTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THShortTensor_copyLong"
  c_copyLong_ :: Ptr CTHShortTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THShortTensor_copyFloat"
  c_copyFloat_ :: Ptr CTHShortTensor -> Ptr CTHFloatTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THShortTensor_copyDouble"
  c_copyDouble_ :: Ptr CTHShortTensor -> Ptr CTHDoubleTensor -> IO ()
...
foreign import ccall "THTensorCopy.h THShortTensor_copyHalf"
  c_copyHalf_ :: Ptr CTHShortTensor -> Ptr CTHHalfTensor -> IO ()
...
foreign import ccall "THTensorCopy.h &THShortTensor_copy"
  p_copy_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyByte"
  p_copyByte_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHByteTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyChar"
  p_copyChar_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHCharTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyShort"
  p_copyShort_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyInt"
  p_copyInt_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHIntTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyLong"
  p_copyLong_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHFloatTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHDoubleTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHHalfTensor -> IO ())
