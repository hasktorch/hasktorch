...
foreign import ccall "THTensorCopy.h &THShortTensor_copy"
  p_copy_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyByte"
  p_copyByte_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyChar"
  p_copyChar_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THCharTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyShort"
  p_copyShort_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyInt"
  p_copyInt_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THIntTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyLong"
  p_copyLong_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THFloatTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THDoubleTensor -> IO ())
...
foreign import ccall "THTensorCopy.h &THShortTensor_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THHalfTensor -> IO ())
