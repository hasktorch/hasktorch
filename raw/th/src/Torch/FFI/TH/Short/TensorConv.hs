...
foreign import ccall "THTensorConv.h THShortTensor_conv2DRevger"
  c_conv2DRevger_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THShortTensor_conv2DRevgerm"
  c_conv2DRevgerm_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THShortTensor_conv2Dger"
  c_conv2Dger_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THShortTensor_conv2Dmv"
  c_conv2Dmv_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THShortTensor_conv2Dmm"
  c_conv2Dmm_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THShortTensor_conv2Dmul"
  c_conv2Dmul_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THShortTensor_conv2Dcmul"
  c_conv2Dcmul_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THShortTensor_conv3DRevger"
  c_conv3DRevger_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorConv.h THShortTensor_conv3Dger"
  c_conv3Dger_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THShortTensor_conv3Dmv"
  c_conv3Dmv_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THShortTensor_conv3Dmul"
  c_conv3Dmul_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h THShortTensor_conv3Dcmul"
  c_conv3Dcmul_ :: Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ()
...
foreign import ccall "THTensorConv.h &THShortTensor_validXCorr2Dptr"
  p_validXCorr2Dptr_ :: FunPtr (Ptr CShort -> CShort -> Ptr CShort -> CLLong -> CLLong -> Ptr CShort -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_validConv2Dptr"
  p_validConv2Dptr_ :: FunPtr (Ptr CShort -> CShort -> Ptr CShort -> CLLong -> CLLong -> Ptr CShort -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_fullXCorr2Dptr"
  p_fullXCorr2Dptr_ :: FunPtr (Ptr CShort -> CShort -> Ptr CShort -> CLLong -> CLLong -> Ptr CShort -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_fullConv2Dptr"
  p_fullConv2Dptr_ :: FunPtr (Ptr CShort -> CShort -> Ptr CShort -> CLLong -> CLLong -> Ptr CShort -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_validXCorr2DRevptr"
  p_validXCorr2DRevptr_ :: FunPtr (Ptr CShort -> CShort -> Ptr CShort -> CLLong -> CLLong -> Ptr CShort -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv2DRevger"
  p_conv2DRevger_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv2DRevgerm"
  p_conv2DRevgerm_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv2Dger"
  p_conv2Dger_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv2Dmv"
  p_conv2Dmv_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv2Dmm"
  p_conv2Dmm_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv2Dmul"
  p_conv2Dmul_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv2Dcmul"
  p_conv2Dcmul_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_validXCorr3Dptr"
  p_validXCorr3Dptr_ :: FunPtr (Ptr CShort -> CShort -> Ptr CShort -> CLLong -> CLLong -> CLLong -> Ptr CShort -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_validConv3Dptr"
  p_validConv3Dptr_ :: FunPtr (Ptr CShort -> CShort -> Ptr CShort -> CLLong -> CLLong -> CLLong -> Ptr CShort -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_fullXCorr3Dptr"
  p_fullXCorr3Dptr_ :: FunPtr (Ptr CShort -> CShort -> Ptr CShort -> CLLong -> CLLong -> CLLong -> Ptr CShort -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_fullConv3Dptr"
  p_fullConv3Dptr_ :: FunPtr (Ptr CShort -> CShort -> Ptr CShort -> CLLong -> CLLong -> CLLong -> Ptr CShort -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_validXCorr3DRevptr"
  p_validXCorr3DRevptr_ :: FunPtr (Ptr CShort -> CShort -> Ptr CShort -> CLLong -> CLLong -> CLLong -> Ptr CShort -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv3DRevger"
  p_conv3DRevger_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv3Dger"
  p_conv3Dger_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv3Dmv"
  p_conv3Dmv_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv3Dmul"
  p_conv3Dmul_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
...
foreign import ccall "THTensorConv.h &THShortTensor_conv3Dcmul"
  p_conv3Dcmul_ :: FunPtr (Ptr CTHShortTensor -> CShort -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> CLLong -> CLLong -> Ptr CChar -> Ptr CChar -> IO ())
