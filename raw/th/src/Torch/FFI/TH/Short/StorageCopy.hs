...
foreign import ccall "THStorageCopy.h THShortStorage_rawCopy"
  c_rawCopy_ :: Ptr CTHShortStorage -> Ptr CShort -> IO ()
...
foreign import ccall "THStorageCopy.h THShortStorage_copy"
  c_copy_ :: Ptr CTHShortStorage -> Ptr CTHShortStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THShortStorage_copyByte"
  c_copyByte_ :: Ptr CTHShortStorage -> Ptr CTHByteStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THShortStorage_copyChar"
  c_copyChar_ :: Ptr CTHShortStorage -> Ptr CTHCharStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THShortStorage_copyShort"
  c_copyShort_ :: Ptr CTHShortStorage -> Ptr CTHShortStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THShortStorage_copyInt"
  c_copyInt_ :: Ptr CTHShortStorage -> Ptr CTHIntStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THShortStorage_copyLong"
  c_copyLong_ :: Ptr CTHShortStorage -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THShortStorage_copyFloat"
  c_copyFloat_ :: Ptr CTHShortStorage -> Ptr CTHFloatStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THShortStorage_copyDouble"
  c_copyDouble_ :: Ptr CTHShortStorage -> Ptr CTHDoubleStorage -> IO ()
...
foreign import ccall "THStorageCopy.h THShortStorage_copyHalf"
  c_copyHalf_ :: Ptr CTHShortStorage -> Ptr CTHHalfStorage -> IO ()
...
foreign import ccall "THStorageCopy.h &THShortStorage_rawCopy"
  p_rawCopy_ :: FunPtr (Ptr CTHShortStorage -> Ptr CShort -> IO ())
...
foreign import ccall "THStorageCopy.h &THShortStorage_copy"
  p_copy_ :: FunPtr (Ptr CTHShortStorage -> Ptr CTHShortStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THShortStorage_copyByte"
  p_copyByte_ :: FunPtr (Ptr CTHShortStorage -> Ptr CTHByteStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THShortStorage_copyChar"
  p_copyChar_ :: FunPtr (Ptr CTHShortStorage -> Ptr CTHCharStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THShortStorage_copyShort"
  p_copyShort_ :: FunPtr (Ptr CTHShortStorage -> Ptr CTHShortStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THShortStorage_copyInt"
  p_copyInt_ :: FunPtr (Ptr CTHShortStorage -> Ptr CTHIntStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THShortStorage_copyLong"
  p_copyLong_ :: FunPtr (Ptr CTHShortStorage -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THShortStorage_copyFloat"
  p_copyFloat_ :: FunPtr (Ptr CTHShortStorage -> Ptr CTHFloatStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THShortStorage_copyDouble"
  p_copyDouble_ :: FunPtr (Ptr CTHShortStorage -> Ptr CTHDoubleStorage -> IO ())
...
foreign import ccall "THStorageCopy.h &THShortStorage_copyHalf"
  p_copyHalf_ :: FunPtr (Ptr CTHShortStorage -> Ptr CTHHalfStorage -> IO ())
