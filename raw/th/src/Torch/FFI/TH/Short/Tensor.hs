...
foreign import ccall "THTensor.h &THShortTensor_storage"
  p_storage_ :: FunPtr (Ptr C'THShortTensor -> IO (Ptr C'THShortStorage))
...
foreign import ccall "THTensor.h &THShortTensor_storageOffset"
  p_storageOffset_ :: FunPtr (Ptr C'THShortTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THShortTensor_nDimension"
  p_nDimension_ :: FunPtr (Ptr C'THShortTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THShortTensor_size"
  p_size_ :: FunPtr (Ptr C'THShortTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THShortTensor_stride"
  p_stride_ :: FunPtr (Ptr C'THShortTensor -> CInt -> IO CLLong)
...
foreign import ccall "THTensor.h &THShortTensor_newSizeOf"
  p_newSizeOf_ :: FunPtr (Ptr C'THShortTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THShortTensor_newStrideOf"
  p_newStrideOf_ :: FunPtr (Ptr C'THShortTensor -> IO (Ptr C'THLongStorage))
...
foreign import ccall "THTensor.h &THShortTensor_data"
  p_data_ :: FunPtr (Ptr C'THShortTensor -> IO (Ptr CShort))
...
foreign import ccall "THTensor.h &THShortTensor_setFlag"
  p_setFlag_ :: FunPtr (Ptr C'THShortTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_clearFlag"
  p_clearFlag_ :: FunPtr (Ptr C'THShortTensor -> CChar -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_new"
  p_new_ :: FunPtr (IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newWithTensor"
  p_newWithTensor_ :: FunPtr (Ptr C'THShortTensor -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newWithStorage"
  p_newWithStorage_ :: FunPtr (Ptr C'THShortStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newWithStorage1d"
  p_newWithStorage1d_ :: FunPtr (Ptr C'THShortStorage -> CPtrdiff -> CLLong -> CLLong -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newWithStorage2d"
  p_newWithStorage2d_ :: FunPtr (Ptr C'THShortStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newWithStorage3d"
  p_newWithStorage3d_ :: FunPtr (Ptr C'THShortStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newWithStorage4d"
  p_newWithStorage4d_ :: FunPtr (Ptr C'THShortStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newWithSize"
  p_newWithSize_ :: FunPtr (Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newWithSize1d"
  p_newWithSize1d_ :: FunPtr (CLLong -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newWithSize2d"
  p_newWithSize2d_ :: FunPtr (CLLong -> CLLong -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newWithSize3d"
  p_newWithSize3d_ :: FunPtr (CLLong -> CLLong -> CLLong -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newWithSize4d"
  p_newWithSize4d_ :: FunPtr (CLLong -> CLLong -> CLLong -> CLLong -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newClone"
  p_newClone_ :: FunPtr (Ptr C'THShortTensor -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newContiguous"
  p_newContiguous_ :: FunPtr (Ptr C'THShortTensor -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newSelect"
  p_newSelect_ :: FunPtr (Ptr C'THShortTensor -> CInt -> CLLong -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newNarrow"
  p_newNarrow_ :: FunPtr (Ptr C'THShortTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newTranspose"
  p_newTranspose_ :: FunPtr (Ptr C'THShortTensor -> CInt -> CInt -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newUnfold"
  p_newUnfold_ :: FunPtr (Ptr C'THShortTensor -> CInt -> CLLong -> CLLong -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newView"
  p_newView_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongStorage -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_newExpand"
  p_newExpand_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongStorage -> IO (Ptr C'THShortTensor))
...
foreign import ccall "THTensor.h &THShortTensor_expand"
  p_expand_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_expandNd"
  p_expandNd_ :: FunPtr (Ptr (Ptr C'THShortTensor) -> Ptr (Ptr C'THShortTensor) -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_resize"
  p_resize_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_resizeAs"
  p_resizeAs_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_resizeNd"
  p_resizeNd_ :: FunPtr (Ptr C'THShortTensor -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_resize1d"
  p_resize1d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_resize2d"
  p_resize2d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_resize3d"
  p_resize3d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_resize4d"
  p_resize4d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_resize5d"
  p_resize5d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_set"
  p_set_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_setStorage"
  p_setStorage_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortStorage -> CPtrdiff -> Ptr C'THLongStorage -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_setStorageNd"
  p_setStorageNd_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortStorage -> CPtrdiff -> CInt -> Ptr CLLong -> Ptr CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_setStorage1d"
  p_setStorage1d_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortStorage -> CPtrdiff -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_setStorage2d"
  p_setStorage2d_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_setStorage3d"
  p_setStorage3d_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_setStorage4d"
  p_setStorage4d_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortStorage -> CPtrdiff -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_narrow"
  p_narrow_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_select"
  p_select_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_transpose"
  p_transpose_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_unfold"
  p_unfold_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_squeeze"
  p_squeeze_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_squeeze1d"
  p_squeeze1d_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_unsqueeze1d"
  p_unsqueeze1d_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_isContiguous"
  p_isContiguous_ :: FunPtr (Ptr C'THShortTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THShortTensor_isSameSizeAs"
  p_isSameSizeAs_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THShortTensor_isSetTo"
  p_isSetTo_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO CInt)
...
foreign import ccall "THTensor.h &THShortTensor_isSize"
  p_isSize_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongStorage -> IO CInt)
...
foreign import ccall "THTensor.h &THShortTensor_nElement"
  p_nElement_ :: FunPtr (Ptr C'THShortTensor -> IO CPtrdiff)
...
foreign import ccall "THTensor.h &THShortTensor_retain"
  p_retain_ :: FunPtr (Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_free"
  p_free_ :: FunPtr (Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_freeCopyTo"
  p_freeCopyTo_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_set1d"
  p_set1d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CShort -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_set2d"
  p_set2d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CLLong -> CShort -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_set3d"
  p_set3d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CLLong -> CLLong -> CShort -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_set4d"
  p_set4d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CLLong -> CLLong -> CLLong -> CShort -> IO ())
...
foreign import ccall "THTensor.h &THShortTensor_get1d"
  p_get1d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> IO CShort)
...
foreign import ccall "THTensor.h &THShortTensor_get2d"
  p_get2d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CLLong -> IO CShort)
...
foreign import ccall "THTensor.h &THShortTensor_get3d"
  p_get3d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CLLong -> CLLong -> IO CShort)
...
foreign import ccall "THTensor.h &THShortTensor_get4d"
  p_get4d_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CLLong -> CLLong -> CLLong -> IO CShort)
...
foreign import ccall "THTensor.h &THShortTensor_desc"
  p_desc_ :: FunPtr (Ptr C'THShortTensor -> IO (Ptr C'THDescBuff))
...
foreign import ccall "THTensor.h &THShortTensor_sizeDesc"
  p_sizeDesc_ :: FunPtr (Ptr C'THShortTensor -> IO (Ptr C'THDescBuff))
