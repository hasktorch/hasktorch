...
foreign import ccall "THTensorRandom.h c_THTensorShort_bernoulli_DoubleTensor"
...
foreign import ccall "THTensorRandom.h &p_THTensorShort_random"
  p_random :: FunPtr (Ptr (CTHShortTensor) -> Ptr (CTHGenerator) -> IO (()))

-- | p_clampedRandom : Pointer to function : self _generator min max -> void
foreign import ccall "THTensorRandom.h &p_THTensorShort_clampedRandom"
...
foreign import ccall "THTensorRandom.h &p_THTensorShort_cappedRandom"
...
foreign import ccall "THTensorRandom.h &p_THTensorShort_geometric"
  p_geometric :: FunPtr (Ptr (CTHShortTensor) -> Ptr (CTHGenerator) -> CDouble -> IO (()))

-- | p_bernoulli : Pointer to function : self _generator p -> void
foreign import ccall "THTensorRandom.h &p_THTensorShort_bernoulli"
...
foreign import ccall "THTensorRandom.h &p_THTensorShort_bernoulli_FloatTensor"
...
foreign import ccall "THTensorRandom.h &p_THTensorShort_bernoulli_DoubleTensor"
