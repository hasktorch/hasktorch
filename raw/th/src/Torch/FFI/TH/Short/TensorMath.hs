...
foreign import ccall "THTensorMath.h THShortTensor_fill"
  c_fill_ :: Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_maskedFill"
  c_maskedFill_ :: Ptr CTHShortTensor -> Ptr CTHByteTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_maskedCopy"
  c_maskedCopy_ :: Ptr CTHShortTensor -> Ptr CTHByteTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_maskedSelect"
  c_maskedSelect_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHByteTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_nonzero"
  c_nonzero_ :: Ptr CTHLongTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_indexSelect"
  c_indexSelect_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_indexCopy"
  c_indexCopy_ :: Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_indexAdd"
  c_indexAdd_ :: Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_indexFill"
  c_indexFill_ :: Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_take"
  c_take_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_put"
  c_put_ :: Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_gather"
  c_gather_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_scatter"
  c_scatter_ :: Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_scatterAdd"
  c_scatterAdd_ :: Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_scatterFill"
  c_scatterFill_ :: Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_dot"
  c_dot_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THShortTensor_minall"
  c_minall_ :: Ptr CTHShortTensor -> IO CShort
...
foreign import ccall "THTensorMath.h THShortTensor_maxall"
  c_maxall_ :: Ptr CTHShortTensor -> IO CShort
...
foreign import ccall "THTensorMath.h THShortTensor_medianall"
  c_medianall_ :: Ptr CTHShortTensor -> IO CShort
...
foreign import ccall "THTensorMath.h THShortTensor_sumall"
  c_sumall_ :: Ptr CTHShortTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THShortTensor_prodall"
  c_prodall_ :: Ptr CTHShortTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THShortTensor_neg"
  c_neg_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_add"
  c_add_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_sub"
  c_sub_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_add_scaled"
  c_add_scaled_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_sub_scaled"
  c_sub_scaled_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_mul"
  c_mul_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_div"
  c_div_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_lshift"
  c_lshift_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_rshift"
  c_rshift_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_fmod"
  c_fmod_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_remainder"
  c_remainder_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_clamp"
  c_clamp_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_bitand"
  c_bitand_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_bitor"
  c_bitor_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_bitxor"
  c_bitxor_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cadd"
  c_cadd_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_csub"
  c_csub_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cmul"
  c_cmul_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cpow"
  c_cpow_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cdiv"
  c_cdiv_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_clshift"
  c_clshift_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_crshift"
  c_crshift_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cfmod"
  c_cfmod_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cremainder"
  c_cremainder_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cbitand"
  c_cbitand_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cbitor"
  c_cbitor_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cbitxor"
  c_cbitxor_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_addcmul"
  c_addcmul_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_addcdiv"
  c_addcdiv_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_addmv"
  c_addmv_ :: Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_addmm"
  c_addmm_ :: Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_addr"
  c_addr_ :: Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_addbmm"
  c_addbmm_ :: Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_baddbmm"
  c_baddbmm_ :: Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_match"
  c_match_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_numel"
  c_numel_ :: Ptr CTHShortTensor -> IO CPtrdiff
...
foreign import ccall "THTensorMath.h THShortTensor_max"
  c_max_ :: Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_min"
  c_min_ :: Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_kthvalue"
  c_kthvalue_ :: Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CLLong -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_mode"
  c_mode_ :: Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_median"
  c_median_ :: Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_sum"
  c_sum_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_prod"
  c_prod_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cumsum"
  c_cumsum_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cumprod"
  c_cumprod_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_sign"
  c_sign_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_trace"
  c_trace_ :: Ptr CTHShortTensor -> IO CLong
...
foreign import ccall "THTensorMath.h THShortTensor_cross"
  c_cross_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cmax"
  c_cmax_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cmin"
  c_cmin_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cmaxValue"
  c_cmaxValue_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cminValue"
  c_cminValue_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_zeros"
  c_zeros_ :: Ptr CTHShortTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_zerosLike"
  c_zerosLike_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_ones"
  c_ones_ :: Ptr CTHShortTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_onesLike"
  c_onesLike_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_diag"
  c_diag_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_eye"
  c_eye_ :: Ptr CTHShortTensor -> CLLong -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_arange"
  c_arange_ :: Ptr CTHShortTensor -> CLong -> CLong -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_range"
  c_range_ :: Ptr CTHShortTensor -> CLong -> CLong -> CLong -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_randperm"
  c_randperm_ :: Ptr CTHShortTensor -> Ptr CTHGenerator -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_reshape"
  c_reshape_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHLongStorage -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_sort"
  c_sort_ :: Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_topk"
  c_topk_ :: Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CLLong -> CInt -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_tril"
  c_tril_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_triu"
  c_triu_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_cat"
  c_cat_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_catArray"
  c_catArray_ :: Ptr CTHShortTensor -> Ptr (Ptr CTHShortTensor) -> CInt -> CInt -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_equal"
  c_equal_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO CInt
...
foreign import ccall "THTensorMath.h THShortTensor_ltValue"
  c_ltValue_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_leValue"
  c_leValue_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_gtValue"
  c_gtValue_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_geValue"
  c_geValue_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_neValue"
  c_neValue_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_eqValue"
  c_eqValue_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_ltValueT"
  c_ltValueT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_leValueT"
  c_leValueT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_gtValueT"
  c_gtValueT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_geValueT"
  c_geValueT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_neValueT"
  c_neValueT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_eqValueT"
  c_eqValueT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_ltTensor"
  c_ltTensor_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_leTensor"
  c_leTensor_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_gtTensor"
  c_gtTensor_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_geTensor"
  c_geTensor_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_neTensor"
  c_neTensor_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_eqTensor"
  c_eqTensor_ :: Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_ltTensorT"
  c_ltTensorT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_leTensorT"
  c_leTensorT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_gtTensorT"
  c_gtTensorT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_geTensorT"
  c_geTensorT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_neTensorT"
  c_neTensorT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_eqTensorT"
  c_eqTensorT_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h THShortTensor_abs"
  c_abs_ :: Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ()
...
foreign import ccall "THTensorMath.h &THShortTensor_fill"
  p_fill_ :: FunPtr (Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_zero"
  p_zero_ :: FunPtr (Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_maskedFill"
  p_maskedFill_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHByteTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_maskedCopy"
  p_maskedCopy_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHByteTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_maskedSelect"
  p_maskedSelect_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_nonzero"
  p_nonzero_ :: FunPtr (Ptr CTHLongTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_indexSelect"
  p_indexSelect_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_indexCopy"
  p_indexCopy_ :: FunPtr (Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_indexAdd"
  p_indexAdd_ :: FunPtr (Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_indexFill"
  p_indexFill_ :: FunPtr (Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_take"
  p_take_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_put"
  p_put_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_gather"
  p_gather_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_scatter"
  p_scatter_ :: FunPtr (Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_scatterAdd"
  p_scatterAdd_ :: FunPtr (Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_scatterFill"
  p_scatterFill_ :: FunPtr (Ptr CTHShortTensor -> CInt -> Ptr CTHLongTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_dot"
  p_dot_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THShortTensor_minall"
  p_minall_ :: FunPtr (Ptr CTHShortTensor -> IO CShort)
...
foreign import ccall "THTensorMath.h &THShortTensor_maxall"
  p_maxall_ :: FunPtr (Ptr CTHShortTensor -> IO CShort)
...
foreign import ccall "THTensorMath.h &THShortTensor_medianall"
  p_medianall_ :: FunPtr (Ptr CTHShortTensor -> IO CShort)
...
foreign import ccall "THTensorMath.h &THShortTensor_sumall"
  p_sumall_ :: FunPtr (Ptr CTHShortTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THShortTensor_prodall"
  p_prodall_ :: FunPtr (Ptr CTHShortTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THShortTensor_neg"
  p_neg_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_add"
  p_add_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_sub"
  p_sub_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_add_scaled"
  p_add_scaled_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_sub_scaled"
  p_sub_scaled_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_mul"
  p_mul_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_div"
  p_div_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_lshift"
  p_lshift_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_rshift"
  p_rshift_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_fmod"
  p_fmod_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_remainder"
  p_remainder_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_clamp"
  p_clamp_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_bitand"
  p_bitand_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_bitor"
  p_bitor_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_bitxor"
  p_bitxor_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cadd"
  p_cadd_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_csub"
  p_csub_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cmul"
  p_cmul_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cpow"
  p_cpow_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cdiv"
  p_cdiv_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_clshift"
  p_clshift_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_crshift"
  p_crshift_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cfmod"
  p_cfmod_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cremainder"
  p_cremainder_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cbitand"
  p_cbitand_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cbitor"
  p_cbitor_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cbitxor"
  p_cbitxor_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addcmul"
  p_addcmul_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addcdiv"
  p_addcdiv_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addmv"
  p_addmv_ :: FunPtr (Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addmm"
  p_addmm_ :: FunPtr (Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addr"
  p_addr_ :: FunPtr (Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addbmm"
  p_addbmm_ :: FunPtr (Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_baddbmm"
  p_baddbmm_ :: FunPtr (Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> CShort -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_match"
  p_match_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_numel"
  p_numel_ :: FunPtr (Ptr CTHShortTensor -> IO CPtrdiff)
...
foreign import ccall "THTensorMath.h &THShortTensor_max"
  p_max_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_min"
  p_min_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_kthvalue"
  p_kthvalue_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_mode"
  p_mode_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_median"
  p_median_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_sum"
  p_sum_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_prod"
  p_prod_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cumsum"
  p_cumsum_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cumprod"
  p_cumprod_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_sign"
  p_sign_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_trace"
  p_trace_ :: FunPtr (Ptr CTHShortTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THShortTensor_cross"
  p_cross_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cmax"
  p_cmax_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cmin"
  p_cmin_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cmaxValue"
  p_cmaxValue_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cminValue"
  p_cminValue_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_zeros"
  p_zeros_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_zerosLike"
  p_zerosLike_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_ones"
  p_ones_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_onesLike"
  p_onesLike_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_diag"
  p_diag_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_eye"
  p_eye_ :: FunPtr (Ptr CTHShortTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_arange"
  p_arange_ :: FunPtr (Ptr CTHShortTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_range"
  p_range_ :: FunPtr (Ptr CTHShortTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_randperm"
  p_randperm_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_reshape"
  p_reshape_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_sort"
  p_sort_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_topk"
  p_topk_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHLongTensor -> Ptr CTHShortTensor -> CLLong -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_tril"
  p_tril_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_triu"
  p_triu_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cat"
  p_cat_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_catArray"
  p_catArray_ :: FunPtr (Ptr CTHShortTensor -> Ptr (Ptr CTHShortTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_equal"
  p_equal_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THShortTensor_ltValue"
  p_ltValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_leValue"
  p_leValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_gtValue"
  p_gtValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_geValue"
  p_geValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_neValue"
  p_neValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_eqValue"
  p_eqValue_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_ltValueT"
  p_ltValueT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_leValueT"
  p_leValueT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_gtValueT"
  p_gtValueT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_geValueT"
  p_geValueT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_neValueT"
  p_neValueT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_eqValueT"
  p_eqValueT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_ltTensor"
  p_ltTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_leTensor"
  p_leTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_gtTensor"
  p_gtTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_geTensor"
  p_geTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_neTensor"
  p_neTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_eqTensor"
  p_eqTensor_ :: FunPtr (Ptr CTHByteTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_ltTensorT"
  p_ltTensorT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_leTensorT"
  p_leTensorT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_gtTensorT"
  p_gtTensorT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_geTensorT"
  p_geTensorT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_neTensorT"
  p_neTensorT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_eqTensorT"
  p_eqTensorT_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_abs"
  p_abs_ :: FunPtr (Ptr CTHShortTensor -> Ptr CTHShortTensor -> IO ())
