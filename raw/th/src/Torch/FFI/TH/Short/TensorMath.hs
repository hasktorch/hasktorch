...
foreign import ccall "THTensorMath.h &THShortTensor_fill"
  p_fill_ :: FunPtr (Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_zero"
  p_zero_ :: FunPtr (Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_maskedFill"
  p_maskedFill_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THByteTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_maskedCopy"
  p_maskedCopy_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THByteTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_maskedSelect"
  p_maskedSelect_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THByteTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_nonzero"
  p_nonzero_ :: FunPtr (Ptr C'THLongTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_indexSelect"
  p_indexSelect_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_indexCopy"
  p_indexCopy_ :: FunPtr (Ptr C'THShortTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_indexAdd"
  p_indexAdd_ :: FunPtr (Ptr C'THShortTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_indexFill"
  p_indexFill_ :: FunPtr (Ptr C'THShortTensor -> CInt -> Ptr C'THLongTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_take"
  p_take_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_put"
  p_put_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_gather"
  p_gather_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> Ptr C'THLongTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_scatter"
  p_scatter_ :: FunPtr (Ptr C'THShortTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_scatterAdd"
  p_scatterAdd_ :: FunPtr (Ptr C'THShortTensor -> CInt -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_scatterFill"
  p_scatterFill_ :: FunPtr (Ptr C'THShortTensor -> CInt -> Ptr C'THLongTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_dot"
  p_dot_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THShortTensor_minall"
  p_minall_ :: FunPtr (Ptr C'THShortTensor -> IO CShort)
...
foreign import ccall "THTensorMath.h &THShortTensor_maxall"
  p_maxall_ :: FunPtr (Ptr C'THShortTensor -> IO CShort)
...
foreign import ccall "THTensorMath.h &THShortTensor_medianall"
  p_medianall_ :: FunPtr (Ptr C'THShortTensor -> IO CShort)
...
foreign import ccall "THTensorMath.h &THShortTensor_sumall"
  p_sumall_ :: FunPtr (Ptr C'THShortTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THShortTensor_prodall"
  p_prodall_ :: FunPtr (Ptr C'THShortTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THShortTensor_neg"
  p_neg_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_add"
  p_add_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_sub"
  p_sub_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_add_scaled"
  p_add_scaled_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_sub_scaled"
  p_sub_scaled_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_mul"
  p_mul_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_div"
  p_div_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_lshift"
  p_lshift_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_rshift"
  p_rshift_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_fmod"
  p_fmod_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_remainder"
  p_remainder_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_clamp"
  p_clamp_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_bitand"
  p_bitand_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_bitor"
  p_bitor_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_bitxor"
  p_bitxor_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cadd"
  p_cadd_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_csub"
  p_csub_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cmul"
  p_cmul_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cpow"
  p_cpow_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cdiv"
  p_cdiv_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_clshift"
  p_clshift_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_crshift"
  p_crshift_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cfmod"
  p_cfmod_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cremainder"
  p_cremainder_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cbitand"
  p_cbitand_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cbitor"
  p_cbitor_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cbitxor"
  p_cbitxor_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addcmul"
  p_addcmul_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addcdiv"
  p_addcdiv_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addmv"
  p_addmv_ :: FunPtr (Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addmm"
  p_addmm_ :: FunPtr (Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addr"
  p_addr_ :: FunPtr (Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_addbmm"
  p_addbmm_ :: FunPtr (Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_baddbmm"
  p_baddbmm_ :: FunPtr (Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> CShort -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_match"
  p_match_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_numel"
  p_numel_ :: FunPtr (Ptr C'THShortTensor -> IO CPtrdiff)
...
foreign import ccall "THTensorMath.h &THShortTensor_preserveReduceDimSemantics"
  p_preserveReduceDimSemantics_ :: FunPtr (Ptr C'THShortTensor -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_max"
  p_max_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_min"
  p_min_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_kthvalue"
  p_kthvalue_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> CLLong -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_mode"
  p_mode_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_median"
  p_median_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_sum"
  p_sum_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_prod"
  p_prod_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cumsum"
  p_cumsum_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cumprod"
  p_cumprod_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_sign"
  p_sign_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_trace"
  p_trace_ :: FunPtr (Ptr C'THShortTensor -> IO CLong)
...
foreign import ccall "THTensorMath.h &THShortTensor_cross"
  p_cross_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cmax"
  p_cmax_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cmin"
  p_cmin_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cmaxValue"
  p_cmaxValue_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cminValue"
  p_cminValue_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_zeros"
  p_zeros_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_zerosLike"
  p_zerosLike_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_ones"
  p_ones_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_onesLike"
  p_onesLike_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_diag"
  p_diag_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_eye"
  p_eye_ :: FunPtr (Ptr C'THShortTensor -> CLLong -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_arange"
  p_arange_ :: FunPtr (Ptr C'THShortTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_range"
  p_range_ :: FunPtr (Ptr C'THShortTensor -> CLong -> CLong -> CLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_randperm"
  p_randperm_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THGenerator -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_reshape"
  p_reshape_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THLongStorage -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_sort"
  p_sort_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_topk"
  p_topk_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THLongTensor -> Ptr C'THShortTensor -> CLLong -> CInt -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_tril"
  p_tril_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_triu"
  p_triu_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CLLong -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_cat"
  p_cat_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_catArray"
  p_catArray_ :: FunPtr (Ptr C'THShortTensor -> Ptr (Ptr C'THShortTensor) -> CInt -> CInt -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_equal"
  p_equal_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO CInt)
...
foreign import ccall "THTensorMath.h &THShortTensor_ltValue"
  p_ltValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_leValue"
  p_leValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_gtValue"
  p_gtValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_geValue"
  p_geValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_neValue"
  p_neValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_eqValue"
  p_eqValue_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_ltValueT"
  p_ltValueT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_leValueT"
  p_leValueT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_gtValueT"
  p_gtValueT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_geValueT"
  p_geValueT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_neValueT"
  p_neValueT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_eqValueT"
  p_eqValueT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> CShort -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_ltTensor"
  p_ltTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_leTensor"
  p_leTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_gtTensor"
  p_gtTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_geTensor"
  p_geTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_neTensor"
  p_neTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_eqTensor"
  p_eqTensor_ :: FunPtr (Ptr C'THByteTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_ltTensorT"
  p_ltTensorT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_leTensorT"
  p_leTensorT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_gtTensorT"
  p_gtTensorT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_geTensorT"
  p_geTensorT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_neTensorT"
  p_neTensorT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_eqTensorT"
  p_eqTensorT_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
...
foreign import ccall "THTensorMath.h &THShortTensor_abs"
  p_abs_ :: FunPtr (Ptr C'THShortTensor -> Ptr C'THShortTensor -> IO ())
