...
empty_permuted_llo
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
empty_permuted_llo = cast3 Unmanaged.empty_permuted_llo

empty_permuted_ll
  :: ForeignPtr IntArray
  -> ForeignPtr IntArray
  -> IO (ForeignPtr Tensor)
empty_permuted_ll = cast2 Unmanaged.empty_permuted_ll
...
sparse_compressed_tensor_tttlo
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
sparse_compressed_tensor_tttlo = cast5 Unmanaged.sparse_compressed_tensor_tttlo
...
sparse_csc_tensor_tttlo
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
sparse_csc_tensor_tttlo = cast5 Unmanaged.sparse_csc_tensor_tttlo
...
sparse_bsr_tensor_tttlo
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
sparse_bsr_tensor_tttlo = cast5 Unmanaged.sparse_bsr_tensor_tttlo
...
sparse_bsc_tensor_tttlo
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
sparse_bsc_tensor_tttlo = cast5 Unmanaged.sparse_bsc_tensor_tttlo
...
sparse_compressed_tensor_ttto
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
sparse_compressed_tensor_ttto = cast4 Unmanaged.sparse_compressed_tensor_ttto
...
sparse_csc_tensor_ttto
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
sparse_csc_tensor_ttto = cast4 Unmanaged.sparse_csc_tensor_ttto
...
sparse_bsr_tensor_ttto
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
sparse_bsr_tensor_ttto = cast4 Unmanaged.sparse_bsr_tensor_ttto
...
sparse_bsc_tensor_ttto
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
sparse_bsc_tensor_ttto = cast4 Unmanaged.sparse_bsc_tensor_ttto
...
_sparse_compressed_tensor_unsafe_tttlo
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
_sparse_compressed_tensor_unsafe_tttlo = cast5 Unmanaged._sparse_compressed_tensor_unsafe_tttlo
...
_sparse_compressed_tensor_unsafe_tttl
  ...
  -> ForeignPtr IntArray
  -> IO (ForeignPtr Tensor)
_sparse_compressed_tensor_unsafe_tttl = cast4 Unmanaged._sparse_compressed_tensor_unsafe_tttl
...
_sparse_csc_tensor_unsafe_tttlo
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
_sparse_csc_tensor_unsafe_tttlo = cast5 Unmanaged._sparse_csc_tensor_unsafe_tttlo
...
_sparse_csc_tensor_unsafe_tttl
  ...
  -> ForeignPtr IntArray
  -> IO (ForeignPtr Tensor)
_sparse_csc_tensor_unsafe_tttl = cast4 Unmanaged._sparse_csc_tensor_unsafe_tttl
...
_sparse_bsr_tensor_unsafe_tttlo
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
_sparse_bsr_tensor_unsafe_tttlo = cast5 Unmanaged._sparse_bsr_tensor_unsafe_tttlo
...
_sparse_bsr_tensor_unsafe_tttl
  ...
  -> ForeignPtr IntArray
  -> IO (ForeignPtr Tensor)
_sparse_bsr_tensor_unsafe_tttl = cast4 Unmanaged._sparse_bsr_tensor_unsafe_tttl
...
_sparse_bsc_tensor_unsafe_tttlo
  ...
  -> ForeignPtr TensorOptions
  -> IO (ForeignPtr Tensor)
_sparse_bsc_tensor_unsafe_tttlo = cast5 Unmanaged._sparse_bsc_tensor_unsafe_tttlo
...
_sparse_bsc_tensor_unsafe_tttl
  ...
  -> ForeignPtr IntArray
  -> IO (ForeignPtr Tensor)
_sparse_bsc_tensor_unsafe_tttl = cast4 Unmanaged._sparse_bsc_tensor_unsafe_tttl
