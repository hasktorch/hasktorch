...
add_out_sparse_cpu_Ttts
  :: Ptr Tensor
  -> Ptr Tensor
  -> Ptr Tensor
  -> Ptr Scalar
  -> IO (Ptr Tensor)
add_out_sparse_cpu_Ttts _out _self _other _alpha =
  [C.block| at::Tensor* { return new at::Tensor(at::native::add_out_sparse_cpu(
    *$(at::Tensor* _out)
  , *$(at::Tensor* _self)
  , *$(at::Tensor* _other)
  , *$(at::Scalar* _alpha)));
...
mul_out_sparse_cpu_Ttt
  :: Ptr Tensor
  -> Ptr Tensor
  -> Ptr Tensor
  -> IO (Ptr Tensor)
mul_out_sparse_cpu_Ttt _out _self _other =
  [C.block| at::Tensor* { return new at::Tensor(at::native::mul_out_sparse_cpu(
    *$(at::Tensor* _out)
  , *$(at::Tensor* _self)
  , *$(at::Tensor* _other)));
  }|]
...
_sspaddmm_out_cpu_Ttttss
  ...
  -> Ptr Scalar
  -> IO (Ptr Tensor)
_sspaddmm_out_cpu_Ttttss _out _self _mat1 _mat2 _beta _alpha =
  [C.block| at::Tensor* { return new at::Tensor(at::native::_sspaddmm_out_cpu(
    *$(at::Tensor* _out)
  , *$(at::Tensor* _self)
  , *$(at::Tensor* _mat1)
  , *$(at::Tensor* _mat2)
...
hspmm_out_sparse_cpu_Ttt
  :: Ptr Tensor
  -> Ptr Tensor
  -> Ptr Tensor
  -> IO (Ptr Tensor)
hspmm_out_sparse_cpu_Ttt _out _mat1 _mat2 =
  [C.block| at::Tensor* { return new at::Tensor(at::native::hspmm_out_sparse_cpu(
    *$(at::Tensor* _out)
  , *$(at::Tensor* _mat1)
  , *$(at::Tensor* _mat2)));
  }|]
