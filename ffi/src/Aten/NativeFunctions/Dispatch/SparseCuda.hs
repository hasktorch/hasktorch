...
module Aten.NativeFunctions.Dispatch.SparseCuda where
...
_sparse_sum_backward_cuda_ttl
  :: Ptr Tensor
  -> Ptr Tensor
  -> Ptr IntList
  -> IO (Ptr Tensor)
_sparse_sum_backward_cuda_ttl _grad _self _dim =
  [C.block| at::Tensor* { return new at::Tensor(at::native::_sparse_sum_backward_cuda(
    *$(at::Tensor* _grad)
  , *$(at::Tensor* _self)
  , *$(at::IntArrayRef* _dim)));
  }|]
...
coalesce_sparse_cuda_t
  :: Ptr Tensor
  -> IO (Ptr Tensor)
coalesce_sparse_cuda_t _self =
  [C.block| at::Tensor* { return new at::Tensor(at::native::coalesce_sparse_cuda(
    *$(at::Tensor* _self)));
  }|]
...
hspmm_sparse_cuda_tt
  :: Ptr Tensor
  -> Ptr Tensor
  -> IO (Ptr Tensor)
hspmm_sparse_cuda_tt _mat1 _mat2 =
  [C.block| at::Tensor* { return new at::Tensor(at::native::hspmm_sparse_cuda(
    *$(at::Tensor* _mat1)
  , *$(at::Tensor* _mat2)));
  }|]
