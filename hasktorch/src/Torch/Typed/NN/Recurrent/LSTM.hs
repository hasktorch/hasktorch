...
instance
  ...
  ) => A.Randomizable (LSTMWithInitSpec inputSize hiddenSize numLayers directionality dtype device)
                      (LSTMWithInit     inputSize hiddenSize numLayers directionality dtype device) where
