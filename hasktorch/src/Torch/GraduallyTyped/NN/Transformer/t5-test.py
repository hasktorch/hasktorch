...
attention_mask = torch.zeros([batch_size, encoder_seq_length], dtype=torch.float)
decoder_attention_mask = torch.zeros([batch_size, decoder_seq_length], dtype=torch.float)
