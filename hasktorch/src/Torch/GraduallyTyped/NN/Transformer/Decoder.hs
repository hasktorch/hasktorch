...
type HasForwardTransformerDecoderC
  ...
  ( Scalar dropoutP,
    HasForwardTransformerDecoderStack (1 <=? numLayers) numLayers device dataType headDim headEmbedDim embedDim decoderInputEmbedDim encoderOutputEmbedDim ffnDim dropoutP decoderInputRequiresGradient decoderInputLayout (decoderInputDevice <+> generatorDevice) decoderInputDataType decoderInputShape encoderOutputRequiresGradient encoderOutputLayout encoderOutputDevice encoderOutputDataType encoderOutputShape decoderAttentionMaskRequiresGradient decoderAttentionMaskLayout decoderAttentionMaskDevice decoderAttentionMaskDataType decoderAttentionMaskShape crossAttentionMaskRequiresGradient crossAttentionMaskLayout crossAttentionMaskDevice crossAttentionMaskDataType crossAttentionMaskShape (decoderInputDevice <+> generatorDevice),
    HasForward
      (LayerNorm 'WithoutBias device dataType ( 'Shape '[decoderInputEmbedDim]))
      (HasForwardTransformerDecoderStackOutput (1 <=? numLayers) numLayers device dataType headDim headEmbedDim embedDim decoderInputEmbedDim encoderOutputEmbedDim ffnDim decoderInputRequiresGradient decoderInputLayout (decoderInputDevice <+> generatorDevice) decoderInputDataType decoderInputShape encoderOutputRequiresGradient encoderOutputLayout encoderOutputDevice encoderOutputDataType encoderOutputShape decoderAttentionMaskRequiresGradient decoderAttentionMaskLayout decoderAttentionMaskDevice decoderAttentionMaskDataType decoderAttentionMaskShape crossAttentionMaskRequiresGradient crossAttentionMaskLayout crossAttentionMaskDevice crossAttentionMaskDataType crossAttentionMaskShape (decoderInputDevice <+> generatorDevice))
