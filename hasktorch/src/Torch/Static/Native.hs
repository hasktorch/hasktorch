...
-- >>> t = binary_cross_entropy @ReduceNone tt tt tt :: Tensor Float '[2,2]
-- >>> (dtype t,shape t)
-- (Float,[2,2])
-- >>> t = binary_cross_entropy @ReduceMean tt tt tt :: Tensor Float '[]
-- >>> (dtype t,shape t)
-- (Float,[])
-- >>> t = binary_cross_entropy @ReduceSum tt tt tt :: Tensor Float '[]
-- >>> (dtype t,shape t)
-- (Float,[])
