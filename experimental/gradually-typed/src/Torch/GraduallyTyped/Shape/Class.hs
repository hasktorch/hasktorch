...
-- >>> fromSing <$> dim
-- Dim {dimName = IsChecked "batch", dimSize = IsChecked 8}
--
...
-- >>> fromSing <$> dim
-- Dim {dimName = IsUnchecked "feature", dimSize = IsChecked 2}
--
...
-- >>> fromSing <$> dim
-- Dim {dimName = IsChecked "batch", dimSize = IsChecked 0}
--
...
-- >>> fromSing <$> dim
-- Dim {dimName = IsUnchecked "batch", dimSize = IsChecked 0}
--
