...
t5BaseSpec ::
  ...
  SGradient gradient ->
  SDevice device ->
  ModelSpec (T5ModelF 'T5 transformerHead T5BaseNumLayers T5BaseNumLayers gradient device T5BaseHeadDim T5BaseHeadEmbedDim T5BaseEmbedDim T5BaseInputEmbedDim T5BaseFFNDim T5BaseVocabDim)
