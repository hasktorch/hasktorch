...
instance Class.IsTensor Tensor where
  ...
  newWithStorage :: Storage -> Int64 -> Ptr CTHLongStorage -> Ptr CTHLongStorage -> IO Tensor
  ...
  setStorage :: Tensor -> Storage -> Int64 -> Ptr CTHLongStorage -> Ptr CTHLongStorage -> IO ()
  ...
  setStorage1d :: Tensor -> Storage -> Int64 -> Int64 -> Int64 -> IO ()
  ...
  setStorage2d :: Tensor -> Storage -> Int64 -> Int64 -> Int64 -> Int64 -> Int64 -> IO ()
  ...
  setStorage3d :: Tensor -> Storage -> Int64 -> Int64 -> Int64 -> Int64 -> Int64 -> Int64 -> Int64 -> IO ()
  ...
  setStorage4d :: Tensor -> Storage -> Int64 -> Int64 -> Int64 -> Int64 -> Int64 -> Int64 -> Int64 -> Int64 -> Int64 -> IO ()
