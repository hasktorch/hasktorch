...
import Torch.Raw.Tensor.Generic (CTHDoubleTensor, CTHFloatTensor, THTensor(..))
import Torch.Core.Tensor.Dynamic.Generic (HaskReal', THTensorLapack', THTensor', THTensorMath')
import Torch.Core.Tensor.Types (THForeignType, withManaged4, withManaged3, withManaged2)
