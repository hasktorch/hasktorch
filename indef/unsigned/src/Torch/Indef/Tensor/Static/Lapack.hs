...
module Torch.Indef.Tensor.Static.DoubleLapack (
  tds_gesv,
  -- tds_trtrs,
  tds_gels,
  -- tds_syev,
...
import Torch.Indef.Tensor.Static.Double
import Torch.Indef.Tensor.Static.DoubleMath
...
-- TH_API void THTensor_(pstrf)(THTensor *ra_, Torch.FFI.TH.Int.Tensor *rpiv_, THTensor*a, const char* uplo, real tol);

-- TH_API void THTensor_(btrifact)(THTensor *ra_, Torch.FFI.TH.Int.Tensor *rpivots_, THIntTensor *rinfo_, int pivot, THTensor *a);
-- TH_API void THTensor_(btrisolve)(THTensor *rb_, THTensor *b, THTensor *atf, Torch.FFI.TH.Int.Tensor *pivots);
