...
module Torch.Indef.Storage where

-- THIS IS REQUIRED TO RE-EXPORT THE ORPHAN INSTANCES, DO NOT DELETE!
-- Dynamic and Static are new to indefinites, but this storage module requires
-- us to overload concerns with both the instance definition and the orphan aggregation.
