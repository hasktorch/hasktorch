...
class TensorMasked t where
  _maskedFill   :: Dimensions d => t d -> MaskTensor t '[(n::Nat)] -> HsReal (t d) -> IO ()
  _maskedCopy   :: Dimensions d => t d -> MaskTensor t '[(n::Nat)] -> t d -> IO ()
  _maskedSelect :: Dimensions d => t d -> t d -> MaskTensor t '[(n::Nat)] -> IO ()
