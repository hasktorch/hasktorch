...
in
  { inherit (shared)
    ...
    ${shared.nullIfDarwin "hasktorch-naperian_cudatoolkit_9_2"} = shared.hasktorch-naperian_cudatoolkit_9_2;
    ...
    ${shared.nullIfDarwin "hasktorch-naperian_cudatoolkit_10_1"} = shared.hasktorch-naperian_cudatoolkit_10_1;
  }
